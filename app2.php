...
<div class="hidden-title"><center><h1>GemaThesaurus</h1></center></p></div>
	...
	<script>
	console.log('[Translation Script] Translation script loaded and running');
        // Collapsible Toolbar
        (function () {
		...
		<!-- Move translation script to end of file -->
		<script>
		// === Toolbar Button & Dropdown Translation ===
		function translateDropdowns() {
				'fr': { Book: 'Livre :', Genesis: 'Genèse', Exodus: 'Exode', Leviticus: 'Lévitique', Numbers: 'Nombres', Deuteronomy: 'Deutéronome', Joshua: 'Josué', Judges: 'Juges', Ruth: 'Ruth', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Rois', '2 Kings': '2 Rois', '1 Chronicles': '1 Chroniques', '2 Chronicles': '2 Chroniques', Ezra: 'Esdras', Nehemiah: 'Néhémie', Esther: 'Esther', Job: 'Job', Psalms: 'Psaumes', Proverbs: 'Proverbes', Ecclesiastes: 'Ecclésiaste', 'Song of Songs': 'Cantique des cantiques', Isaiah: 'Ésaïe', Jeremiah: 'Jérémie', Lamentations: 'Lamentations', Ezekiel: 'Ézéchiel', Daniel: 'Daniel', Hosea: 'Osée', Joel: 'Joël', Amos: 'Amos', Obadiah: 'Abdias', Jonah: 'Jonas', Micah: 'Michée', Nahum: 'Nahum', Habakkuk: 'Habacuc', Zephaniah: 'Sophonie', Haggai: 'Aggée', Zechariah: 'Zacharie', Malachi: 'Malachie', Matthew: 'Matthieu', Mark: 'Marc', Luke: 'Luc', John: 'Jean', Acts: 'Actes', Romans: 'Romains', '1 Corinthians': '1 Corinthiens', '2 Corinthians': '2 Corinthiens', Galatians: 'Galates', Ephesians: 'Éphésiens', Philippians: 'Philippiens', Colossians: 'Colossiens', '1 Thessalonians': '1 Thessaloniciens', '2 Thessalonians': '2 Thessaloniciens', '1 Timothy': '1 Timothée', '2 Timothy': '2 Timothée', Titus: 'Tite', Philemon: 'Philémon', Hebrews: 'Hébreux', James: 'Jacques', '1 Peter': '1 Pierre', '2 Peter': '2 Pierre', '1 John': '1 Jean', '2 John': '2 Jean', '3 John': '3 Jean', Jude: 'Jude', Revelation: 'Apocalypse', 'Modify:': 'Modifier :', 'Alt Word #2 ⁕': 'Mot alternatif #2 ⁕', 'Alt Word #1 *': 'Mot alternatif #1 *', 'Alt Letter Size': 'Taille de lettre alternative', 'Cantillation (♫ notes)': 'Cantillation (notes ♫)', 'Niqqud (Vowel Points)': 'Niqqud (points voyelles)', 'Maqaf (dash, hypenes)': 'Maqaf (tiret, trait d’union)', 'Punctuation': 'Ponctuation', 'Digits': 'Chiffres', 'Spaces': 'Espaces', 'Carriage Returns': 'Retours chariot', 'Latin/English Letters': 'Lettres latines/anglaises', 'Greek Letters': 'Lettres grecques', 'Hebrew Letters': 'Lettres hébraïques', 'Convert Finals': 'Convertir les finales', 'Split Hyphenated': 'Séparer les mots avec tiret', 'Gematria:': 'Guématria :', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+mot', 'Ordinal': 'Ordinal', 'Reduced': 'Réduit', 'Integral Reduced': 'Réduit intégral', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Chiffrement :', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (avec finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'es': { Book: 'Libro:', Genesis: 'Génesis', Exodus: 'Éxodo', Leviticus: 'Levítico', Numbers: 'Números', Deuteronomy: 'Deuteronomio', Joshua: 'Josué', Judges: 'Jueces', Ruth: 'Rut', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Reyes', '2 Kings': '2 Reyes', '1 Chronicles': '1 Crónicas', '2 Chronicles': '2 Crónicas', Ezra: 'Esdras', Nehemiah: 'Nehemías', Esther: 'Ester', Job: 'Job', Psalms: 'Salmos', Proverbs: 'Proverbios', Ecclesiastes: 'Eclesiastés', 'Song of Songs': 'Cantar de los Cantares', Isaiah: 'Isaías', Jeremiah: 'Jeremías', Lamentations: 'Lamentaciones', Ezekiel: 'Ezequiel', Daniel: 'Daniel', Hosea: 'Oseas', Joel: 'Joel', Amos: 'Amós', Obadiah: 'Abdías', Jonah: 'Jonás', Micah: 'Miqueas', Nahum: 'Nahúm', Habakkuk: 'Habacuc', Zephaniah: 'Sofonías', Haggai: 'Hageo', Zechariah: 'Zacarías', Malachi: 'Malaquías', Matthew: 'Mateo', Mark: 'Marcos', Luke: 'Lucas', John: 'Juan', Acts: 'Hechos', Romans: 'Romanos', '1 Corinthians': '1 Corintios', '2 Corinthians': '2 Corintios', Galatians: 'Gálatas', Ephesians: 'Efesios', Philippians: 'Filipenses', Colossians: 'Colosenses', '1 Thessalonians': '1 Tesalonicenses', '2 Thessalonians': '2 Tesalonicenses', '1 Timothy': '1 Timoteo', '2 Timothy': '2 Timoteo', Titus: 'Tito', Philemon: 'Filemón', Hebrews: 'Hebreos', James: 'Santiago', '1 Peter': '1 Pedro', '2 Peter': '2 Pedro', '1 John': '1 Juan', '2 John': '2 Juan', '3 John': '3 Juan', Jude: 'Judas', Revelation: 'Apocalipsis', 'Modify:': 'Modificar:', 'Alt Word #2 ⁕': 'Palabra alternativa #2 ⁕', 'Alt Word #1 *': 'Palabra alternativa #1 *', 'Alt Letter Size': 'Tamaño de letra alternativo', 'Cantillation (♫ notes)': 'Cantilación (notas ♫)', 'Niqqud (Vowel Points)': 'Niqqud (puntos vocálicos)', 'Maqaf (dash, hypenes)': 'Maqaf (guion, raya)', 'Punctuation': 'Puntuación', 'Digits': 'Dígitos', 'Spaces': 'Espacios', 'Carriage Returns': 'Retornos de carro', 'Latin/English Letters': 'Letras latinas/inglesas', 'Greek Letters': 'Letras griegas', 'Hebrew Letters': 'Letras hebreas', 'Convert Finals': 'Convertir finales', 'Split Hyphenated': 'Separar palabras con guion', 'Gematria:': 'Guematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+palabra', 'Ordinal': 'Ordinal', 'Reduced': 'Reducido', 'Integral Reduced': 'Reducido integral', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Encriptación:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (con finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'he': { Book: 'ספר:', Genesis: 'בראשית', Exodus: 'שמות', Leviticus: 'ויקרא', Numbers: 'במדבר', Deuteronomy: 'דברים', Joshua: 'יהושע', Judges: 'שופטים', Ruth: 'רות', '1 Samuel': 'שמואל א׳', '2 Samuel': 'שמואל ב׳', '1 Kings': 'מלכים א׳', '2 Kings': 'מלכים ב׳', '1 Chronicles': 'דברי הימים א׳', '2 Chronicles': 'דברי הימים ב׳', Ezra: 'עזרא', Nehemiah: 'נחמיה', Esther: 'אסתר', Job: 'איוב', Psalms: 'תהילים', Proverbs: 'משלי', Ecclesiastes: 'קהלת', 'Song of Songs': 'שיר השירים', Isaiah: 'ישעיהו', Jeremiah: 'ירמיהו', Lamentations: 'איכה', Ezekiel: 'יחזקאל', Daniel: 'דניאל', Hosea: 'הושע', Joel: 'יואל', Amos: 'עמוס', Obadiah: 'עובדיה', Jonah: 'יונה', Micah: 'מיכה', Nahum: 'נחום', Habakkuk: 'חבקוק', Zephaniah: 'צפניה', Haggai: 'חגי', Zechariah: 'זכריה', Malachi: 'מלאכי', Matthew: 'מתי', Mark: 'מרקוס', Luke: 'לוקס', John: 'יוחנן', Acts: 'מעשים', Romans: 'רומים', '1 Corinthians': 'קורינתים א׳', '2 Corinthians': 'קורינתים ב׳', Galatians: 'גלטים', Ephesians: 'אפסים', Philippians: 'פיליפים', Colossians: 'קולוסים', '1 Thessalonians': 'תסלוניקים א׳', '2 Thessalonians': 'תסלוניקים ב׳', '1 Timothy': 'טימותיאוס א׳', '2 Timothy': 'טימותיאוס ב׳', Titus: 'טיטוס', Philemon: 'פילימון', Hebrews: 'עברים', James: 'יעקב', '1 Peter': 'פטרוס א׳', '2 Peter': 'פטרוס ב׳', '1 John': 'יוחנן א׳', '2 John': 'יוחנן ב׳', '3 John': 'יוחנן ג׳', Jude: 'יהודה', Revelation: 'התגלות', 'Modify:': 'שנה:', 'Alt Word #2 ⁕': 'מילה חלופית #2 ⁕', 'Alt Word #1 *': 'מילה חלופית #1 *', 'Alt Letter Size': 'גודל אות חלופית', 'Cantillation (♫ notes)': 'טעמי המקרא (תווים ♫)', 'Niqqud (Vowel Points)': 'ניקוד (סימני תנועה)', 'Maqaf (dash, hypenes)': 'מקאף (מקף, קו)', 'Punctuation': 'פיסוק', 'Digits': 'ספרות', 'Spaces': 'רווחים', 'Carriage Returns': 'מעברי שורה', 'Latin/English Letters': 'אותיות לטיניות/אנגליות', 'Greek Letters': 'אותיות יווניות', 'Hebrew Letters': 'אותיות עבריות', 'Convert Finals': 'המר סופיות', 'Split Hyphenated': 'פצל מילים עם מקף', 'Gematria:': 'גימטריה:', 'Ragil': 'רגיל', 'Katan': 'קטן', 'HaKlali': 'הכללי', 'Kolel': 'כולל', 'Kolel+word': 'כולל+מילה', 'Ordinal': 'סידורי', 'Reduced': 'מצומצם', 'Integral Reduced': 'מצומצם שלם', 'HaKadmi': 'הקדמי', 'HaPerati': 'הפרטי', 'Miluy': 'מילוי', 'Encryption:': 'הצפנה:', 'AYiK-BeCheR': 'אייק-בכר', 'AL-BaM': 'אל-בם', 'AT-BaSh': 'את-בש', 'ACh-BI': 'אך-בי', 'AChaS-BeTA': 'אחס-בטא', 'AT-BaCh': 'את-בח', 'AT-BaCh (with Finals)': 'את-בח (עם סופיות)', 'AiY-BaK': 'איי-בק', 'ATz-BaPh': 'אץ-בף', 'AL-BeTh': 'אל-בת', 'Ofanim': 'אופנים' },
				'pl': { Book: 'Księga:', Genesis: 'Rodzaju', Exodus: 'Wyjścia', Leviticus: 'Kapłańska', Numbers: 'Liczb', Deuteronomy: 'Powtórzonego Prawa', Joshua: 'Jozuego', Judges: 'Sędziów', Ruth: 'Rut', '1 Samuel': '1 Samuela', '2 Samuel': '2 Samuela', '1 Kings': '1 Królewska', '2 Kings': '2 Królewska', '1 Chronicles': '1 Kronik', '2 Chronicles': '2 Kronik', Ezra: 'Ezdrasza', Nehemiah: 'Nehemiasza', Esther: 'Estery', Job: 'Hioba', Psalms: 'Psalmów', Proverbs: 'Przysłów', Ecclesiastes: 'Kaznodziei', 'Song of Songs': 'Pieśń nad Pieśniami', Isaiah: 'Izajasza', Jeremiah: 'Jeremiasza', Lamentations: 'Lamentacje', Ezekiel: 'Ezechiela', Daniel: 'Daniela', Hosea: 'Ozeasza', Joel: 'Joela', Amos: 'Amosa', Obadiah: 'Abdiasza', Jonah: 'Jonasza', Micah: 'Micheasza', Nahum: 'Nahuma', Habakkuk: 'Habakuka', Zephaniah: 'Sofoniasza', Haggai: 'Aggeusza', Zechariah: 'Zachariasza', Malachi: 'Malachiasza', Matthew: 'Mateusza', Mark: 'Marka', Luke: 'Łukasza', John: 'Jana', Acts: 'Dzieje Apostolskie', Romans: 'Rzymian', '1 Corinthians': '1 Koryntian', '2 Corinthians': '2 Koryntian', Galatians: 'Galatów', Ephesians: 'Efezjan', Philippians: 'Filipian', Colossians: 'Kolosan', '1 Thessalonians': '1 Tesaloniczan', '2 Thessalonians': '2 Tesaloniczan', '1 Timothy': '1 Tymoteusza', '2 Timothy': '2 Tymoteusza', Titus: 'Tytusa', Philemon: 'Filemona', Hebrews: 'Hebrajczyków', James: 'Jakuba', '1 Peter': '1 Piotra', '2 Peter': '2 Piotra', '1 John': '1 Jana', '2 John': '2 Jana', '3 John': '3 Jana', Jude: 'Judy', Revelation: 'Objawienie', 'Modify:': 'Modyfikuj:', 'Alt Word #2 ⁕': 'Alternatywne słowo #2 ⁕', 'Alt Word #1 *': 'Alternatywne słowo #1 *', 'Alt Letter Size': 'Alternatywny rozmiar litery', 'Cantillation (♫ notes)': 'Kantylacja (nuty ♫)', 'Niqqud (Vowel Points)': 'Niqqud (punkty samogłoskowe)', 'Maqaf (dash, hypenes)': 'Maqaf (myślnik, łącznik)', 'Punctuation': 'Interpunkcja', 'Digits': 'Cyfry', 'Spaces': 'Spacje', 'Carriage Returns': 'Powroty karetki', 'Latin/English Letters': 'Litery łacińskie/angielskie', 'Greek Letters': 'Litery greckie', 'Hebrew Letters': 'Litery hebrajskie', 'Convert Finals': 'Konwertuj końcowe', 'Split Hyphenated': 'Podziel słowa z łącznikiem', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+słowo', 'Ordinal': 'Porządkowy', 'Reduced': 'Zredukowany', 'Integral Reduced': 'Całkowicie zredukowany', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Szyfrowanie:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (z końcowymi)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'tr': { Book: 'Kitap:', Genesis: 'Yaratılış', Exodus: 'Çıkış', Leviticus: 'Levililer', Numbers: 'Sayım', Deuteronomy: 'Tesniye', Joshua: 'Yeşu', Judges: 'Hakimler', Ruth: 'Rut', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Krallar', '2 Kings': '2 Krallar', '1 Chronicles': '1 Tarihler', '2 Chronicles': '2 Tarihler', Ezra: 'Ezra', Nehemiah: 'Nehemya', Esther: 'Ester', Job: 'Eyüp', Psalms: 'Mezmurlar', Proverbs: 'Süleymanın Özdeyişleri', Ecclesiastes: 'Vaiz', 'Song of Songs': 'Ezgiler Ezgisi', Isaiah: 'Yeşaya', Jeremiah: 'Yeremya', Lamentations: 'Ağıtlar', Ezekiel: 'Hezekiel', Daniel: 'Daniel', Hosea: 'Hoşea', Joel: 'Yoel', Amos: 'Amos', Obadiah: 'Ovadya', Jonah: 'Yunus', Micah: 'Mika', Nahum: 'Nahum', Habakkuk: 'Habakkuk', Zephaniah: 'Sefanya', Haggai: 'Hagay', Zechariah: 'Zekeriya', Malachi: 'Malaki', Matthew: 'Matta', Mark: 'Markos', Luke: 'Luka', John: 'Yuhanna', Acts: 'Elçilerin İşleri', Romans: 'Romalılar', '1 Corinthians': '1 Korintliler', '2 Corinthians': '2 Korintliler', Galatians: 'Galatyalılar', Ephesians: 'Efesliler', Philippians: 'Filipililer', Colossians: 'Koloseliler', '1 Thessalonians': '1 Selanikliler', '2 Thessalonians': '2 Selanikliler', '1 Timothy': '1 Timoteos', '2 Timothy': '2 Timoteos', Titus: 'Titus', Philemon: 'Filimon', Hebrews: 'İbraniler', James: 'Yakup', '1 Peter': '1 Petrus', '2 Peter': '2 Petrus', '1 John': '1 Yuhanna', '2 John': '2 Yuhanna', '3 John': '3 Yuhanna', Jude: 'Yahuda', Revelation: 'Vahiy', 'Modify:': 'Değiştir:', 'Alt Word #2 ⁕': 'Alternatif Kelime #2 ⁕', 'Alt Word #1 *': 'Alternatif Kelime #1 *', 'Alt Letter Size': 'Alternatif Harf Boyutu', 'Cantillation (♫ notes)': 'Ezgi (notalar ♫)', 'Niqqud (Vowel Points)': 'Niqqud (ünlü noktaları)', 'Maqaf (dash, hypenes)': 'Maqaf (tire, kısa çizgi)', 'Punctuation': 'Noktalama', 'Digits': 'Rakamlar', 'Spaces': 'Boşluklar', 'Carriage Returns': 'Satır Sonları', 'Latin/English Letters': 'Latince/İngilizce Harfler', 'Greek Letters': 'Yunan Harfleri', 'Hebrew Letters': 'İbranice Harfler', 'Convert Finals': 'Sonları Dönüştür', 'Split Hyphenated': 'Tireli Kelimeleri Böl', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+kelime', 'Ordinal': 'Sıralı', 'Reduced': 'Azaltılmış', 'Integral Reduced': 'Tam Azaltılmış', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Şifreleme:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (sonlarla)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'fa': { Book: 'کتاب:', Genesis: 'پیدایش', Exodus: 'خروج', Leviticus: 'لاویان', Numbers: 'اعداد', Deuteronomy: 'تثنیه', Joshua: 'یوشع', Judges: 'داوران', Ruth: 'روت', '1 Samuel': 'اول سموئیل', '2 Samuel': 'دوم سموئیل', '1 Kings': 'اول پادشاهان', '2 Kings': 'دوم پادشاهان', '1 Chronicles': 'اول تواریخ', '2 Chronicles': 'دوم تواریخ', Ezra: 'عزرا', Nehemiah: 'نحمیا', Esther: 'استر', Job: 'ایوب', Psalms: 'مزامیر', Proverbs: 'امثال', Ecclesiastes: 'جامعه', 'Song of Songs': 'غزل غزل‌ها', Isaiah: 'اشعیا', Jeremiah: 'ارمیا', Lamentations: 'مراثی', Ezekiel: 'حزقیال', Daniel: 'دانیال', Hosea: 'هوشع', Joel: 'یئیل', Amos: 'عاموس', Obadiah: 'عبدیا', Jonah: 'یونس', Micah: 'میکا', Nahum: 'ناحوم', Habakkuk: 'حبقوق', Zephaniah: 'صفنیا', Haggai: 'حجی', Zechariah: 'زکریا', Malachi: 'ملاکی', Matthew: 'متی', Mark: 'مرقس', Luke: 'لوقا', John: 'یوحنا', Acts: 'اعمال رسولان', Romans: 'رومیان', '1 Corinthians': 'اول قرنتیان', '2 Corinthians': 'دوم قرنتیان', Galatians: 'غلاطیان', Ephesians: 'افسسیان', Philippians: 'فیلیپیان', Colossians: 'کولسیان', '1 Thessalonians': 'اول تسالونیکیان', '2 Thessalonians': 'دوم تسالونیکیان', '1 Timothy': 'اول تیموتائوس', '2 Timothy': 'دوم تیموتائوس', Titus: 'تیتوس', Philemon: 'فلیمون', Hebrews: 'عبرانیان', James: 'یعقوب', '1 Peter': 'اول پطرس', '2 Peter': 'دوم پطرس', '1 John': 'اول یوحنا', '2 John': 'دوم یوحنا', '3 John': 'سوم یوحنا', Jude: 'یهودا', Revelation: 'مکاشفه', 'Modify:': 'تغییر:', 'Alt Word #2 ⁕': 'کلمه جایگزین #2 ⁕', 'Alt Word #1 *': 'کلمه جایگزین #1 *', 'Alt Letter Size': 'اندازه حرف جایگزین', 'Cantillation (♫ notes)': 'آواز (نت‌ها ♫)', 'Niqqud (Vowel Points)': 'نیکود (نقاط صدادار)', 'Maqaf (dash, hypenes)': 'ماکاف (خط تیره، فاصله)', 'Punctuation': 'نشانه‌گذاری', 'Digits': 'اعداد', 'Spaces': 'فاصله‌ها', 'Carriage Returns': 'بازگشت خط', 'Latin/English Letters': 'حروف لاتین/انگلیسی', 'Greek Letters': 'حروف یونانی', 'Hebrew Letters': 'حروف عبری', 'Convert Finals': 'تبدیل نهایی‌ها', 'Split Hyphenated': 'تقسیم کلمات با خط تیره', 'Gematria:': 'جماتریا:', 'Ragil': 'راگیل', 'Katan': 'کتان', 'HaKlali': 'هکللی', 'Kolel': 'کولل', 'Kolel+word': 'کولل+کلمه', 'Ordinal': 'ترتیبی', 'Reduced': 'کاهش یافته', 'Integral Reduced': 'کاهش یافته کامل', 'HaKadmi': 'هقدمی', 'HaPerati': 'هپراتی', 'Miluy': 'میلوی', 'Encryption:': 'رمزگذاری:', 'AYiK-BeCheR': 'آییک-بخر', 'AL-BaM': 'آل-بم', 'AT-BaSh': 'ات-بش', 'ACh-BI': 'اخ-بی', 'AChaS-BeTA': 'اخس-بتا', 'AT-BaCh': 'ات-بح', 'AT-BaCh (with Finals)': 'ات-بح (با نهایی‌ها)', 'AiY-BaK': 'آیی-بک', 'ATz-BaPh': 'اتز-بف', 'AL-BeTh': 'آل-بت', 'Ofanim': 'اوفانیم' },
				'zh': { Book: '书:', Genesis: '创世记', Exodus: '出埃及记', Leviticus: '利未记', Numbers: '民数记', Deuteronomy: '申命记', Joshua: '约书亚记', Judges: '士师记', Ruth: '路得记', '1 Samuel': '撒母耳记上', '2 Samuel': '撒母耳记下', '1 Kings': '列王纪上', '2 Kings': '列王纪下', '1 Chronicles': '历代志上', '2 Chronicles': '历代志下', Ezra: '以斯拉记', Nehemiah: '尼希米记', Esther: '以斯帖记', Job: '约伯记', Psalms: '诗篇', Proverbs: '箴言', Ecclesiastes: '传道书', 'Song of Songs': '雅歌', Isaiah: '以赛亚书', Jeremiah: '耶利米书', Lamentations: '耶利米哀歌', Ezekiel: '以西结书', Daniel: '但以理书', Hosea: '何西阿书', Joel: '约珥书', Amos: '阿摩司书', Obadiah: '俄巴底亚书', Jonah: '约拿书', Micah: '弥迦书', Nahum: '那鸿书', Habakkuk: '哈巴谷书', Zephaniah: '西番雅书', Haggai: '哈该书', Zechariah: '撒迦利亚书', Malachi: '玛拉基书', Matthew: '马太福音', Mark: '马可福音', Luke: '路加福音', John: '约翰福音', Acts: '使徒行传', Romans: '罗马书', '1 Corinthians': '哥林多前书', '2 Corinthians': '哥林多后书', Galatians: '加拉太书', Ephesians: '以弗所书', Philippians: '腓立比书', Colossians: '歌罗西书', '1 Thessalonians': '帖撒罗尼迦前书', '2 Thessalonians': '帖撒罗尼迦后书', '1 Timothy': '提摩太前书', '2 Timothy': '提摩太后书', Titus: '提多书', Philemon: '腓利门书', Hebrews: '希伯来书', James: '雅各书', '1 Peter': '彼得前书', '2 Peter': '彼得后书', '1 John': '约翰一书', '2 John': '约翰二书', '3 John': '约翰三书', Jude: '犹大书', Revelation: '启示录', 'Modify:': '修改:', 'Alt Word #2 ⁕': '替代词 #2 ⁕', 'Alt Word #1 *': '替代词 #1 *', 'Alt Letter Size': '替代字母大小', 'Cantillation (♫ notes)': '吟唱 (音符 ♫)', 'Niqqud (Vowel Points)': '尼库德 (元音点)', 'Maqaf (dash, hypenes)': '玛卡夫 (破折号, 连字符)', 'Punctuation': '标点', 'Digits': '数字', 'Spaces': '空格', 'Carriage Returns': '回车', 'Latin/English Letters': '拉丁/英文字母', 'Greek Letters': '希腊字母', 'Hebrew Letters': '希伯来字母', 'Convert Finals': '转换尾字母', 'Split Hyphenated': '分割连字符单词', 'Gematria:': '字母数字:', 'Ragil': '拉吉尔', 'Katan': '卡坦', 'HaKlali': '哈克拉利', 'Kolel': '科莱尔', 'Kolel+word': '科莱尔+词', 'Ordinal': '序数', 'Reduced': '简化', 'Integral Reduced': '完全简化', 'HaKadmi': '哈卡德米', 'HaPerati': '哈佩拉蒂', 'Miluy': '米卢伊', 'Encryption:': '加密:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (带尾字母)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': '奥法尼姆' },
				'vi': { Book: 'Sách:', Genesis: 'Sáng thế ký', Exodus: 'Xuất Ai Cập', Leviticus: 'Lê-vi Ký', Numbers: 'Dân số ký', Deuteronomy: 'Phục truyền luật lệ ký', Joshua: 'Giô-suê', Judges: 'Các quan xét', Ruth: 'Ru-tơ', '1 Samuel': '1 Sa-mu-ên', '2 Samuel': '2 Sa-mu-ên', '1 Kings': '1 Các vua', '2 Kings': '2 Các vua', '1 Chronicles': '1 Sử ký', '2 Chronicles': '2 Sử ký', Ezra: 'Ê-xơ-ra', Nehemiah: 'Nê-hê-mi', Esther: 'Ê-xơ-tê', Job: 'Gióp', Psalms: 'Thi thiên', Proverbs: 'Châm ngôn', Ecclesiastes: 'Truyền đạo', 'Song of Songs': 'Nhã ca', Isaiah: 'Ê-sai', Jeremiah: 'Giê-rê-mi', Lamentations: 'Ca thương', Ezekiel: 'Ê-xê-chi-ên', Daniel: 'Đa-ni-ên', Hosea: 'Ô-sê', Joel: 'Giô-ên', Amos: 'A-mốt', Obadiah: 'Ô-ba-đi-a', Jonah: 'Giô-na', Micah: 'Mi-chê', Nahum: 'Na-hum', Habakkuk: 'Ha-ba-cúc', Zephaniah: 'Sô-phô-ni', Haggai: 'Ha-gai', Zechariah: 'Xa-cha-ri', Malachi: 'Ma-la-chi', Matthew: 'Ma-thi-ơ', Mark: 'Mác', Luke: 'Lu-ca', John: 'Giăng', Acts: 'Công vụ các sứ đồ', Romans: 'Rô-ma', '1 Corinthians': '1 Cô-rinh-tô', '2 Corinthians': '2 Cô-rinh-tô', Galatians: 'Ga-la-ti', Ephesians: 'Ê-phê-sô', Philippians: 'Phi-líp', Colossians: 'Cô-lô-se', '1 Thessalonians': '1 Tê-sa-lô-ni-ca', '2 Thessalonians': '2 Tê-sa-lô-ni-ca', '1 Timothy': '1 Ti-mô-thê', '2 Timothy': '2 Ti-mô-thê', Titus: 'Tít', Philemon: 'Phi-lê-môn', Hebrews: 'Hê-bơ-rơ', James: 'Gia-cơ', '1 Peter': '1 Phi-e-rơ', '2 Peter': '2 Phi-e-rơ', '1 John': '1 Giăng', '2 John': '2 Giăng', '3 John': '3 Giăng', Jude: 'Giu-đe', Revelation: 'Khải huyền', 'Modify:': 'Sửa đổi:', 'Alt Word #2 ⁕': 'Từ thay thế #2 ⁕', 'Alt Word #1 *': 'Từ thay thế #1 *', 'Alt Letter Size': 'Kích thước chữ thay thế', 'Cantillation (♫ notes)': 'Ngâm (nốt ♫)', 'Niqqud (Vowel Points)': 'Niqqud (dấu nguyên âm)', 'Maqaf (dash, hypenes)': 'Maqaf (gạch ngang, gạch nối)', 'Punctuation': 'Dấu câu', 'Digits': 'Chữ số', 'Spaces': 'Khoảng trắng', 'Carriage Returns': 'Xuống dòng', 'Latin/English Letters': 'Chữ Latinh/Anh', 'Greek Letters': 'Chữ Hy Lạp', 'Hebrew Letters': 'Chữ Do Thái', 'Convert Finals': 'Chuyển đổi cuối', 'Split Hyphenated': 'Tách từ có gạch nối', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+từ', 'Ordinal': 'Số thứ tự', 'Reduced': 'Giảm', 'Integral Reduced': 'Giảm hoàn toàn', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Mã hóa:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (với cuối)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'cs': { Book: 'Kniha:', Genesis: 'Genesis', Exodus: 'Exodus', Leviticus: 'Leviticus', Numbers: 'Numeri', Deuteronomy: 'Deuteronomium', Joshua: 'Jozue', Judges: 'Soudců', Ruth: 'Rút', '1 Samuel': '1 Samuelova', '2 Samuel': '2 Samuelova', '1 Kings': '1 Královská', '2 Kings': '2 Královská', '1 Chronicles': '1 Paralipomenon', '2 Chronicles': '2 Paralipomenon', Ezra: 'Ezdráš', Nehemiah: 'Nehemjáš', Esther: 'Ester', Job: 'Job', Psalms: 'Žalmy', Proverbs: 'Přísloví', Ecclesiastes: 'Kazatel', 'Song of Songs': 'Píseň písní', Isaiah: 'Izajáš', Jeremiah: 'Jeremjáš', Lamentations: 'Pláč', Ezekiel: 'Ezechiel', Daniel: 'Daniel', Hosea: 'Ozeáš', Joel: 'Joel', Amos: 'Amos', Obadiah: 'Abdiáš', Jonah: 'Jonáš', Micah: 'Micheáš', Nahum: 'Nahum', Habakkuk: 'Abakuk', Zephaniah: 'Sofoniáš', Haggai: 'Ageus', Zechariah: 'Zachariáš', Malachi: 'Malachiáš', Matthew: 'Matouš', Mark: 'Marek', Luke: 'Lukáš', John: 'Jan', Acts: 'Skutky apoštolů', Romans: 'Římanům', '1 Corinthians': '1 Korintským', '2 Corinthians': '2 Korintským', Galatians: 'Galatským', Ephesians: 'Efezským', Philippians: 'Filipským', Colossians: 'Koloským', '1 Thessalonians': '1 Tesalonickým', '2 Thessalonians': '2 Tesalonickým', '1 Timothy': '1 Timoteovi', '2 Timothy': '2 Timoteovi', Titus: 'Titovi', Philemon: 'Filemonovi', Hebrews: 'Židům', James: 'Jakub', '1 Peter': '1 Petrův', '2 Peter': '2 Petrův', '1 John': '1 Janův', '2 John': '2 Janův', '3 John': '3 Janův', Jude: 'Juda', Revelation: 'Zjevení', 'Modify:': 'Upravit:', 'Alt Word #2 ⁕': 'Alternativní slovo #2 ⁕', 'Alt Word #1 *': 'Alternativní slovo #1 *', 'Alt Letter Size': 'Alternativní velikost písma', 'Cantillation (♫ notes)': 'Kantilační znaky (noty ♫)', 'Niqqud (Vowel Points)': 'Niqqud (samohlásky)', 'Maqaf (dash, hypenes)': 'Maqaf (pomlčka, spojovník)', 'Punctuation': 'Interpunkce', 'Digits': 'Číslice', 'Spaces': 'Mezery', 'Carriage Returns': 'Zalomení řádku', 'Latin/English Letters': 'Latinská/anglická písmena', 'Greek Letters': 'Řecká písmena', 'Hebrew Letters': 'Hebrejská písmena', 'Convert Finals': 'Převést finální', 'Split Hyphenated': 'Rozdělit slova se spojovníkem', 'Gematria:': 'Gematrie:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+slovo', 'Ordinal': 'Ordinální', 'Reduced': 'Redukovaný', 'Integral Reduced': 'Plně redukovaný', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Šifrování:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (s finálními)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'id': { Book: 'Kitab:', Genesis: 'Kejadian', Exodus: 'Keluaran', Leviticus: 'Imamat', Numbers: 'Bilangan', Deuteronomy: 'Ulangan', Joshua: 'Yosua', Judges: 'Hakim-hakim', Ruth: 'Rut', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Raja-raja', '2 Kings': '2 Raja-raja', '1 Chronicles': '1 Tawarikh', '2 Chronicles': '2 Tawarikh', Ezra: 'Ezra', Nehemiah: 'Nehemia', Esther: 'Ester', Job: 'Ayub', Psalms: 'Mazmur', Proverbs: 'Amsal', Ecclesiastes: 'Pengkhotbah', 'Song of Songs': 'Kidung Agung', Isaiah: 'Yesaya', Jeremiah: 'Yeremia', Lamentations: 'Ratapan', Ezekiel: 'Yehezkiel', Daniel: 'Daniel', Hosea: 'Hosea', Joel: 'Yoel', Amos: 'Amos', Obadiah: 'Obaja', Jonah: 'Yunus', Micah: 'Mikha', Nahum: 'Nahum', Habakkuk: 'Habakuk', Zephaniah: 'Zefanya', Haggai: 'Hagai', Zechariah: 'Zakharia', Malachi: 'Maleakhi', Matthew: 'Matius', Mark: 'Markus', Luke: 'Lukas', John: 'Yohanes', Acts: 'Kisah Para Rasul', Romans: 'Roma', '1 Corinthians': '1 Korintus', '2 Corinthians': '2 Korintus', Galatians: 'Galatia', Ephesians: 'Efesus', Philippians: 'Filipi', Colossians: 'Kolose', '1 Thessalonians': '1 Tesalonika', '2 Thessalonians': '2 Tesalonika', '1 Timothy': '1 Timotius', '2 Timothy': '2 Timotius', Titus: 'Titus', Philemon: 'Filemon', Hebrews: 'Ibrani', James: 'Yakobus', '1 Peter': '1 Petrus', '2 Peter': '2 Petrus', '1 John': '1 Yohanes', '2 John': '2 Yohanes', '3 John': '3 Yohanes', Jude: 'Yudas', Revelation: 'Wahyu', 'Modify:': 'Ubah:', 'Alt Word #2 ⁕': 'Kata alternatif #2 ⁕', 'Alt Word #1 *': 'Kata alternatif #1 *', 'Alt Letter Size': 'Ukuran huruf alternatif', 'Cantillation (♫ notes)': 'Kantilasi (not ♫)', 'Niqqud (Vowel Points)': 'Niqqud (tanda vokal)', 'Maqaf (dash, hypenes)': 'Maqaf (strip, tanda hubung)', 'Punctuation': 'Tanda baca', 'Digits': 'Angka', 'Spaces': 'Spasi', 'Carriage Returns': 'Pengembalian baris', 'Latin/English Letters': 'Huruf Latin/Inggris', 'Greek Letters': 'Huruf Yunani', 'Hebrew Letters': 'Huruf Ibrani', 'Convert Finals': 'Konversi huruf akhir', 'Split Hyphenated': 'Pisahkan kata ber-strip', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+kata', 'Ordinal': 'Ordinal', 'Reduced': 'Dikurangi', 'Integral Reduced': 'Dikurangi penuh', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Enkripsi:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (dengan huruf akhir)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'ko': { Book: '책:', Genesis: '창세기', Exodus: '출애굽기', Leviticus: '레위기', Numbers: '민수기', Deuteronomy: '신명기', Joshua: '여호수아', Judges: '사사기', Ruth: '룻기', '1 Samuel': '사무엘상', '2 Samuel': '사무엘하', '1 Kings': '열왕기상', '2 Kings': '열왕기하', '1 Chronicles': '역대상', '2 Chronicles': '역대하', Ezra: '에스라', Nehemiah: '느헤미야', Esther: '에스더', Job: '욥기', Psalms: '시편', Proverbs: '잠언', Ecclesiastes: '전도서', 'Song of Songs': '아가', Isaiah: '이사야', Jeremiah: '예레미야', Lamentations: '예레미야 애가', Ezekiel: '에스겔', Daniel: '다니엘', Hosea: '호세아', Joel: '요엘', Amos: '아모스', Obadiah: '오바댜', Jonah: '요나', Micah: '미가', Nahum: '나훔', Habakkuk: '하박국', Zephaniah: '스바냐', Haggai: '학개', Zechariah: '스가랴', Malachi: '말라기', Matthew: '마태복음', Mark: '마가복음', Luke: '누가복음', John: '요한복음', Acts: '사도행전', Romans: '로마서', '1 Corinthians': '고린도전서', '2 Corinthians': '고린도후서', Galatians: '갈라디아서', Ephesians: '에베소서', Philippians: '빌립보서', Colossians: '골로새서', '1 Thessalonians': '데살로니가전서', '2 Thessalonians': '데살로니가후서', '1 Timothy': '디모데전서', '2 Timothy': '디모데후서', Titus: '디도서', Philemon: '빌레몬서', Hebrews: '히브리서', James: '야고보서', '1 Peter': '베드로전서', '2 Peter': '베드로후서', '1 John': '요한1서', '2 John': '요한2서', '3 John': '요한3서', Jude: '유다서', Revelation: '요한계시록', 'Modify:': '수정:', 'Alt Word #2 ⁕': '대체 단어 #2 ⁕', 'Alt Word #1 *': '대체 단어 #1 *', 'Alt Letter Size': '대체 글자 크기', 'Cantillation (♫ notes)': '성가 (음표 ♫)', 'Niqqud (Vowel Points)': '니쿠드 (모음 기호)', 'Maqaf (dash, hypenes)': '마카프 (대시, 하이픈)', 'Punctuation': '구두점', 'Digits': '숫자', 'Spaces': '공백', 'Carriage Returns': '줄 바꿈', 'Latin/English Letters': '라틴/영어 글자', 'Greek Letters': '그리스 글자', 'Hebrew Letters': '히브리 글자', 'Convert Finals': '최종 변환', 'Split Hyphenated': '하이픈 단어 분리', 'Gematria:': '게마트리아:', 'Ragil': '라길', 'Katan': '카탄', 'HaKlali': '하클랄리', 'Kolel': '콜렐', 'Kolel+word': '콜렐+단어', 'Ordinal': '서수', 'Reduced': '축소', 'Integral Reduced': '완전 축소', 'HaKadmi': '하카드미', 'HaPerati': '하페라티', 'Miluy': '밀루이', 'Encryption:': '암호화:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (최종 포함)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': '오파님' },
				'uk': { Book: 'Книга:', Genesis: 'Буття', Exodus: 'Вихід', Leviticus: 'Левит', Numbers: 'Числа', Deuteronomy: 'Повторення Закону', Joshua: 'Ісус Навин', Judges: 'Судді', Ruth: 'Рут', '1 Samuel': '1 Самуїла', '2 Samuel': '2 Самуїла', '1 Kings': '1 Царів', '2 Kings': '2 Царів', '1 Chronicles': '1 Хронік', '2 Chronicles': '2 Хронік', Ezra: 'Ездра', Nehemiah: 'Неемія', Esther: 'Естер', Job: 'Йов', Psalms: 'Псалми', Proverbs: 'Приповісті', Ecclesiastes: 'Екклезіаст', 'Song of Songs': 'Пісня над піснями', Isaiah: 'Ісая', Jeremiah: 'Єремія', Lamentations: 'Плач Єремії', Ezekiel: 'Єзекіїль', Daniel: 'Даниїл', Hosea: 'Осія', Joel: 'Йоіл', Amos: 'Амос', Obadiah: 'Овадия', Jonah: 'Йона', Micah: 'Михей', Nahum: 'Наум', Habakkuk: 'Авакум', Zephaniah: 'Софонія', Haggai: 'Огей', Zechariah: 'Захарія', Malachi: 'Малахія', Matthew: 'Матвій', Mark: 'Марк', Luke: 'Лука', John: 'Іван', Acts: 'Дії', Romans: 'Римлянам', '1 Corinthians': '1 Коринтянам', '2 Corinthians': '2 Коринтянам', Galatians: 'Галатам', Ephesians: 'Ефесянам', Philippians: 'Филипʼянам', Colossians: 'Колосянам', '1 Thessalonians': '1 Солунянам', '2 Thessalonians': '2 Солунянам', '1 Timothy': '1 Тимофію', '2 Timothy': '2 Тимофію', Titus: 'Титу', Philemon: 'Филимону', Hebrews: 'Євреям', James: 'Яків', '1 Peter': '1 Петра', '2 Peter': '2 Петра', '1 John': '1 Івана', '2 John': '2 Івана', '3 John': '3 Івана', Jude: 'Юда', Revelation: 'Обʼявлення', 'Modify:': 'Змінити:', 'Alt Word #2 ⁕': 'Альтернативне слово #2 ⁕', 'Alt Word #1 *': 'Альтернативне слово #1 *', 'Alt Letter Size': 'Альтернативний розмір літери', 'Cantillation (♫ notes)': 'Кантиляція (ноти ♫)', 'Niqqud (Vowel Points)': 'Нікуд (голосні точки)', 'Maqaf (dash, hypenes)': 'Макаф (тире, дефіс)', 'Punctuation': 'Пунктуація', 'Digits': 'Цифри', 'Spaces': 'Пробіли', 'Carriage Returns': 'Повернення каретки', 'Latin/English Letters': 'Латинські/англійські літери', 'Greek Letters': 'Грецькі літери', 'Hebrew Letters': 'Єврейські літери', 'Convert Finals': 'Конвертувати фінальні', 'Split Hyphenated': 'Розділити слова з дефісом', 'Gematria:': 'Гематрія:', 'Ragil': 'Рагіль', 'Katan': 'Катан', 'HaKlali': 'Хаклалі', 'Kolel': 'Колель', 'Kolel+word': 'Колель+слово', 'Ordinal': 'Порядковий', 'Reduced': 'Зменшений', 'Integral Reduced': 'Повністю зменшений', 'HaKadmi': 'Хакадмі', 'HaPerati': 'Хаператі', 'Miluy': 'Мілуй', 'Encryption:': 'Шифрування:', 'AYiK-BeCheR': 'АЙіК-БеХеР', 'AL-BaM': 'АЛ-БаМ', 'AT-BaSh': 'АТ-БаШ', 'ACh-BI': 'Ах-БІ', 'AChaS-BeTA': 'Ахас-БеТА', 'AT-BaCh': 'АТ-БаХ', 'AT-BaCh (with Finals)': 'АТ-БаХ (з фінальними)', 'AiY-BaK': 'Ай-Бак', 'ATz-BaPh': 'Ац-БаФ', 'AL-BeTh': 'АЛ-БеТ', 'Ofanim': 'Офанім' },
				'hu': { Book: 'Könyv:', Genesis: 'Teremtés', Exodus: 'Kivonulás', Leviticus: 'Leviták', Numbers: 'Számok', Deuteronomy: 'Második törvénykönyv', Joshua: 'Józsué', Judges: 'Bírák', Ruth: 'Ruth', '1 Samuel': '1 Sámuel', '2 Samuel': '2 Sámuel', '1 Kings': '1 Királyok', '2 Kings': '2 Királyok', '1 Chronicles': '1 Krónikák', '2 Chronicles': '2 Krónikák', Ezra: 'Ezsdrás', Nehemiah: 'Nehémiás', Esther: 'Eszter', Job: 'Jób', Psalms: 'Zsoltárok', Proverbs: 'Példabeszédek', Ecclesiastes: 'Prédikátor', 'Song of Songs': 'Énekek éneke', Isaiah: 'Ézsaiás', Jeremiah: 'Jeremiás', Lamentations: 'Jeremiás siralmai', Ezekiel: 'Ezékiel', Daniel: 'Dániel', Hosea: 'Hóseás', Joel: 'Jóel', Amos: 'Ámós', Obadiah: 'Abdiás', Jonah: 'Jónás', Micah: 'Mikeás', Nahum: 'Náhum', Habakkuk: 'Habakuk', Zephaniah: 'Sofóniás', Haggai: 'Haggeus', Zechariah: 'Zakariás', Malachi: 'Malakiás', Matthew: 'Máté', Mark: 'Márk', Luke: 'Lukács', John: 'János', Acts: 'Apostolok cselekedetei', Romans: 'Rómaiakhoz', '1 Corinthians': '1 Korinthusiakhoz', '2 Corinthians': '2 Korinthusiakhoz', Galatians: 'Galatákhoz', Ephesians: 'Efézusiakhoz', Philippians: 'Filippiekhez', Colossians: 'Kolosséiakhoz', '1 Thessalonians': '1 Thesszalonikaiakhoz', '2 Thessalonians': '2 Thesszalonikaiakhoz', '1 Timothy': '1 Timóteushoz', '2 Timothy': '2 Timóteushoz', Titus: 'Tituszhoz', Philemon: 'Filemonhoz', Hebrews: 'Zsidókhoz', James: 'Jakab', '1 Peter': '1 Péter', '2 Peter': '2 Péter', '1 John': '1 János', '2 John': '2 János', '3 John': '3 János', Jude: 'Júdás', Revelation: 'Jelenések', 'Modify:': 'Módosít:', 'Alt Word #2 ⁕': 'Alternatív szó #2 ⁕', 'Alt Word #1 *': 'Alternatív szó #1 *', 'Alt Letter Size': 'Alternatív betűméret', 'Cantillation (♫ notes)': 'Kantilláció (hangjegyek ♫)', 'Niqqud (Vowel Points)': 'Niqqud (magánhangzó jelek)', 'Maqaf (dash, hypenes)': 'Maqaf (kötőjel, gondolatjel)', 'Punctuation': 'Írásjelek', 'Digits': 'Számjegyek', 'Spaces': 'Szóközök', 'Carriage Returns': 'Sortörések', 'Latin/English Letters': 'Latin/angol betűk', 'Greek Letters': 'Görög betűk', 'Hebrew Letters': 'Héber betűk', 'Convert Finals': 'Végződések átalakítása', 'Split Hyphenated': 'Kötőjeles szavak szétválasztása', 'Gematria:': 'Gemátria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+szó', 'Ordinal': 'Sorszám', 'Reduced': 'Csökkentett', 'Integral Reduced': 'Teljesen csökkentett', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Titkosítás:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (végződésekkel)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'ar': { Book: 'الكتاب:', Genesis: 'التكوين', Exodus: 'الخروج', Leviticus: 'اللاويين', Numbers: 'العدد', Deuteronomy: 'التثنية', Joshua: 'يشوع', Judges: 'القضاة', Ruth: 'راعوث', '1 Samuel': 'صموئيل الأول', '2 Samuel': 'صموئيل الثاني', '1 Kings': 'الملوك الأول', '2 Kings': 'الملوك الثاني', '1 Chronicles': 'أخبار الأيام الأول', '2 Chronicles': 'أخبار الأيام الثاني', Ezra: 'عزرا', Nehemiah: 'نحميا', Esther: 'أستير', Job: 'أيوب', Psalms: 'المزامير', Proverbs: 'الأمثال', Ecclesiastes: 'الجامعة', 'Song of Songs': 'نشيد الأنشاد', Isaiah: 'إشعياء', Jeremiah: 'إرميا', Lamentations: 'مراثي إرميا', Ezekiel: 'حزقيال', Daniel: 'دانيال', Hosea: 'هوشع', Joel: 'يوئيل', Amos: 'عاموس', Obadiah: 'عوبديا', Jonah: 'يونان', Micah: 'ميخا', Nahum: 'ناحوم', Habakkuk: 'حبقوق', Zephaniah: 'صفنيا', Haggai: 'حجي', Zechariah: 'زكريا', Malachi: 'ملاخي', Matthew: 'متى', Mark: 'مرقس', Luke: 'لوقا', John: 'يوحنا', Acts: 'أعمال الرسل', Romans: 'رومية', '1 Corinthians': 'كورنثوس الأولى', '2 Corinthians': 'كورنثوس الثانية', Galatians: 'غلاطية', Ephesians: 'أفسس', Philippians: 'فيلبي', Colossians: 'كولوسي', '1 Thessalonians': 'تسالونيكي الأولى', '2 Thessalonians': 'تسالونيكي الثانية', '1 Timothy': 'تيموثاوس الأولى', '2 Timothy': 'تيموثاوس الثانية', Titus: 'تيطس', Philemon: 'فليمون', Hebrews: 'العبرانيين', James: 'يعقوب', '1 Peter': 'بطرس الأولى', '2 Peter': 'بطرس الثانية', '1 John': 'يوحنا الأولى', '2 John': 'يوحنا الثانية', '3 John': 'يوحنا الثالثة', Jude: 'يهوذا', Revelation: 'رؤيا يوحنا', 'Modify:': 'تعديل:', 'Alt Word #2 ⁕': 'كلمة بديلة #2 ⁕', 'Alt Word #1 *': 'كلمة بديلة #1 *', 'Alt Letter Size': 'حجم الحرف البديل', 'Cantillation (♫ notes)': 'التلاوة (نغمات ♫)', 'Niqqud (Vowel Points)': 'نيقود (علامات الحركات)', 'Maqaf (dash, hypenes)': 'ماكاف (شرطة، واصلة)', 'Punctuation': 'علامات الترقيم', 'Digits': 'أرقام', 'Spaces': 'مسافات', 'Carriage Returns': 'إرجاع السطر', 'Latin/English Letters': 'حروف لاتينية/إنجليزية', 'Greek Letters': 'حروف يونانية', 'Hebrew Letters': 'حروف عبرية', 'Convert Finals': 'تحويل النهائيات', 'Split Hyphenated': 'تقسيم الكلمات ذات الواصلة', 'Gematria:': 'الجيماتريا:', 'Ragil': 'راجيل', 'Katan': 'كتان', 'HaKlali': 'هكلالي', 'Kolel': 'كوليل', 'Kolel+word': 'كوليل+كلمة', 'Ordinal': 'ترتيبي', 'Reduced': 'مخفض', 'Integral Reduced': 'مخفض كلياً', 'HaKadmi': 'هقدمي', 'HaPerati': 'هبراتي', 'Miluy': 'ميلوي', 'Encryption:': 'تشفير:', 'AYiK-BeCheR': 'آيك-بخر', 'AL-BaM': 'أل-بم', 'AT-BaSh': 'أت-بش', 'ACh-BI': 'أخ-بي', 'AChaS-BeTA': 'أخس-بيتا', 'AT-BaCh': 'أت-بح', 'AT-BaCh (with Finals)': 'أت-بح (مع النهائيات)', 'AiY-BaK': 'آي-باك', 'ATz-BaPh': 'أتز-بف', 'AL-BeTh': 'أل-بت', 'Ofanim': 'أوفانيم' },
				'ja': { Book: '書:', Genesis: '創世記', Exodus: '出エジプト記', Leviticus: 'レビ記', Numbers: '民数記', Deuteronomy: '申命記', Joshua: 'ヨシュア記', Judges: '士師記', Ruth: 'ルツ記', '1 Samuel': 'サムエル記上', '2 Samuel': 'サムエル記下', '1 Kings': '列王記上', '2 Kings': '列王記下', '1 Chronicles': '歴代誌上', '2 Chronicles': '歴代誌下', Ezra: 'エズラ記', Nehemiah: 'ネヘミヤ記', Esther: 'エステル記', Job: 'ヨブ記', Psalms: '詩篇', Proverbs: '箴言', Ecclesiastes: '伝道の書', 'Song of Songs': '雅歌', Isaiah: 'イザヤ書', Jeremiah: 'エレミヤ書', Lamentations: '哀歌', Ezekiel: 'エゼキエル書', Daniel: 'ダニエル書', Hosea: 'ホセア書', Joel: 'ヨエル書', Amos: 'アモス書', Obadiah: 'オバデヤ書', Jonah: 'ヨナ書', Micah: 'ミカ書', Nahum: 'ナホム書', Habakkuk: 'ハバクク書', Zephaniah: 'ゼパニヤ書', Haggai: 'ハガイ書', Zechariah: 'ゼカリヤ書', Malachi: 'マラキ書', Matthew: 'マタイによる福音書', Mark: 'マルコによる福音書', Luke: 'ルカによる福音書', John: 'ヨハネによる福音書', Acts: '使徒行伝', Romans: 'ローマ人への手紙', '1 Corinthians': 'コリント人への第一の手紙', '2 Corinthians': 'コリント人への第二の手紙', Galatians: 'ガラテヤ人への手紙', Ephesians: 'エペソ人への手紙', Philippians: 'ピリピ人への手紙', Colossians: 'コロサイ人への手紙', '1 Thessalonians': 'テサロニケ人への第一の手紙', '2 Thessalonians': 'テサロニケ人への第二の手紙', '1 Timothy': 'テモテへの第一の手紙', '2 Timothy': 'テモテへの第二の手紙', Titus: 'テトスへの手紙', Philemon: 'ピレモンへの手紙', Hebrews: 'ヘブル人への手紙', James: 'ヤコブの手紙', '1 Peter': 'ペテロの第一の手紙', '2 Peter': 'ペテロの第二の手紙', '1 John': 'ヨハネの第一の手紙', '2 John': 'ヨハネの第二の手紙', '3 John': 'ヨハネの第三の手紙', Jude: 'ユダの手紙', Revelation: 'ヨハネの黙示録', 'Modify:': '修正:', 'Alt Word #2 ⁕': '代替語 #2 ⁕', 'Alt Word #1 *': '代替語 #1 *', 'Alt Letter Size': '代替文字サイズ', 'Cantillation (♫ notes)': 'カンティレーション (♫ ノート)', 'Niqqud (Vowel Points)': 'ニクッド (母音記号)', 'Maqaf (dash, hypenes)': 'マカフ (ダッシュ、ハイフン)', 'Punctuation': '句読点', 'Digits': '数字', 'Spaces': 'スペース', 'Carriage Returns': '改行', 'Latin/English Letters': 'ラテン文字/英語文字', 'Greek Letters': 'ギリシャ文字', 'Hebrew Letters': 'ヘブライ文字', 'Convert Finals': 'ファイナル変換', 'Split Hyphenated': 'ハイフン付き単語分割', 'Gematria:': 'ゲマトリア:', 'Ragil': 'ラギル', 'Katan': 'カタン', 'HaKlali': 'ハクラリ', 'Kolel': 'コレル', 'Kolel+word': 'コレル+単語', 'Ordinal': '序数', 'Reduced': '縮小', 'Integral Reduced': '完全縮小', 'HaKadmi': 'ハカドミ', 'HaPerati': 'ハペラティ', 'Miluy': 'ミルイ', 'Encryption:': '暗号化:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (ファイナル付き)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'オファニム' },
				'pt': { Book: 'Livro:', Genesis: 'Gênesis', Exodus: 'Êxodo', Leviticus: 'Levítico', Numbers: 'Números', Deuteronomy: 'Deuteronômio', Joshua: 'Josué', Judges: 'Juízes', Ruth: 'Rute', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Reis', '2 Kings': '2 Reis', '1 Chronicles': '1 Crônicas', '2 Chronicles': '2 Crônicas', Ezra: 'Esdras', Nehemiah: 'Neemias', Esther: 'Ester', Job: 'Jó', Psalms: 'Salmos', Proverbs: 'Provérbios', Ecclesiastes: 'Eclesiastes', 'Song of Songs': 'Cântico dos Cânticos', Isaiah: 'Isaías', Jeremiah: 'Jeremias', Lamentations: 'Lamentações', Ezekiel: 'Ezequiel', Daniel: 'Daniel', Hosea: 'Oseias', Joel: 'Joel', Amos: 'Amós', Obadiah: 'Obadias', Jonah: 'Jonas', Micah: 'Miquéias', Nahum: 'Naum', Habakkuk: 'Habacuque', Zephaniah: 'Sofonias', Haggai: 'Ageu', Zechariah: 'Zacarias', Malachi: 'Malaquias', Matthew: 'Mateus', Mark: 'Marcos', Luke: 'Lucas', John: 'João', Acts: 'Atos', Romans: 'Romanos', '1 Corinthians': '1 Coríntios', '2 Corinthians': '2 Coríntios', Galatians: 'Gálatas', Ephesians: 'Efésios', Philippians: 'Filipenses', Colossians: 'Colossenses', '1 Thessalonians': '1 Tessalonicenses', '2 Thessalonians': '2 Tessalonicenses', '1 Timothy': '1 Timóteo', '2 Timothy': '2 Timóteo', Titus: 'Tito', Philemon: 'Filemom', Hebrews: 'Hebreus', James: 'Tiago', '1 Peter': '1 Pedro', '2 Peter': '2 Pedro', '1 John': '1 João', '2 John': '2 João', '3 John': '3 João', Jude: 'Judas', Revelation: 'Apocalipse', 'Modify:': 'Modificar:', 'Alt Word #2 ⁕': 'Palavra alternativa #2 ⁕', 'Alt Word #1 *': 'Palavra alternativa #1 *', 'Alt Letter Size': 'Tamanho da letra alternativa', 'Cantillation (♫ notes)': 'Cantilação (notas ♫)', 'Niqqud (Vowel Points)': 'Niqqud (pontos vocálicos)', 'Maqaf (dash, hypenes)': 'Maqaf (traço, hífen)', 'Punctuation': 'Pontuação', 'Digits': 'Dígitos', 'Spaces': 'Espaços', 'Carriage Returns': 'Retornos de carro', 'Latin/English Letters': 'Letras latinas/inglesas', 'Greek Letters': 'Letras gregas', 'Hebrew Letters': 'Letras hebraicas', 'Convert Finals': 'Converter finais', 'Split Hyphenated': 'Separar palavras com hífen', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+palavra', 'Ordinal': 'Ordinal', 'Reduced': 'Reduzido', 'Integral Reduced': 'Reduzido integral', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Criptografia:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (com finais)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'it': { Book: 'Libro:', Genesis: 'Genesi', Exodus: 'Esodo', Leviticus: 'Levitico', Numbers: 'Numeri', Deuteronomy: 'Deuteronomio', Joshua: 'Giosuè', Judges: 'Giudici', Ruth: 'Rut', '1 Samuel': '1 Samuele', '2 Samuel': '2 Samuele', '1 Kings': '1 Re', '2 Kings': '2 Re', '1 Chronicles': '1 Cronache', '2 Chronicles': '2 Cronache', Ezra: 'Esdra', Nehemiah: 'Neemia', Esther: 'Ester', Job: 'Giobbe', Psalms: 'Salmi', Proverbs: 'Proverbi', Ecclesiastes: 'Ecclesiaste', 'Song of Songs': 'Cantico dei Cantici', Isaiah: 'Isaia', Jeremiah: 'Geremia', Lamentations: 'Lamentazioni', Ezekiel: 'Ezechiele', Daniel: 'Daniele', Hosea: 'Osea', Joel: 'Joel', Amos: 'Amos', Obadiah: 'Abdia', Jonah: 'Giona', Micah: 'Michea', Nahum: 'Naum', Habakkuk: 'Abacuc', Zephaniah: 'Sofonia', Haggai: 'Aggeo', Zechariah: 'Zaccaria', Malachi: 'Malachia', Matthew: 'Matteo', Mark: 'Marco', Luke: 'Luca', John: 'Giovanni', Acts: 'Atti', Romans: 'Romani', '1 Corinthians': '1 Corinzi', '2 Corinthians': '2 Corinzi', Galatians: 'Galati', Ephesians: 'Efesini', Philippians: 'Filippesi', Colossians: 'Colossesi', '1 Thessalonians': '1 Tessalonicesi', '2 Thessalonians': '2 Tessalonicesi', '1 Timothy': '1 Timoteo', '2 Timothy': '2 Timoteo', Titus: 'Tito', Philemon: 'Filemone', Hebrews: 'Ebrei', James: 'Giacomo', '1 Peter': '1 Pietro', '2 Peter': '2 Pietro', '1 John': '1 Giovanni', '2 John': '2 Giovanni', '3 John': '3 Giovanni', Jude: 'Giuda', Revelation: 'Apocalisse', 'Modify:': 'Modifica:', 'Alt Word #2 ⁕': 'Parola alternativa #2 ⁕', 'Alt Word #1 *': 'Parola alternativa #1 *', 'Alt Letter Size': 'Dimensione lettera alternativa', 'Cantillation (♫ notes)': 'Cantillazione (note ♫)', 'Niqqud (Vowel Points)': 'Niqqud (punti vocalici)', 'Maqaf (dash, hypenes)': 'Maqaf (trattino, trattini)', 'Punctuation': 'Punteggiatura', 'Digits': 'Cifre', 'Spaces': 'Spazi', 'Carriage Returns': 'A capo', 'Latin/English Letters': 'Lettere latine/inglesi', 'Greek Letters': 'Lettere greche', 'Hebrew Letters': 'Lettere ebraiche', 'Convert Finals': 'Converti finali', 'Split Hyphenated': 'Dividi parole con trattino', 'Gematria:': 'Ghematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+parola', 'Ordinal': 'Ordinale', 'Reduced': 'Ridotto', 'Integral Reduced': 'Ridotto integrale', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Crittografia:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (con finali)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'nl': { Book: 'Boek:', Genesis: 'Genesis', Exodus: 'Exodus', Leviticus: 'Leviticus', Numbers: 'Numeri', Deuteronomy: 'Deuteronomium', Joshua: 'Jozua', Judges: 'Richteren', Ruth: 'Ruth', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Koningen', '2 Kings': '2 Koningen', '1 Chronicles': '1 Kronieken', '2 Chronicles': '2 Kronieken', Ezra: 'Ezra', Nehemiah: 'Nehemia', Esther: 'Esther', Job: 'Job', Psalms: 'Psalmen', Proverbs: 'Spreuken', Ecclesiastes: 'Prediker', 'Song of Songs': 'Hooglied', Isaiah: 'Jesaja', Jeremiah: 'Jeremia', Lamentations: 'Klaagliederen', Ezekiel: 'Ezechiël', Daniel: 'Daniel', Hosea: 'Hosea', Joel: 'Joël', Amos: 'Amos', Obadiah: 'Obadja', Jonah: 'Jona', Micah: 'Micha', Nahum: 'Nahum', Habakkuk: 'Habakuk', Zephaniah: 'Zefanja', Haggai: 'Haggai', Zechariah: 'Zacharia', Malachi: 'Maleachi', Matthew: 'Mattheüs', Mark: 'Marcus', Luke: 'Lucas', John: 'Johannes', Acts: 'Handelingen', Romans: 'Romeinen', '1 Corinthians': '1 Korintiërs', '2 Corinthians': '2 Korintiërs', Galatians: 'Galaten', Ephesians: 'Efeziërs', Philippians: 'Filippenzen', Colossians: 'Kolossenzen', '1 Thessalonians': '1 Thessalonicenzen', '2 Thessalonians': '2 Thessalonicenzen', '1 Timothy': '1 Timoteüs', '2 Timothy': '2 Timoteüs', Titus: 'Titus', Philemon: 'Filemon', Hebrews: 'Hebreeën', James: 'Jakobus', '1 Peter': '1 Petrus', '2 Peter': '2 Petrus', '1 John': '1 Johannes', '2 John': '2 Johannes', '3 John': '3 Johannes', Jude: 'Judas', Revelation: 'Openbaring', 'Modify:': 'Wijzig:', 'Alt Word #2 ⁕': 'Alternatief woord #2 ⁕', 'Alt Word #1 *': 'Alternatief woord #1 *', 'Alt Letter Size': 'Alternatieve lettergrootte', 'Cantillation (♫ notes)': 'Cantillatie (noten ♫)', 'Niqqud (Vowel Points)': 'Niqqud (klinkerpunten)', 'Maqaf (dash, hypenes)': 'Maqaf (streepje, koppelteken)', 'Punctuation': 'Interpunctie', 'Digits': 'Cijfers', 'Spaces': 'Spaties', 'Carriage Returns': 'Regeleinden', 'Latin/English Letters': 'Latijnse/Engelse letters', 'Greek Letters': 'Griekse letters', 'Hebrew Letters': 'Hebreeuwse letters', 'Convert Finals': 'Finalen omzetten', 'Split Hyphenated': 'Woorden met koppelteken splitsen', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+woord', 'Ordinal': 'Ordinaal', 'Reduced': 'Gerduceerd', 'Integral Reduced': 'Geheel gerduceerd', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Encryptie:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (met finalen)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
				'ru': { Book: 'Книга:', Genesis: 'Бытие', Exodus: 'Исход', Leviticus: 'Левит', Numbers: 'Числа', Deuteronomy: 'Второзаконие', Joshua: 'Иисус Навин', Judges: 'Судьи', Ruth: 'Руфь', '1 Samuel': '1 Царств', '2 Samuel': '2 Царств', '1 Kings': '3 Царств', '2 Kings': '4 Царств', '1 Chronicles': '1 Паралипоменон', '2 Chronicles': '2 Паралипоменон', Ezra: 'Ездра', Nehemiah: 'Неемия', Esther: 'Есфирь', Job: 'Иов', Psalms: 'Псалтирь', Proverbs: 'Притчи', Ecclesiastes: 'Екклесиаст', 'Song of Songs': 'Песнь песней', Isaiah: 'Исаия', Jeremiah: 'Иеремия', Lamentations: 'Плач Иеремии', Ezekiel: 'Иезекииль', Daniel: 'Даниил', Hosea: 'Осия', Joel: 'Иоиль', Amos: 'Амос', Obadiah: 'Авдий', Jonah: 'Иона', Micah: 'Михей', Nahum: 'Наум', Habakkuk: 'Аввакум', Zephaniah: 'Софония', Haggai: 'Аггей', Zechariah: 'Захария', Malachi: 'Малахия', Matthew: 'Матфей', Mark: 'Марк', Luke: 'Лука', John: 'Иоанн', Acts: 'Деяния', Romans: 'Римлянам', '1 Corinthians': '1 Коринфянам', '2 Corinthians': '2 Коринфянам', Galatians: 'Галатам', Ephesians: 'Ефесянам', Philippians: 'Филиппийцам', Colossians: 'Колоссянам', '1 Thessalonians': '1 Фессалоникийцам', '2 Thessalonians': '2 Фессалоникийцам', '1 Timothy': '1 Тимофею', '2 Timothy': '2 Тимофею', Titus: 'Титу', Philemon: 'Филимону', Hebrews: 'Евреям', James: 'Иаков', '1 Peter': '1 Петра', '2 Peter': '2 Петра', '1 John': '1 Иоанна', '2 John': '2 Иоанна', '3 John': '3 Иоанна', Jude: 'Иуда', Revelation: 'Откровение', 'Modify:': 'Изменить:', 'Alt Word #2 ⁕': 'Альтернативное слово #2 ⁕', 'Alt Word #1 *': 'Альтернативное слово #1 *', 'Alt Letter Size': 'Размер альтернативной буквы', 'Cantillation (♫ notes)': 'Кантилляция (ноты ♫)', 'Niqqud (Vowel Points)': 'Никуд (гласные точки)', 'Maqaf (dash, hypenes)': 'Макаф (тире, дефисы)', 'Punctuation': 'Пунктуация', 'Digits': 'Цифры', 'Spaces': 'Пробелы', 'Carriage Returns': 'Переводы строки', 'Latin/English Letters': 'Латинские/английские буквы', 'Greek Letters': 'Греческие буквы', 'Hebrew Letters': 'Еврейские буквы', 'Convert Finals': 'Преобразовать финальные', 'Split Hyphenated': 'Разделить слова с дефисом', 'Gematria:': 'Гематрия:', 'Ragil': 'Рагиль', 'Katan': 'Катан', 'HaKlali': 'Хаклали', 'Kolel': 'Колель', 'Kolel+word': 'Колель+слово', 'Ordinal': 'Порядковый', 'Reduced': 'Упрощённый', 'Integral Reduced': 'Упрощённый целый', 'HaKadmi': 'Хакадми', 'HaPerati': 'Хаперати', 'Miluy': 'Милуй', 'Encryption:': 'Шифрование:', 'AYiK-BeCheR': 'АЙиК-БеХеР', 'AL-BaM': 'АЛ-БаМ', 'AT-BaSh': 'АТ-БаШ', 'ACh-BI': 'Ах-БИ', 'AChaS-BeTA': 'Ахас-БеТА', 'AT-BaCh': 'АТ-БаХ', 'AT-BaCh (with Finals)': 'АТ-БаХ (с финальными)', 'AiY-BaK': 'Ай-Бак', 'ATz-BaPh': 'Ац-БаФ', 'AL-BeTh': 'АЛ-БеТ', 'Ofanim': 'Офаним' },
				'de': { Book: 'Buch:', Genesis: 'Genesis', Exodus: 'Exodus', Leviticus: 'Levitikus', Numbers: 'Numeri', Deuteronomy: 'Deuteronomium', Joshua: 'Josua', Judges: 'Richter', Ruth: 'Ruth', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Könige', '2 Kings': '2 Könige', '1 Chronicles': '1 Chronik', '2 Chronicles': '2 Chronik', Ezra: 'Esra', Nehemiah: 'Nehemia', Esther: 'Esther', Job: 'Hiob', Psalms: 'Psalmen', Proverbs: 'Sprüche', Ecclesiastes: 'Prediger', 'Song of Songs': 'Hohelied', Isaiah: 'Jesaja', Jeremiah: 'Jeremia', Lamentations: 'Klagelieder', Ezekiel: 'Ezechiel', Daniel: 'Daniel', Hosea: 'Hosea', Joel: 'Joel', Amos: 'Amos', Obadiah: 'Obadja', Jonah: 'Jona', Micah: 'Micha', Nahum: 'Nahum', Habakkuk: 'Habakuk', Zephaniah: 'Zefanja', Haggai: 'Haggai', Zechariah: 'Sacharja', Malachi: 'Maleachi', Matthew: 'Matthäus', Mark: 'Markus', Luke: 'Lukas', John: 'Johannes', Acts: 'Apostelgeschichte', Romans: 'Römer', '1 Corinthians': '1 Korinther', '2 Corinthians': '2 Korinther', Galatians: 'Galater', Ephesians: 'Epheser', Philippians: 'Philipper', Colossians: 'Kolosser', '1 Thessalonians': '1 Thessalonicher', '2 Thessalonians': '2 Thessalonicher', '1 Timothy': '1 Timotheus', '2 Timothy': '2 Timotheus', Titus: 'Titus', Philemon: 'Philemon', Hebrews: 'Hebräer', James: 'Jakobus', '1 Peter': '1 Petrus', '2 Peter': '2 Petrus', '1 John': '1 Johannes', '2 John': '2 Johannes', '3 John': '3 Johannes', Jude: 'Judas', Revelation: 'Offenbarung', 'Modify:': 'Ändern:', 'Alt Word #2 ⁕': 'Alternatives Wort #2 ⁕', 'Alt Word #1 *': 'Alternatives Wort #1 *', 'Alt Letter Size': 'Alternative Buchstabengröße', 'Cantillation (♫ notes)': 'Kantilierung (Noten ♫)', 'Niqqud (Vowel Points)': 'Niqqud (Vokalpunkte)', 'Maqaf (dash, hypenes)': 'Maqaf (Bindestrich, Gedankenstrich)', 'Punctuation': 'Interpunktion', 'Digits': 'Ziffern', 'Spaces': 'Leerzeichen', 'Carriage Returns': 'Zeilenumbrüche', 'Latin/English Letters': 'Lateinische/englische Buchstaben', 'Greek Letters': 'Griechische Buchstaben', 'Hebrew Letters': 'Hebräische Buchstaben', 'Convert Finals': 'Finale umwandeln', 'Split Hyphenated': 'Getrennte Wörter mit Bindestrich', 'Gematria:': 'Gematria:', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+Wort', 'Ordinal': 'Ordinal', 'Reduced': 'Reduziert', 'Integral Reduced': 'Integral reduziert', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Verschlüsselung:', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (mit Finalen)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' },
		}
		...
		document.addEventListener('DOMContentLoaded', function() {
			setTimeout(runAllTranslations, 300);
			setTimeout(runAllTranslations, 1200);
		});
		window.runAllTranslations = runAllTranslations;
		</script>
		...
		/*--------NT Hebrew----------E. Margoliouth-Trans--*/
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/HebrewNT.txt"]						{ --opt-bg:#3333aa; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/matthew/matthew.txt"]				{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/mark/mark.txt"]						{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/luke/luke.txt"]						{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/john/john.txt"]						{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/acts/acts.txt"]						{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/romans/romans.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1corinthians/1corinthians.txt"]		{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2corinthians/2corinthians.txt"]		{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/galatians/galatians.txt"]			{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/ephesians/ephesians.txt"]			{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philippians/philippians.txt"]		{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/colossians/colossians.txt"]			{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1thessalonians/1thessalonians.txt"]	{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2thessalonians/2thessalonians.txt"]	{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1timothy/1timothy.txt"]				{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2timothy/2timothy.txt"]				{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/titus/titus.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philemon/philemon.txt"]				{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/hebrews/hebrews.txt"]				{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/james/james.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1peter/1peter.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2peter/2peter.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1john/1john.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2john/2john.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/3john/3john.txt"]					{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/jude/jude.txt"]						{ --opt-bg:#546cad; }
		#bookSelect option[value*="/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/revelation/revelation.txt"]			{ --opt-bg:#546cad; }
		...
		<select id="bookSelect" onchange="loadFile(this.value)">
			...
			<option value='---'> </option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/HebrewNT.txt'>--------NT Hebrew--------</option><!-- NT in Hebrew -->
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/HebrewNT.txt'>--(E. Margoliouth-Trans)--</option><!-- Ezekiel Margoliouth's Translation of the Greek NT to Hebrew -->
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/matthew/matthew.txt'>&#x1F4D8; Matthew</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/mark/mark.txt'>&#x1F4D8; Mark</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/luke/luke.txt'>&#x1F4D8; Luke</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/john/john.txt'>&#x1F4D8; John</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/acts/acts.txt'>&#x1F4D8; Acts</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/romans/romans.txt'>&#x1F4D8; Romans</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1corinthians/1corinthians.txt'>&#x1F4D8; 1 Corinthians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2corinthians/2corinthians.txt'>&#x1F4D8; 2 Corinthians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/galatians/galatians.txt'>&#x1F4D8; Galatians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/ephesians/ephesians.txt'>&#x1F4D8; Ephesians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philippians/philippians.txt'>&#x1F4D8; Philippians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/colossians/colossians.txt'>&#x1F4D8; Colossians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1thessalonians/1thessalonians.txt'>&#x1F4D8; 1 Thessalonians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2thessalonians/2thessalonians.txt'>&#x1F4D8; 2 Thessalonians</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1timothy/1timothy.txt'>&#x1F4D8; 1 Timothy</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2timothy/2timothy.txt'>&#x1F4D8; 2 Timothy</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/titus/titus.txt'>&#x1F4D8; Titus</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philemon/philemon.txt'>&#x1F4D8; Philemon</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/hebrews/hebrews.txt'>&#x1F4D8; Hebrews</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/james/james.txt'>&#x1F4D8; James</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1peter/1peter.txt'>&#x1F4D8; 1 Peter</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2peter/2peter.txt'>&#x1F4D8; 2 Peter</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1john/1john.txt'>&#x1F4D8; 1 John</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2john/2john.txt'>&#x1F4D8; 2 John</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/3john/3john.txt'>&#x1F4D8; 3 John</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/jude/jude.txt'>&#x1F4D8; Jude</option>
			<option value='/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/revelation/revelation.txt'>&#x1F4D8; Revelation</option>
			<option value='---'> </option>
			...
			<option value='---'> </option>
			<option value='---'>--------Additions in Latin--------</option>
			...
			<option value='---'> </option>
			<option value='---'>--------Additions in English--------</option>
		...
		<script>
			...
			document.getElementById('bookSelect').addEventListener('change', function() {
			  ...
			  switch (this.value) {
				...
				/*--------NT Hebrew---------E.Margoliouth-Trans--*/
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/matthew/matthew.txt":					textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/mark/mark.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/luke/luke.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/john/john.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/acts/acts.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/romans/romans.txt":					textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1corinthians/1corinthians.txt":		textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2corinthians/2corinthians.txt":		textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/galatians/galatians.txt":				textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/ephesians/ephesians.txt":				textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philippians/philippians.txt":			textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/colossians/colossians.txt":			textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1thessalonians/1thessalonians.txt":	textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2thessalonians/2thessalonians.txt":	textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1timothy/1timothy.txt":				textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2timothy/2timothy.txt":				textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/titus/titus.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/philemon/philemon.txt":				textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/hebrews/hebrews.txt":					textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/james/james.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1peter/1peter.txt":					textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2peter/2peter.txt":					textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/1john/1john.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/2john/2john.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/3john/3john.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/jude/jude.txt":						textarea.dir = 'rtl';	break;
				case "/gemacrypt/files/books/NT/Hebrew/Ezekiel-Margoliouth-Translation/revelation/revelation.txt":			textarea.dir = 'rtl';	break;
				/*--------NT Hebrew---------Delitzsch-Translation--*/
		...
		<script>
			...
			function highlightSpecialCharacters(text) {
				...
				// Greek and English .txt files contain the \u200E (Left-to-Right Mark) or &#8206; or &#x200E; as the very first character of the .txt file.
				// Hebrew .txt files also contain the \u200F (Right-to-Left Mark) or &#8207; or &#x200F; as the very first character of the .txt file.
				
				// Style the letter to the left of BOM (U+FEFF) or &#xFEFF; or &#65279; but exclude asterisk (*) and flower mark (⁕)
				// Due to browser artifacts (<) being generated when processing the Zero-Width No-Break Space (BOM), a \u180E character is added before the Zero-Width character it to prevent the artifact.
				escapedText = escapedText.replace(/([^*⁕])(\uFEFF|&#xFEFF;|&#65279;)/g, function(match, p1, p2) {
					return '<span style="font-size:36px">' + p1 + '</span>' + p2;
				});

				// Style the letter to the left of Word Joiner (U+2060), or &#x2060; or &#8288;, or &NoBreak; but exclude asterisk (*) and flower mark (⁕)
				// Due to browser artifacts (<) being generated when processing the Zero-Width No-Break (Word Joiner), a \u180E character is added before the Zero-Width character it to prevent the artifact.
				escapedText = escapedText.replace(/([^*⁕])(\u2060|&#x2060;|&#8288;|&NoBreak;)/g, function(match, p1, p2) {
					return '<span style="font-size:14px">' + p1 + '</span>' + p2;
				});
		...
		async function loadFile(url) {
			...
			document.getElementById('modifySelect').value = 'Modify';
		}
		</script>

		<style>
		#modifySelect {  border-radius: 8px; }
		#modifySelect option          { background:#3333aa; color:#fff; border-radius: 5px; }	/*  Fallback color for any option that does not get an override  */
		#modifySelect option          { background:var(--opt-bg,#3333aa); border-radius: 5px; } 
		#modifySelect option[value*="AltWord2"]					{ --opt-bg:#3333aa; }
		#modifySelect option[value*="AltWord1"]					{ --opt-bg:#3333aa; }
		#modifySelect option[value*="AltLetterSize"]			{ --opt-bg:#3333aa; }
		#modifySelect option[value*="LetterSize"]				{ --opt-bg:#3333aa; }
		#modifySelect option[value*="Cantillation"]				{ --opt-bg:#48bef5; }
		#modifySelect option[value*="Niqqud"]					{ --opt-bg:#48bef5; }
		#modifySelect option[value*="Maqaf"]					{ --opt-bg:#48bef5; }
		#modifySelect option[value*="Punctuation"]				{ --opt-bg:#4589a8; }
		#modifySelect option[value*="Digits"]					{ --opt-bg:#4589a8; }
		#modifySelect option[value*="Spaces"]					{ --opt-bg:#4589a8; }
		#modifySelect option[value*="CarriageReturns"]			{ --opt-bg:#4589a8; }
		#modifySelect option[value*="LatinLetters"]				{ --opt-bg:#00aeff; }
		#modifySelect option[value*="GreekLetters"]				{ --opt-bg:#00aeff; }
		#modifySelect option[value*="HebrewLetters"]			{ --opt-bg:#00aeff; }
		#modifySelect option[value*="ConvertFinals"]			{ --opt-bg:#546cad; }
		#modifySelect option[value*="SplitHyphen"]				{ --opt-bg:#546cad; }
		</style>

        <select id="modifySelect" tabIndex="" onChange="">
            <option value='Modify' selected="true">&#x1F4DD; Modify:</option>
		...
		function translateDropdowns() {
			const translations = {
				...
				'fr': {	Book: 'Livre :', Genesis: 'Genèse', Exodus: 'Exode', Leviticus: 'Lévitique', Numbers: 'Nombres', Deuteronomy: 'Deutéronome', Joshua: 'Josué', Judges: 'Juges', Ruth: 'Ruth', '1 Samuel': '1 Samuel', '2 Samuel': '2 Samuel', '1 Kings': '1 Rois', '2 Kings': '2 Rois', '1 Chronicles': '1 Chroniques', '2 Chronicles': '2 Chroniques', Ezra: 'Esdras', Nehemiah: 'Néhémie', Esther: 'Esther', Job: 'Job', Psalms: 'Psaumes', Proverbs: 'Proverbes', Ecclesiastes: 'Ecclésiaste', 'Song of Songs': 'Cantique des cantiques', Isaiah: 'Ésaïe', Jeremiah: 'Jérémie', Lamentations: 'Lamentations', Ezekiel: 'Ézéchiel', Daniel: 'Daniel', Hosea: 'Osée', Joel: 'Joël', Amos: 'Amos', Obadiah: 'Abdias', Jonah: 'Jonas', Micah: 'Michée', Nahum: 'Nahum', Habakkuk: 'Habacuc', Zephaniah: 'Sophonie', Haggai: 'Aggée', Zechariah: 'Zacharie', Malachi: 'Malachie', Matthew: 'Matthieu', Mark: 'Marc', Luke: 'Luc', John: 'Jean', Acts: 'Actes', Romans: 'Romains', '1 Corinthians': '1 Corinthiens', '2 Corinthians': '2 Corinthiens', Galatians: 'Galates', Ephesians: 'Éphésiens', Philippians: 'Philippiens', Colossians: 'Colossiens', '1 Thessalonians': '1 Thessaloniciens', '2 Thessalonians': '2 Thessaloniciens', '1 Timothy': '1 Timothée', '2 Timothy': '2 Timothée', Titus: 'Tite', Philemon: 'Philémon', Hebrews: 'Hébreux', James: 'Jacques', '1 Peter': '1 Pierre', '2 Peter': '2 Pierre', '1 John': '1 Jean', '2 John': '2 Jean', '3 John': '3 Jean', Jude: 'Jude', Revelation: 'Apocalypse', 'Testament of Abraham': 'Testament d’Abraham', 'Testament of Moses': 'Testament de Moïse', 'Testament of Solomon': 'Testament de Salomon', 'Testament of the 12 Patriarchs': 'Testament des 12 Patriarches', 'Testimony of Truth': 'Témoignage de la Vérité', 'Theodotus': 'Théodote', 'Theophilus of Antioch': 'Théophile d’Antioche', 'Thomas the Contender': 'Thomas le Contendant', 'Thunder, Perfect Mind': 'Tonnerre, Esprit Parfait', 'Tobit': 'Tobie', 'Traditions of Matthias': 'Traditions de Matthias', 'Vision of Ezra': 'Vision d’Esdras', 'Wisdom of Sirach': 'Sagesse de Sirach', 'Wisdom of Solomon': 'Sagesse de Salomon', 'Modify:': 'Modifier :', 'Alt Word #2 ⁕': 'Mot alternatif #2 ⁕', 'Alt Word #1 *': 'Mot alternatif #1 *', 'Alt Letter Size': 'Taille de lettre alternative', 'Cantillation (♫ notes)': 'Cantillation (notes ♫)', 'Niqqud (Vowel Points)': 'Niqqud (points voyelles)', 'Maqaf (dash, hypenes)': 'Maqaf (tiret, trait d’union)', 'Punctuation': 'Ponctuation', 'Digits': 'Chiffres', 'Spaces': 'Espaces', 'Carriage Returns': 'Retours chariot', 'Latin/English Letters': 'Lettres latines/anglaises', 'Greek Letters': 'Lettres grecques', 'Hebrew Letters': 'Lettres hébraïques', 'Convert Finals': 'Convertir les finales', 'Split Hyphenated': 'Séparer les mots avec tiret', 'Gematria:': 'Guématria :', 'Ragil': 'Ragil', 'Katan': 'Katan', 'HaKlali': 'HaKlali', 'Kolel': 'Kolel', 'Kolel+word': 'Kolel+mot', 'Ordinal': 'Ordinal', 'Reduced': 'Réduit', 'Integral Reduced': 'Réduit intégral', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy', 'Encryption:': 'Chiffrement :', 'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (avec finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim' }, 
			};
			function getLang() {
			...
			selectIds.forEach(function(id) {
				...
				if (select) {
					select.querySelectorAll('option').forEach(function(opt) {
						// Extract label robustly: preserve icons, trim, keep colons/specials, normalize spaces
						let raw = opt.textContent;
						let label = raw.trim();
						// Strip leading icons/emojis for matching
						let iconMatch = label.match(/^([\p{Emoji}\p{Symbol}\p{Punctuation}\p{S}\p{So}\p{Sk}\p{Sm}\p{Sc}\p{Zs}\u200d\uFE0F]+)?\s*(.*)$/u);
						let icon = iconMatch && iconMatch[1] ? iconMatch[1] : '';
						let labelNoIcon = iconMatch && iconMatch[2] ? iconMatch[2] : label;
						// Normalize label for matching: only normalize spaces and case, preserve all special characters
						let normalizedLabel = labelNoIcon.replace(/\s+/g, ' ').trim().toLowerCase();
						let matched = false;
						for (const key in map) {
							// Normalize key similarly
							let normalizedKey = key.replace(/[.,;!?\-–—()\[\]{}<>#*^~_\|\/\\]/g, '').replace(/\s+/g, ' ').trim().toLowerCase();
							// Debug: print normalized key and label for comparison
							console.log('[Dropdown Translation Debug] Comparing:', normalizedKey, '<->', normalizedLabel, '| Key:', key, '| Label:', labelNoIcon);
							if (normalizedKey === normalizedLabel) {
								// Replace only the label, preserve any icons/prefix/suffix
								opt.textContent = icon + ' ' + map[key];
								matched = true;
								break;
							}
						}
						if (!matched) {
							// Log untranslated dropdown items for debugging
							console.log('[Dropdown Translation] No translation for:', raw, '| Extracted label:', label, '| Normalized:', normalizedLabel);
						}
					});
				}
			});
		...
		function translateStatusBarLabels() {
			const statusTranslations = {
				'en': {
					'Verses:': 'Verses:', 'Words:': 'Words:', 'Letters:': 'Letters:', 'Gematria:': 'Gematria:', 'En. Gematria:': 'En. Gematria:', 'Encrypted:': 'Encrypted:'
				},
				'fr': {'Verses:': 'Versets :','Words:': 'Mots :','Letters:': 'Lettres :','Gematria:': 'Guématria :','En. Gematria:': 'Guématria Anglaise :','Encrypted:': 'Chiffré :'},
				'es': {'Verses:': 'Versículos:','Words:': 'Palabras:','Letters:': 'Letras:','Gematria:': 'Guematria:','En. Gematria:': 'Guematria Ing.:','Encrypted:': 'Encriptado:'},
				'he': {'Verses:': 'פסוקים:','Words:': 'מילים:','Letters:': 'אותיות:','Gematria:': 'גימטריה:','En. Gematria:': 'גימטריה אנגלית:','Encrypted:': 'מוצפן:'},
				'ru': {'Verses:': 'Стихи:','Words:': 'Слова:','Letters:': 'Буквы:','Gematria:': 'Гематрия:','En. Gematria:': 'Англ. гематрия:','Encrypted:': 'Зашифровано:'},
				'de': {'Verses:': 'Verse:','Words:': 'Wörter:','Letters:': 'Buchstaben:','Gematria:': 'Gematria:','En. Gematria:': 'Engl. Gematria:','Encrypted:': 'Verschlüsselt:'},
				'ja': {'Verses:': '節:','Words:': '単語:','Letters:': '文字:','Gematria:': 'ゲマトリア:','En. Gematria:': '英語ゲマトリア:','Encrypted:': '暗号化:'},
				'pt': {'Verses:': 'Versos:','Words:': 'Palavras:','Letters:': 'Letras:','Gematria:': 'Gematria:','En. Gematria:': 'Gematria Ing.:','Encrypted:': 'Criptografado:'},
				'it': {'Verses:': 'Versi:','Words:': 'Parole:','Letters:': 'Lettere:','Gematria:': 'Ghematria:','En. Gematria:': 'Ghematria Ing.:','Encrypted:': 'Criptato:'},
				'nl': {'Verses:': 'Verzen:','Words:': 'Woorden:','Letters:': 'Letters:','Gematria:': 'Gematria:','En. Gematria:': 'Eng. Gematria:','Encrypted:': 'Versleuteld:'},
				'pl': {'Verses:': 'Wersety:','Words:': 'Słowa:','Letters:': 'Litery:','Gematria:': 'Gematria:','En. Gematria:': 'Ang. Gematria:','Encrypted:': 'Zaszyfrowane:'},
				'tr': {'Verses:': 'Ayetler:','Words:': 'Kelimeler:','Letters:': 'Harfler:','Gematria:': 'Gematria:','En. Gematria:': 'İng. Gematria:','Encrypted:': 'Şifreli:'},
				'fa': {'Verses:': 'آیات:','Words:': 'کلمات:','Letters:': 'حروف:','Gematria:': 'جماتریا:','En. Gematria:': 'جماتریای انگلیسی:','Encrypted:': 'رمزگذاری شده:'},
				'zh': {'Verses:': '节:','Words:': '词:','Letters:': '字母:','Gematria:': '字母数字:','En. Gematria:': '英文字母数字:','Encrypted:': '加密:'},
				'vi': {'Verses:': 'Câu:','Words:': 'Từ:','Letters:': 'Chữ cái:','Gematria:': 'Gematria:','En. Gematria:': 'Gematria Anh:','Encrypted:': 'Đã mã hóa:'},
				'cs': {'Verses:': 'Verše:','Words:': 'Slova:','Letters:': 'Písmena:','Gematria:': 'Gematrie:','En. Gematria:': 'Angl. gematrie:','Encrypted:': 'Zašifrováno:'},
				'id': {'Verses:': 'Ayat:','Words:': 'Kata:','Letters:': 'Huruf:','Gematria:': 'Gematria:','En. Gematria:': 'Gematria Inggris:','Encrypted:': 'Terenkripsi:'},
				'ko': {'Verses:': '절:','Words:': '단어:','Letters:': '글자:','Gematria:': '게마트리아:','En. Gematria:': '영어 게마트리아:','Encrypted:': '암호화됨:'},
				'uk': {'Verses:': 'Вірші:','Words:': 'Слова:','Letters:': 'Літери:','Gematria:': 'Гематрія:','En. Gematria:': 'Англ. гематрія:','Encrypted:': 'Зашифровано:'},
				'hu': {'Verses:': 'Versek:','Words:': 'Szavak:','Letters:': 'Betűk:','Gematria:': 'Gemátria:','En. Gematria:': 'Angol gemátria:','Encrypted:': 'Titkosítva:'},
				'ar': {'Verses:': 'آيات:','Words:': 'كلمات:','Letters:': 'حروف:','Gematria:': 'الجيماتريا:','En. Gematria:': 'الجيماتريا الإنجليزية:','Encrypted:': 'مشفر:'}
			};
			function getLang() {
				let lang = navigator.language || navigator.userLanguage || 'en';
				lang = lang.split('-')[0];
		...
		document.addEventListener('DOMContentLoaded', function() {
			// Run after 300ms and again after 1200ms to catch late rendering
			setTimeout(runAllTranslations, 300);
			setTimeout(runAllTranslations, 1200);
		});
		...
		document.addEventListener('DOMContentLoaded', function() {
			const translations = {
				'en': {Open: 'Open', Calc: 'Calc', Find: 'Find', ELS: 'ELS', Swap: 'Swap', Copy: 'Copy', Align: 'Align', Wrap: 'Wrap', Mode: 'Mode', Trans: 'Trans', Print: 'Print', Export: 'Export', Clear: 'Clear', DB: 'DB', Help: 'Help'},
				'he': {Open: 'פתח', Calc: 'חשב', Find: 'מצא', ELS: 'רצף', Swap: 'החלף', Copy: 'העתק', Align: 'יישור', Wrap: 'גלישת טקסט', Mode: 'מצב', Trans: 'תרגם', Print: 'הדפס', Export: 'יצא', Clear: 'נקה', DB: 'מסד', Help: 'עזרה'},
				'es': {Open: 'Abrir', Calc: 'Calcular', Find: 'Buscar', ELS: 'ELS', Swap: 'Intercambiar', Copy: 'Copiar', Align: 'Alinear', Wrap: 'Ajustar', Mode: 'Modo', Trans: 'Traducir', Print: 'Imprimir', Export: 'Exportar', Clear: 'Limpiar', DB: 'BD', Help: 'Ayuda'},
				'fr': {Open: 'Ouvrir', Calc: 'Calculer', Find: 'Trouver', ELS: 'ELS', Swap: 'Échanger', Copy: 'Copier', Align: 'Aligner', Wrap: 'Retour à la ligne', Mode: 'Mode', Trans: 'Traduire', Print: 'Imprimer', Export: 'Exporter', Clear: 'Effacer', DB: 'BD', Help: 'Aide'},
				'ru': {Open: 'Открыть', Calc: 'Вычислить', Find: 'Найти', ELS: 'ELS', Swap: 'Поменять', Copy: 'Копировать', Align: 'Выровнять', Wrap: 'Перенос', Mode: 'Режим', Trans: 'Перевести', Print: 'Печать', Export: 'Экспорт', Clear: 'Очистить', DB: 'БД', Help: 'Помощь'},
				'de': {Open: 'Öffnen', Calc: 'Berechnen', Find: 'Finden', ELS: 'ELS', Swap: 'Tauschen', Copy: 'Kopieren', Align: 'Ausrichten', Wrap: 'Umbruch', Mode: 'Modus', Trans: 'Übersetzen', Print: 'Drucken', Export: 'Exportieren', Clear: 'Löschen', DB: 'DB', Help: 'Hilfe'},
				'ja': {Open: '開く', Calc: '計算', Find: '検索', ELS: 'ELS', Swap: '入れ替え', Copy: 'コピー', Align: '整列', Wrap: '折り返し', Mode: 'モード', Trans: '翻訳', Print: '印刷', Export: 'エクスポート', Clear: 'クリア', DB: 'DB', Help: 'ヘルプ'},
				'pt': {Open: 'Abrir', Calc: 'Calcular', Find: 'Buscar', ELS: 'ELS', Swap: 'Trocar', Copy: 'Copiar', Align: 'Alinhar', Wrap: 'Quebrar', Mode: 'Modo', Trans: 'Traduzir', Print: 'Imprimir', Export: 'Exportar', Clear: 'Limpar', DB: 'BD', Help: 'Ajuda'},
				'it': {Open: 'Apri', Calc: 'Calcola', Find: 'Trova', ELS: 'ELS', Swap: 'Scambia', Copy: 'Copia', Align: 'Allinea', Wrap: 'A capo', Mode: 'Modalità', Trans: 'Traduci', Print: 'Stampa', Export: 'Esporta', Clear: 'Cancella', DB: 'DB', Help: 'Aiuto'},
				'nl': {Open: 'Openen', Calc: 'Berekenen', Find: 'Zoeken', ELS: 'ELS', Swap: 'Wisselen', Copy: 'Kopiëren', Align: 'Uitlijnen', Wrap: 'Terugloop', Mode: 'Modus', Trans: 'Vertalen', Print: 'Afdrukken', Export: 'Exporteren', Clear: 'Wissen', DB: 'DB', Help: 'Help'},
				'pl': {Open: 'Otwórz', Calc: 'Oblicz', Find: 'Znajdź', ELS: 'ELS', Swap: 'Zamień', Copy: 'Kopiuj', Align: 'Wyrównaj', Wrap: 'Zawijanie', Mode: 'Tryb', Trans: 'Tłumacz', Print: 'Drukuj', Export: 'Eksportuj', Clear: 'Wyczyść', DB: 'BD', Help: 'Pomoc'},
				'tr': {Open: 'Aç', Calc: 'Hesapla', Find: 'Bul', ELS: 'ELS', Swap: 'Değiştir', Copy: 'Kopyala', Align: 'Hizala', Wrap: 'Kaydır', Mode: 'Mod', Trans: 'Çevir', Print: 'Yazdır', Export: 'Dışa aktar', Clear: 'Temizle', DB: 'VT', Help: 'Yardım'},
				'fa': {Open: 'باز کردن', Calc: 'محاسبه', Find: 'یافتن', ELS: 'ELS', Swap: 'تعویض', Copy: 'کپی', Align: 'تراز', Wrap: 'شکستن', Mode: 'حالت', Trans: 'ترجمه', Print: 'چاپ', Export: 'صادر کردن', Clear: 'پاک کردن', DB: 'پایگاه', Help: 'راهنما'},
				'zh': {Open: '打开', Calc: '计算', Find: '查找', ELS: 'ELS', Swap: '交换', Copy: '复制', Align: '对齐', Wrap: '换行', Mode: '模式', Trans: '翻译', Print: '打印', Export: '导出', Clear: '清除', DB: '数据库', Help: '帮助'},
				'vi': {Open: 'Mở', Calc: 'Tính', Find: 'Tìm', ELS: 'ELS', Swap: 'Hoán đổi', Copy: 'Sao chép', Align: 'Căn chỉnh', Wrap: 'Ngắt dòng', Mode: 'Chế độ', Trans: 'Dịch', Print: 'In', Export: 'Xuất', Clear: 'Xóa', DB: 'CSDL', Help: 'Trợ giúp'},
				'cs': {Open: 'Otevřít', Calc: 'Vypočítat', Find: 'Najít', ELS: 'ELS', Swap: 'Vyměnit', Copy: 'Kopírovat', Align: 'Zarovnat', Wrap: 'Zalomit', Mode: 'Režim', Trans: 'Přeložit', Print: 'Tisk', Export: 'Exportovat', Clear: 'Vymazat', DB: 'DB', Help: 'Nápověda'},
				'id': {Open: 'Buka', Calc: 'Hitung', Find: 'Cari', ELS: 'ELS', Swap: 'Tukar', Copy: 'Salin', Align: 'Rata', Wrap: 'Bungkus', Mode: 'Mode', Trans: 'Terjemahkan', Print: 'Cetak', Export: 'Ekspor', Clear: 'Bersihkan', DB: 'DB', Help: 'Bantuan'},
				'ko': {Open: '열기', Calc: '계산', Find: '찾기', ELS: 'ELS', Swap: '교환', Copy: '복사', Align: '정렬', Wrap: '줄 바꿈', Mode: '모드', Trans: '번역', Print: '인쇄', Export: '내보내기', Clear: '지우기', DB: 'DB', Help: '도움말'},
				'uk': {Open: 'Відкрити', Calc: 'Обчислити', Find: 'Знайти', ELS: 'ELS', Swap: 'Поміняти', Copy: 'Копіювати', Align: 'Вирівняти', Wrap: 'Перенос', Mode: 'Режим', Trans: 'Перекласти', Print: 'Друк', Export: 'Експортувати', Clear: 'Очистити', DB: 'БД', Help: 'Допомога'},
				'hu': {Open: 'Megnyitás', Calc: 'Számítás', Find: 'Keresés', ELS: 'ELS', Swap: 'Csere', Copy: 'Másolás', Align: 'Igazítás', Wrap: 'Sortörés', Mode: 'Mód', Trans: 'Fordítás', Print: 'Nyomtatás', Export: 'Exportálás', Clear: 'Törlés', DB: 'Adatbázis', Help: 'Súgó'},
				'ar': {Open: 'فتح', Calc: 'حساب', Find: 'بحث', ELS: 'ELS', Swap: 'تبديل', Copy: 'نسخ', Align: 'محاذاة', Wrap: 'التفاف', Mode: 'وضع', Trans: 'ترجمة', Print: 'طباعة', Export: 'تصدير', Clear: 'مسح', DB: 'قاعدة بيانات', Help: 'مساعدة'}
			};
			function getLang() {
				let lang = navigator.language || navigator.userLanguage || 'en';
				lang = lang.split('-')[0];
	...
	<script>
		function toggleFind(){
			...
			// Translation logic for Find Modal
			const lang = navigator.language.split('-')[0];
			const findModalTranslations = {
				ru: { title: "Найти совпадения по гематрии", label: "Введите значение гематрии", placeholder: "Введите значение гематрии", button: "Поиск", cleanup: "Удалить ВСЕ предыдущие разметки/форматирование." },
				de: { title: "Finde Gematria-Übereinstimmungen", label: "Geben Sie den Gematria-Wert ein", placeholder: "Geben Sie den Gematria-Wert ein", button: "Suchen", cleanup: "ALLE vorherigen Textformatierungen entfernen." },
				ja: { title: "ゲマトリア一致を検索", label: "ゲマトリア値を入力", placeholder: "ゲマトリア値を入力", button: "検索", cleanup: "すべての以前のテキストマークアップ/フォーマットを削除。" },
				pt: { title: "Encontrar correspondências de gematria", label: "Digite o valor da gematria", placeholder: "Digite o valor da gematria", button: "Buscar", cleanup: "Remover TODA a formatação/marcação anterior." },
				it: { title: "Trova corrispondenze di gematria", label: "Inserisci il valore della gematria", placeholder: "Inserisci il valore della gematria", button: "Cerca", cleanup: "Rimuovi TUTTA la formattazione/marcatura precedente." },
				nl: { title: "Vind Gematria-overeenkomsten", label: "Voer gematriawaarde in", placeholder: "Voer gematriawaarde in", button: "Zoeken", cleanup: "Verwijder ALLE eerdere tekstopmaak/markering." },
				pl: { title: "Znajdź dopasowania gematrii", label: "Wpisz wartość gematrii", placeholder: "Wpisz wartość gematrii", button: "Szukaj", cleanup: "Usuń WSZYSTKIE poprzednie formatowanie/oznaczenia." },
				tr: { title: "Gematria Eşleşmelerini Bul", label: "Gematria değerini girin", placeholder: "Gematria değerini girin", button: "Ara", cleanup: "TÜM önceki metin biçimlendirmesini/işaretlemeyi kaldır." },
				fa: { title: "یافتن تطابق‌های جماتریا", label: "مقدار جماتریا را وارد کنید", placeholder: "مقدار جماتریا را وارد کنید", button: "جستجو", cleanup: "تمام قالب‌بندی/نشانه‌گذاری قبلی را حذف کنید." },
				zh: { title: "查找字母数字匹配", label: "输入字母数字值", placeholder: "输入字母数字值", button: "搜索", cleanup: "移除所有之前的文本标记/格式。" },
				vi: { title: "Tìm kết quả gematria", label: "Nhập giá trị gematria", placeholder: "Nhập giá trị gematria", button: "Tìm kiếm", cleanup: "Xóa TẤT CẢ định dạng/đánh dấu trước đó." },
				cs: { title: "Najít shody gematrie", label: "Zadejte hodnotu gematrie", placeholder: "Zadejte hodnotu gematrie", button: "Hledat", cleanup: "Odstraňte VEŠKERÉ předchozí formátování/označení." },
				id: { title: "Temukan Kecocokan Gematria", label: "Masukkan nilai gematria", placeholder: "Masukkan nilai gematria", button: "Cari", cleanup: "Hapus SEMUA penandaan/pemformatan sebelumnya." },
				ko: { title: "게마트리아 일치 찾기", label: "게마트리아 값을 입력하세요", placeholder: "게마트리아 값을 입력하세요", button: "검색", cleanup: "이전의 모든 텍스트 마크업/서식을 제거합니다." },
				uk: { title: "Знайти відповідності гематрії", label: "Введіть значення гематрії", placeholder: "Введіть значення гематрії", button: "Пошук", cleanup: "Видалити ВСІ попередні розмітки/форматування." },
				hu: { title: "Gemátria egyezések keresése", label: "Adja meg a gemátria értéket", placeholder: "Adja meg a gemátria értéket", button: "Keresés", cleanup: "Minden korábbi formázás/megjelölés eltávolítása." },
				ar: { title: "البحث عن تطابقات الجيماتريا", label: "أدخل قيمة الجيماتريا", placeholder: "أدخل قيمة الجيماتريا", button: "بحث", cleanup: "إزالة جميع التنسيقات/العلامات السابقة." },
				en: { title: "Find Gematria Matches", label: "Enter gematria value", placeholder: "Enter gematria value", button: "Search", cleanup: "Remove ALL previous text mark up / formatting." },
				fr: { title: "Trouver des correspondances de guématria", label: "Entrez la valeur de guématria", placeholder: "Entrez la valeur de guématria", button: "Rechercher", cleanup: "Supprimer TOUT le formatage / balisage précédent." },
				he: { title: "מצא התאמות גימטריה", label: "הזן ערך גימטריה", placeholder: "הזן ערך גימטריה", button: "חפש", cleanup: "הסר את כל הסימון/עיצוב הקודם." },
				es: { title: "Buscar coincidencias de gematría", label: "Ingrese el valor de gematría", placeholder: "Ingrese el valor de gematría", button: "Buscar", cleanup: "Eliminar TODO el formato/marcado anterior."}
			};
			const t = findModalTranslations[lang] || findModalTranslations.en;
			modal.innerHTML = `
				<div class="modal-content" style="width: 40%; min-width: 300px; max-width: 80vw; height: auto; min-height: 300px; max-height: 90vh;">
					...
					<div style="display: flex; flex-direction: column; gap: 5px; margin-top: 20px;">
						<label for="findInput" style="font-size: 11px; text-align: left; margin-left: 2px;">${t.label}</label>
						<div style="display: flex; flex-direction: row; align-items: center; gap: 10px;">
							<input type="text" id="findInput" placeholder="${t.placeholder}" style="text-align: left; padding: 8px; border: 1px solid #ccc; border-radius: 5px; flex-grow: 1;">
							<button id="findSearchBtn" class="textBtn" style="background-color: #3333aa; color: #fff; border: none; padding: 8px 8px 8px 8px; cursor: pointer; font-size: 12px; font-weight: bold; margin-right: 0px; border-radius: 5px; box-shadow: 2px 3px 6px rgba(0, 0, 0, 0.35); transition: background-color 0.0s;">
								<img src="img/find.png" height="16" width="14" border="0" alt="Search"><img src="img/invis.gif" width="4" border="0">${t.button}
							</button>
						</div>
						<div class="cleanup-checkbox-container">
							<input type="checkbox" id="findCleanupCheckbox" checked>
							<label for="findCleanupCheckbox">${t.cleanup}</label>
						</div>
					</div>
	...
	<script>
		function toggleELS(){
			...
			const langEls = navigator.language.split('-')[0];
			const elsModalTranslations = {
				ru: { title: "Последовательность равноудалённых букв", remove: "Удалить:", altWord1: "Альтернативное слово 1", altWord2: "Альтернативное слово 2", startLabel: "Начальная позиция", startPlaceholder: "Начальная позиция", cleanup: "Удалить ВСЕ предыдущие разметки/форматирование.", seqLabel: "Номер последовательности", seqPlaceholder: "Номер последовательности", button: "Поиск" },
				de: { title: "Gleichabständige Buchstabenfolge", remove: "Entfernen:", altWord1: "Alternatives Wort 1", altWord2: "Alternatives Wort 2", startLabel: "Startposition", startPlaceholder: "Startposition", cleanup: "ALLE vorherigen Textformatierungen entfernen.", seqLabel: "Sequenznummer", seqPlaceholder: "Sequenznummer", button: "Suchen" },
				ja: { title: "等間隔文字列", remove: "削除:", altWord1: "代替語1", altWord2: "代替語2", startLabel: "開始位置", startPlaceholder: "開始位置", cleanup: "すべての以前のテキストマークアップ/フォーマットを削除。", seqLabel: "シーケンス番号", seqPlaceholder: "シーケンス番号", button: "検索" },
				pt: { title: "Sequência de Letras Equidistantes", remove: "Remover:", altWord1: "Palavra alternativa 1", altWord2: "Palavra alternativa 2", startLabel: "Posição inicial", startPlaceholder: "Posição inicial", cleanup: "Remover TODA a formatação/marcação anterior.", seqLabel: "Número da sequência", seqPlaceholder: "Número da sequência", button: "Buscar" },
				it: { title: "Sequenza di lettere equidistanti", remove: "Rimuovi:", altWord1: "Parola alternativa 1", altWord2: "Parola alternativa 2", startLabel: "Posizione iniziale", startPlaceholder: "Posizione iniziale", cleanup: "Rimuovi TUTTA la formattazione/marcatura precedente.", seqLabel: "Numero sequenza", seqPlaceholder: "Numero sequenza", button: "Cerca" },
				nl: { title: "Equidistante Letterreeks", remove: "Verwijderen:", altWord1: "Alternatief woord 1", altWord2: "Alternatief woord 2", startLabel: "Startpositie", startPlaceholder: "Startpositie", cleanup: "Verwijder ALLE eerdere tekstopmaak/markering.", seqLabel: "Sequencenummer", seqPlaceholder: "Sequencenummer", button: "Zoeken" },
				pl: { title: "Sekwencja liter o równej odległości", remove: "Usuń:", altWord1: "Alternatywne słowo 1", altWord2: "Alternatywne słowo 2", startLabel: "Pozycja początkowa", startPlaceholder: "Pozycja początkowa", cleanup: "Usuń WSZYSTKIE poprzednie formatowanie/oznaczenia.", seqLabel: "Numer sekwencji", seqPlaceholder: "Numer sekwencji", button: "Szukaj" },
				tr: { title: "Eşit Aralıklı Harf Dizisi", remove: "Kaldır:", altWord1: "Alternatif Kelime 1", altWord2: "Alternatif Kelime 2", startLabel: "Başlangıç Pozisyonu", startPlaceholder: "Başlangıç Pozisyonu", cleanup: "TÜM önceki metin biçimlendirmesini/işaretlemeyi kaldır.", seqLabel: "Dizi Numarası", seqPlaceholder: "Dizi Numarası", button: "Ara" },
				fa: { title: "دنباله حروف با فاصله برابر", remove: "حذف:", altWord1: "کلمه جایگزین 1", altWord2: "کلمه جایگزین 2", startLabel: "موقعیت شروع", startPlaceholder: "موقعیت شروع", cleanup: "تمام قالب‌بندی/نشانه‌گذاری قبلی را حذف کنید.", seqLabel: "شماره دنباله", seqPlaceholder: "شماره دنباله", button: "جستجو" },
				zh: { title: "等距字母序列", remove: "移除:", altWord1: "替代词1", altWord2: "替代词2", startLabel: "起始位置", startPlaceholder: "起始位置", cleanup: "移除所有之前的文本标记/格式。", seqLabel: "序列号", seqPlaceholder: "序列号", button: "搜索" },
				vi: { title: "Chuỗi chữ cái cách đều", remove: "Xóa:", altWord1: "Từ thay thế 1", altWord2: "Từ thay thế 2", startLabel: "Vị trí bắt đầu", startPlaceholder: "Vị trí bắt đầu", cleanup: "Xóa TẤT CẢ định dạng/đánh dấu trước đó.", seqLabel: "Số thứ tự chuỗi", seqPlaceholder: "Số thứ tự chuỗi", button: "Tìm kiếm" },
				cs: { title: "Sekvence písmen se stejnou vzdáleností", remove: "Odstranit:", altWord1: "Alternativní slovo 1", altWord2: "Alternativní slovo 2", startLabel: "Počáteční pozice", startPlaceholder: "Počáteční pozice", cleanup: "Odstraňte VEŠKERÉ předchozí formátování/označení.", seqLabel: "Číslo sekvence", seqPlaceholder: "Číslo sekvence", button: "Hledat" },
				id: { title: "Urutan Huruf Berjarak Sama", remove: "Hapus:", altWord1: "Kata alternatif 1", altWord2: "Kata alternatif 2", startLabel: "Posisi awal", startPlaceholder: "Posisi awal", cleanup: "Hapus SEMUA penandaan/pemformatan sebelumnya.", seqLabel: "Nomor urutan", seqPlaceholder: "Nomor urutan", button: "Cari" },
				ko: { title: "등간격 문자 시퀀스", remove: "제거:", altWord1: "대체 단어 1", altWord2: "대체 단어 2", startLabel: "시작 위치", startPlaceholder: "시작 위치", cleanup: "이전의 모든 텍스트 마크업/서식을 제거합니다.", seqLabel: "시퀀스 번호", seqPlaceholder: "시퀀스 번호", button: "검색" },
				uk: { title: "Послідовність рівновіддалених букв", remove: "Видалити:", altWord1: "Альтернативне слово 1", altWord2: "Альтернативне слово 2", startLabel: "Початкова позиція", startPlaceholder: "Початкова позиція", cleanup: "Видалити ВСІ попередні розмітки/форматування.", seqLabel: "Номер послідовності", seqPlaceholder: "Номер послідовності", button: "Пошук" },
				hu: { title: "Egyenlő távolságú betűsorozat", remove: "Eltávolítás:", altWord1: "Alternatív szó 1", altWord2: "Alternatív szó 2", startLabel: "Kezdőpozíció", startPlaceholder: "Kezdőpozíció", cleanup: "Minden korábbi formázás/megjelölés eltávolítása.", seqLabel: "Sorszám", seqPlaceholder: "Sorszám", button: "Keresés" },
				ar: { title: "تسلسل الحروف المتساوية المسافة", remove: "إزالة:", altWord1: "كلمة بديلة 1", altWord2: "كلمة بديلة 2", startLabel: "موضع البدء", startPlaceholder: "موضع البدء", cleanup: "إزالة جميع التنسيقات/العلامات السابقة.", seqLabel: "رقم التسلسل", seqPlaceholder: "رقم التسلسل", button: "بحث" },
				en: { title: "Equidistant Letter Sequence", remove: "Remove:", altWord1: "Alt Word 1", altWord2: "Alt Word 2", startLabel: "Start Position", startPlaceholder: "Start Position", cleanup: "Remove ALL previous text mark up / formatting.", seqLabel: "Sequence Number", seqPlaceholder: "Sequence Number", button: "Search"},
				fr: { title: "Séquence de lettres équidistantes", remove: "Supprimer :", altWord1: "Mot alternatif 1", altWord2: "Mot alternatif 2", startLabel: "Position de départ", startPlaceholder: "Position de départ", cleanup: "Supprimer TOUT le formatage / balisage précédent.", seqLabel: "Numéro de séquence", seqPlaceholder: "Numéro de séquence", button: "Rechercher" },
				he: { title: "רצף אותיות שוות מרחק", remove: "הסר:", altWord1: "מילה חלופית 1", altWord2: "מילה חלופית 2", startLabel: "מיקום התחלה", startPlaceholder: "מיקום התחלה", cleanup: "הסר את כל הסימון/עיצוב הקודם.", seqLabel: "מספר רצף", seqPlaceholder: "מספר רצף", button: "חפש" },
				es: { title: "Secuencia de letras equidistantes", remove: "Eliminar:", altWord1: "Palabra alternativa 1", altWord2: "Palabra alternativa 2", startLabel: "Posición inicial", startPlaceholder: "Posición inicial", cleanup: "Eliminar TODO el formato/marcado anterior.", seqLabel: "Número de secuencia", seqPlaceholder: "Número de secuencia", button: "Buscar" }
			};
			const tEls = elsModalTranslations[langEls] || elsModalTranslations.en;
			const modal = document.createElement('div');
			modal.id = 'elsModal';
			modal.className = 'modal';
			modal.innerHTML = `
			...
			<h2 style="text-align: center; margin-top: 0;">${tEls.title}</h2>
			<div style="display: flex; flex-direction: column; gap: 10px; margin-top: 20px;">
			<div class="alt-word-controls" id="altWordControls" style="display: none;">
			<div class="radio-group">
			<span class="remove-label">${tEls.remove}</span>
			<div class="radio-option">
			<input type="radio" id="altWord1Radio" name="altWordSelection" value="AltWord1">
			<label for="altWord1Radio">${tEls.altWord1}<span class="asterisk">*</span></label>
			</div>
			<div class="radio-option">
			<input type="radio" id="altWord2Radio" name="altWordSelection" value="AltWord2">
			<label for="altWord2Radio">${tEls.altWord2}<span class="flower">⁕</span></label>
			</div>
			</div>
			</div>
			<div class="els-controls">
			<div class="els-input-group" style="display: flex; flex-direction: column; gap: 5px;">
			<label for="startPosition" style="font-size: 11px; text-align: center;">${tEls.startLabel}</label>
			<input type="text" id="startPosition" value="${guessStartPosition}" placeholder="${tEls.startPlaceholder}" style="text-align: center; padding: 8px; border: 1px solid #ccc; border-radius: 5px;">
			<div class="cleanup-checkbox-container">
			<input type="checkbox" id="elsCleanupCheckbox" checked>
			<label for="elsCleanupCheckbox">${tEls.cleanup}</label>
			</div>
			</div>
			<div class="els-input-group" style="display: flex; flex-direction: column; gap: 5px;">
			<label for="sequenceNum" style="font-size: 11px; text-align: center;">${tEls.seqLabel}</label>
			<input type="text" id="sequenceNum" placeholder="${tEls.seqPlaceholder}" style="text-align: center; padding: 8px; border: 1px solid #ccc; border-radius: 5px;">
			</div>
			<button id="elsSearchBtn" class="textBtn" style="background-color: #3333aa; color: #fff; border: none; padding: 8px 8px 8px 8px; cursor: pointer; font-size: 12px; font-weight: bold; margin-right: 0px; border-radius: 5px; box-shadow: 2px 3px 6px rgba(0, 0, 0, 0.35); transition: background-color 0.0s; margin-top: 21px;"><img src="img/find.png" height="16" width="14" border="0" alt="Search"><img src="img/invis.gif" width="4" border="0">${tEls.button}</button>
			</div>
			</div>
  ...
  switch (selectedOption) {
    ...
    <script>
			...
			switch (selectedValue) {
				...
				case 'AltLetterSize':
					...
					if (typeof GraphemeSplitter === 'undefined') {
						...
						eval(window.localStorage.getItem('GraphemeSplitterSrc'));
					}
					let html = textArea.innerHTML;
					const brPlaceholder = '___BR___';
					html = html.replace(/<br\s*\/?>/gi, brPlaceholder);
					 function wrapFontSizeInText(text) {
					     const splitter = new GraphemeSplitter();
					     const clusters = splitter.splitGraphemes(text);
					     return clusters.map(function(cluster) {
					         // Check for BOM/NoBreak in cluster
					         if (/[\uFEFF\u2060]|&#x2060;|&#65279;|&#xFEFF;|&#8288;|&NoBreak;/.test(cluster)) {
					             let fontSize = '14px';
					             if (/\uFEFF|&#65279;|&#xFEFF;/.test(cluster)) fontSize = '36px';
					             // Remove BOM/NoBreak for display
					             cluster = cluster.replace(/[\uFEFF\u2060]|&#65279;|&#xFEFF;|&#8288;|&NoBreak;/g, '');
					             return '<span style="font-size:' + fontSize + '">' + cluster + '</span>';
					         } else {
					             return cluster;
					         }
					     }).join('');
					 }
					// Only apply font size to the base letter following the special character
					function wrapFontSizeInText(text) {
						// Hebrew, Greek, Latin base letters
						const baseLetter = '[\u05D0-\u05EA\u05DA\u05DD\u05DF\u05E3\u05E5\u0391-\u03A9\u03B1-\u03C9a-zA-Z]';
						const bomPattern = '(?:\uFEFF|&#65279;|&#xFEFF;)';
						const noBreakPattern = '(?:\u2060|&#8288;|&#x2060;|&NoBreak;)';
						// BOM + base letter
						text = text.replace(new RegExp(bomPattern + '(' + baseLetter + ')', 'g'), function(match, p1) {
							return match.slice(0, match.length - p1.length) + '<span style="font-size:36px">' + p1 + '</span>';
						});
						// NoBreak + base letter
						text = text.replace(new RegExp(noBreakPattern + '(' + baseLetter + ')', 'g'), function(match, p1) {
							return match.slice(0, match.length - p1.length) + '<span style="font-size:14px">' + p1 + '</span>';
						});
						return text;
					}
					const tempDiv = document.createElement('div');
					...
					function walk(node) {
						if (node.nodeType === Node.TEXT_NODE) {
							const processed = wrapFontSizeInText(node.nodeValue);
					...
					walk(tempDiv);
					let finalHtml = tempDiv.innerHTML.replace(new RegExp(brPlaceholder, 'g'), '<br>');
		...
		clearBtn.addEventListener('click', async () => {
			...
			// Reset modifySelect to default on first click (not double click)
