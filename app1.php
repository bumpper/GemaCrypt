...
<head>
<script>
// === Language Detection and Translation Maps ===
function getLang() {
...
const translations = {
	'en': {title: 'GemaCrypt',	inputPlaceholder: 'Type your word here', input2Placeholder: 'Optional word to be Knit',	encryption: 'Encryption', gematria: 'Gematria',	spelling: 'Spelling', calculate: 'Calculate', transpose: 'Transpose', 
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (with Finals)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +letters', 'Kolel +word(s)': 'Kolel +word(s)', 'HaKlali': 'HaKlali', 'Reduced': 'Reduced', 'Integral Reduced': 'Integral Reduced', 'Katan': 'Katan', 'Ordinal': 'Ordinal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
        pictogramWords: {"Ox": "Ox", "House": "House", "Water": "Water", "Door": "Door", "Hand": "Hand", "Eye": "Eye", "Tooth": "Tooth", "Head": "Head", "Staff": "Staff", "Camel": "Camel", "Fish": "Fish", "Basket": "Basket", "Palm": "Palm", "Cross": "Cross", "Bow": "Bow", "Sickle": "Sickle", "Sun": "Sun", "Moon": "Moon", "Star": "Star", "Mountain": "Mountain", "Tree": "Tree", "Field": "Field", "Foot": "Foot", "Ear": "Ear", "Heart": "Heart", "Crown": "Crown"},
		resultHeaders: {"Input Phrase Gematria": "Input Phrase Gematria", "Encrypted Phrases": "Encrypted Phrases", "Encrypted Phrase Gematria": "Encrypted Phrase Gematria", "Original Input Phrase": "Original Input Phrase", "Leap": "Leap", "Skip": "Skip", "Acronym": "Acronym", "Elision": "Elision", "Finals": "Finals", "Av-Gad (Forward Exchange)": "Av-Gad (Forward Exchange)", "Knit Word": "Knit Word", "At-Ba (Backward Exchange)": "At-Ba (Backward Exchange)", "Pictogram & Meaning": "Pictogram & Meaning", "Miluy (Spelling)": "Miluy (Spelling)", "Morphs": "Morphs", "Summation": "Summation", "# of Paths": "# of Paths", "Possible Divisions": "Possible Divisions", "ThShRQ (Reversed)": "ThShRQ (Reversed)", "# of Gates": "# of Gates", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# of Words", "# of Letters": "# of Letters", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (with Finals)": "AT-BaCh (with Finals)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +letters": "Kolel +letters", "Kolel +word(s)": "Kolel +word(s)", "Reduced": "Reduced", "Integral Reduced": "Integral Reduced", "Katan": "Katan", "Ordinal": "Ordinal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati",	"Crowns (tagin)": "Crowns (tagin)", "Ananagrams": "Ananagrams",	"Gematria Matches": "Gematria Matches", "Total": "Total"}
	},
	'fr': {title: 'GemaCrypt', inputPlaceholder: 'Tapez votre mot ici', input2Placeholder: 'Mot optionnel à tricoter', encryption: 'Chiffrement', gematria: 'Guématria', spelling: 'Orthographe', calculate: 'Calculer', transpose: 'Transposer',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (avec finales)': 'AT-BaCh (avec finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +lettres', 'Kolel +word(s)': 'Kolel +mot(s)', 'HaKlali': 'HaKlali', 'Reduced': 'Réduit', 'Integral Reduced': 'Réduit intégral', 'Katan': 'Katan', 'Ordinal': 'Ordinal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Bœuf", "House": "Maison", "Water": "Eau", "Door": "Porte", "Hand": "Main", "Eye": "Œil", "Tooth": "Dent", "Head": "Tête", "Staff": "Bâton", "Camel": "Chameau", "Fish": "Poisson", "Basket": "Panier", "Palm": "Paume", "Cross": "Croix", "Bow": "Arc", "Sickle": "Faucille", "Sun": "Soleil", "Moon": "Lune", "Star": "Étoile", "Mountain": "Montagne", "Tree": "Arbre", "Field": "Champ", "Foot": "Pied", "Ear": "Oreille", "Heart": "Cœur", "Crown": "Couronne"},
		resultHeaders: {"Input Phrase Gematria": "Guématria de la phrase d'entrée", "Encrypted Phrases": "Phrases chiffrées", "Encrypted Phrase Gematria": "Guématria de la phrase chiffrée", "Original Input Phrase": "Phrase d'entrée originale", "Leap": "Saut", "Skip": "Sauter", "Acronym": "Acronyme", "Elision": "Élision", "Finals": "Finales", "Av-Gad (Forward Exchange)": "Av-Gad (Permutation avant)", "Knit Word": "Mot tricoté", "At-Ba (Backward Exchange)": "At-Ba (Permutation arrière)", "Pictogram & Meaning": "Pictogramme & signification", "Miluy (Spelling)": "Miluy (Orthographe)", "Morphes": "Morphes", "Summation": "Somme", "# of Paths": "# de chemins", "Possible Divisions": "Divisions possibles", "ThShRQ (Reversed)": "ThShRQ (Inversé)", "# of Gates": "# de portes", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# de mots", "# of Letters": "# de lettres", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (avec finales)": "AT-BaCh (avec finales)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +lettres": "Kolel +lettres", "Kolel +mot(s)": "Kolel +mot(s)", "Réduit": "Réduit", "Réduit intégral": "Réduit intégral", "Katan": "Katan", "Ordinal": "Ordinal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Couronnes (tagin)", "Ananagrams": "Ananagrammes", "Gematria Matches": "Correspondances de guématria", "Total": "Total"}
	},
	'es': {title: 'GemaCrypt', inputPlaceholder: 'Escribe tu palabra aquí', input2Placeholder: 'Palabra opcional para tejer', encryption: 'Encriptación', gematria: 'Guematria', spelling: 'Ortografía', calculate: 'Calcular', transpose: 'Transponer',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (con finales)': 'AT-BaCh (con finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +letras', 'Kolel +word(s)': 'Kolel +palabra(s)', 'HaKlali': 'HaKlali', 'Reduced': 'Reducido', 'Integral Reduced': 'Reducido integral', 'Katan': 'Katan', 'Ordinal': 'Ordinal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Buey", "House": "Casa", "Water": "Agua", "Door": "Puerta", "Hand": "Mano", "Eye": "Ojo", "Tooth": "Diente", "Head": "Cabeza", "Staff": "Bastón", "Camel": "Camello", "Fish": "Pez", "Basket": "Cesta", "Palm": "Palma", "Cross": "Cruz", "Bow": "Arco", "Sickle": "Hoz", "Sun": "Sol", "Moon": "Luna", "Star": "Estrella", "Mountain": "Montaña", "Tree": "Árbol", "Field": "Campo", "Foot": "Pie", "Ear": "Oreja", "Heart": "Corazón", "Crown": "Corona"},
		resultHeaders: {"Input Phrase Gematria": "Gematría de la frase de entrada", "Encrypted Phrases": "Frases encriptadas", "Encrypted Phrase Gematria": "Gematría de la frase encriptada", "Original Input Phrase": "Frase de entrada original", "Leap": "Salto", "Skip": "Saltar", "Acronym": "Acrónimo", "Elision": "Elisión", "Finals": "Finales", "Av-Gad (Forward Exchange)": "Av-Gad (Intercambio hacia adelante)", "Knit Word": "Palabra tejida", "At-Ba (Backward Exchange)": "At-Ba (Intercambio hacia atrás)", "Pictogram & Meaning": "Pictograma y significado", "Miluy (Spelling)": "Miluy (Ortografía)", "Morphs": "Morfos", "Summation": "Suma", "# of Paths": "# de caminos", "Possible Divisions": "Divisiones posibles", "ThShRQ (Reversed)": "ThShRQ (Invertido)", "# of Gates": "# de puertas", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# de palabras", "# of Letters": "# de letras", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (con finales)": "AT-BaCh (con finales)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +letras": "Kolel +letras", "Kolel +palabra(s)": "Kolel +palabra(s)", "Reducido": "Reducido", "Reducido integral": "Reducido integral", "Katan": "Katan", "Ordinal": "Ordinal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Coronas (tagin)", "Ananagrams": "Ananagramas", "Gematria Matches": "Coincidencias de gematría", "Total": "Total"}
	},
	'he': {title: 'גימאקריפט', inputPlaceholder: 'הקלד את מילתך כאן', input2Placeholder: 'מילה אופציונלית לסריגה', encryption: 'הצפנה', gematria: 'גימטריה', spelling: 'איות', calculate: 'חשב', transpose: 'הפוך',
		cryptMenu: {'AYiK-BeCheR': 'אייק-בכר', 'AL-BaM': 'אל-בם', 'AT-BaSh': 'את-בש', 'ACh-BI': 'אך-בי', 'AChaS-BeTA': 'אחס-בטא', 'AT-BaCh': 'את-בח', 'AT-BaCh (עם סופיות)': 'את-בח (עם סופיות)', 'AiY-BaK': 'איי-בק', 'ATz-BaPh': 'אץ-בף', 'AL-BeTh': 'אל-בת', 'Ofanim': 'אופנים'},
		gemMenu: {'Ragil': 'רגיל', 'Kolel +letters': 'כולל +אותיות', 'Kolel +word(s)': 'כולל +מילה/ות', 'HaKlali': 'הכללי', 'Reduced': 'מצומצם', 'Integral Reduced': 'מצומצם שלם', 'Katan': 'קטן', 'Ordinal': 'סידורי', 'HaKadmi': 'הקדמי', 'HaPerati': 'הפרטי', 'Miluy': 'מילוי'},
		spellMenu: {'A"B': 'א"ב', 'SaG': 'ס"ג', 'MaH': 'מ"ה', 'BaN': 'ב"ן'},
        pictogramWords: {"Ox": "שור", "House": "בית", "Water": "מים", "Door": "דלת", "Hand": "יד", "Eye": "עין", "Tooth": "שן", "Head": "ראש", "Staff": "מטה", "Camel": "גמל", "Fish": "דג", "Basket": "סל", "Palm": "כף יד", "Cross": "צלב", "Bow": "קשת", "Sickle": "מגל", "Sun": "שמש", "Moon": "ירח", "Star": "כוכב", "Mountain": "הר", "Tree": "עץ", "Field": "שדה", "Foot": "רגל", "Ear": "אוזן", "Heart": "לב", "Crown": "כתר"},
		resultHeaders: {"Input Phrase Gematria": "גימטריה של הביטוי שהוזן", "Encrypted Phrases": "ביטויים מוצפנים", "Encrypted Phrase Gematria": "גימטריה של הביטוי המוצפן", "Original Input Phrase": "הביטוי המקורי שהוזן", "Leap": "דילוג", "Skip": "דלג", "Acronym": "ראשי תיבות", "Elision": "השמטה", "Finals": "סופיות", "Av-Gad (Forward Exchange)": "אב-גד (החלפה קדימה)", "Knit Word": "מילה סרוגה", "At-Ba (Backward Exchange)": "את-בא (החלפה אחורה)", "Pictogram & Meaning": "פיקטוגרמה ומשמעות", "Miluy (Spelling)": "מילוי (איות)", "Morphs": "מורפולוגיה", "Summation": "סיכום", "# of Paths": "# של נתיבים", "Possible Divisions": "חלוקות אפשריות", "ThShRQ (Reversed)": "תשר"ק (הפוך)", "# of Gates": "# של שערים", "A\"B": "א\"ב", "SaG": "ס"ג", "MaH": "מ"ה", "BaN": "ב"ן", "# of Words": "# של מילים", "# of Letters": "# של אותיות", "Ofanim": "אופנים", "AYiK-BeCheR": "אייק-בכר", "AL-BaM": "אל-בם", "AT-BaSh": "את-בש", "ACh-BI": "אך-בי", "AChaS-BeTA": "אחס-בטא", "AiY-BaK": "איי-בק", "AT-BaCh": "את-בח", "AT-BaCh (עם סופיות)": "את-בח (עם סופיות)", "ATz-BaPh": "אץ-בף", "AL-BeTh": "אל-בת", "Ragil": "רגיל", "HaKlali": "הכללי", "כולל +אותיות": "כולל +אותיות", "כולל +מילה/ות": "כולל +מילה/ות", "מצומצם": "מצומצם", "מצומצם שלם": "מצומצם שלם", "קטן": "קטן", "סידורי": "סידורי", "הקדמי": "הקדמי", "הפרטי": "הפרטי", "Crowns (tagin)": "כתרים (תגין)", "Ananagrams": "אנאנגרמות", "Gematria Matches": "התאמות גימטריה", "Total": "סַך הַכֹּל"}
	},
	'ru': {title: 'ГемаКрипт', inputPlaceholder: 'Введите ваше слово здесь', input2Placeholder: 'Необязательное слово для вязки', encryption: 'Шифрование', gematria: 'Гематрия', spelling: 'Правописание', calculate: 'Вычислить', transpose: 'Транспонировать',
		cryptMenu: {'AYiK-BeCheR': 'АЙиК-БеЧеР', 'AL-BaM': 'АЛ-БаМ', 'AT-BaSh': 'АТ-БаШ', 'ACh-BI': 'Ах-БИ', 'AChaS-BeTA': 'Ахас-БеТА', 'AT-BaCh': 'АТ-БаХ', 'AT-BaCh (с финалами)': 'АТ-БаХ (с финалами)', 'AiY-BaK': 'АйЙ-БаК', 'ATz-BaPh': 'АТц-БаФ', 'AL-BeTh': 'АЛ-БеТ', 'Ofanim': 'Офаним'},
		gemMenu: {'Ragil': 'Рагиль', 'Kolel +letters': 'Колель +буквы', 'Kolel +word(s)': 'Колель +слово(а)', 'HaKlali': 'ХаКлали', 'Reduced': 'Упрощённый', 'Integral Reduced': 'Интегрально упрощённый', 'Katan': 'Катан', 'Ordinal': 'Порядковый', 'HaKadmi': 'ХаКадми', 'HaPerati': 'ХаПерати', 'Miluy': 'Милуй'},
		spellMenu: {'A"B': 'А"Б', 'SaG': 'СаГ', 'MaH': 'МаХ', 'BaN': 'БаН'},
        pictogramWords: {"Ox": "Бык", "House": "Дом", "Water": "Вода", "Door": "Дверь", "Hand": "Рука", "Eye": "Глаз", "Tooth": "Зуб", "Head": "Голова", "Staff": "Посох", "Camel": "Верблюд", "Fish": "Рыба", "Basket": "Корзина", "Palm": "Ладонь", "Cross": "Крест", "Bow": "Лук", "Sickle": "Серп", "Sun": "Солнце", "Moon": "Луна", "Star": "Звезда", "Mountain": "Гора", "Tree": "Дерево", "Field": "Поле", "Foot": "Нога", "Ear": "Ухо", "Heart": "Сердце", "Crown": "Корона"},
		resultHeaders: {"Input Phrase Gematria": "Гематрия введённой фразы", "Encrypted Phrases": "Зашифрованные фразы", "Encrypted Phrase Gematria": "Гематрия зашифрованной фразы", "Original Input Phrase": "Исходная введённая фраза", "Leap": "Прыжок", "Skip": "Пропустить", "Acronym": "Акроним", "Elision": "Элизия", "Finals": "Финалы", "Av-Gad (Forward Exchange)": "Ав-Гад (прямой обмен)", "Knit Word": "Связанное слово", "At-Ba (Backward Exchange)": "Ат-Ба (обратный обмен)", "Pictogram & Meaning": "Пиктограмма и значение", "Miluy (Spelling)": "Милуй (правописание)", "Morphs": "Морфы", "Summation": "Суммирование", "# of Paths": "# путей", "Possible Divisions": "Возможные деления", "ThShRQ (Reversed)": "ТШРК (обратный)", "# of Gates": "# ворот", "A\"B": "А\"Б", "SaG": "СаГ", "MaH": "МаХ", "BaN": "БаН", "# of Words": "# слов", "# of Letters": "# букв", "Ofanim": "Офаним", "AYiK-BeCheR": "АЙиК-БеЧеР", "AL-BaM": "АЛ-БаМ", "AT-BaSh": "АТ-БаШ", "ACh-BI": "Ах-БИ", "AChaS-BeTA": "Ахас-БеТА", "AiY-BaK": "АйЙ-БаК", "AT-BaCh": "АТ-БаХ", "AT-BaCh (с финалами)": "АТ-БаХ (с финалами)", "ATz-BaPh": "АТц-БаФ", "AL-BeTh": "АЛ-БеТ", "Рагиль": "Рагиль", "ХаКлали": "ХаКлали", "Колель +буквы": "Колель +буквы", "Колель +слово(а)": "Колель +слово(а)", "Упрощённый": "Упрощённый", "Интегрально упрощённый": "Интегрально упрощённый", "Катан": "Катан", "Порядковый": "Порядковый", "ХаКадми": "ХаКадми", "ХаПерати": "ХаПерати", "Crowns (tagin)": "Короны (тагин)", "Ananagrams": "Ананаграммы", "Gematria Matches": "Совпадения гематрии", "Total": "Общий"}
	},
	'de': {title: 'GemaCrypt', inputPlaceholder: 'Geben Sie Ihr Wort hier ein', input2Placeholder: 'Optionales Wort zum Verknüpfen', encryption: 'Verschlüsselung', gematria: 'Gematria', spelling: 'Rechtschreibung', calculate: 'Berechnen', transpose: 'Transponieren',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (mit Endungen)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +Buchstaben', 'Kolel +word(s)': 'Kolel +Wort/Wörter', 'HaKlali': 'HaKlali', 'Reduced': 'Reduziert', 'Integral Reduced': 'Integral reduziert', 'Katan': 'Katan', 'Ordinal': 'Ordinal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Ochse", "House": "Haus", "Water": "Wasser", "Door": "Tür", "Hand": "Hand", "Eye": "Auge", "Tooth": "Zahn", "Head": "Kopf", "Staff": "Stab", "Camel": "Kamel", "Fish": "Fisch", "Basket": "Korb", "Palm": "Handfläche", "Cross": "Kreuz", "Bow": "Bogen", "Sickle": "Sichel", "Sun": "Sonne", "Moon": "Mond", "Star": "Stern", "Mountain": "Berg", "Tree": "Baum", "Field": "Feld", "Foot": "Fuß", "Ear": "Ohr", "Heart": "Herz", "Crown": "Krone"},
		resultHeaders: {"Input Phrase Gematria": "Gematria des Eingabesatzes", "Encrypted Phrases": "Verschlüsselte Sätze", "Encrypted Phrase Gematria": "Gematria des verschlüsselten Satzes", "Original Input Phrase": "Originaler Eingabesatz", "Leap": "Sprung", "Skip": "Überspringen", "Acronym": "Akronym", "Elision": "Elision", "Finals": "Endungen", "Av-Gad (Forward Exchange)": "Av-Gad (Vorwärtswechsel)", "Knit Word": "Verknüpftes Wort", "At-Ba (Backward Exchange)": "At-Ba (Rückwärtswechsel)", "Pictogram & Meaning": "Piktogramm & Bedeutung", "Miluy (Spelling)": "Miluy (Rechtschreibung)", "Morphs": "Morphe", "Summation": "Summierung", "# of Paths": "# der Wege", "Possible Divisions": "Mögliche Teilungen", "ThShRQ (Reversed)": "ThShRQ (Umgekehrt)", "# of Gates": "# der Tore", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# der Wörter", "# of Letters": "# der Buchstaben", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (mit Endungen)": "AT-BaCh (mit Endungen)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +Buchstaben": "Kolel +Buchstaben", "Kolel +Wort/Wörter": "Kolel +Wort/Wörter", "Reduziert": "Reduziert", "Integral reduziert": "Integral reduziert", "Katan": "Katan", "Ordinal": "Ordinal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Kronen (tagin)", "Ananagrams": "Ananagramme", "Gematria Matches": "Gematria-Übereinstimmungen", "Total": "Gesamt"}
	},
	'ja': {title: 'ゲマクリプト', inputPlaceholder: 'ここに単語を入力してください', input2Placeholder: '編み込み用のオプション単語', encryption: '暗号化', gematria: 'ゲマトリア', spelling: 'スペリング', calculate: '計算', transpose: '転置',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh（ファイナル付き）', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'オファニム'},
		gemMenu: {'Ragil': 'ラギル', 'Kolel +letters': 'コレル +文字', 'Kolel +word(s)': 'コレル +単語', 'HaKlali': 'ハクラリ', 'Reduced': '簡略化', 'Integral Reduced': '完全簡略化', 'Katan': 'カタン', 'Ordinal': '序数', 'HaKadmi': 'ハカドミ', 'HaPerati': 'ハペラティ', 'Miluy': 'ミルイ'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'サグ', 'MaH': 'マハ', 'BaN': 'バン'},
        pictogramWords: {"Ox": "牛", "House": "家", "Water": "水", "Door": "ドア", "Hand": "手", "Eye": "目", "Tooth": "歯", "Head": "頭", "Staff": "杖", "Camel": "ラクダ", "Fish": "魚", "Basket": "かご", "Palm": "手のひら", "Cross": "十字架", "Bow": "弓", "Sickle": "鎌", "Sun": "太陽", "Moon": "月", "Star": "星", "Mountain": "山", "Tree": "木", "Field": "畑", "Foot": "足", "Ear": "耳", "Heart": "心", "Crown": "王冠"},
		resultHeaders: {"Input Phrase Gematria": "入力フレーズのゲマトリア", "Encrypted Phrases": "暗号化されたフレーズ", "Encrypted Phrase Gematria": "暗号化フレーズのゲマトリア", "Original Input Phrase": "元の入力フレーズ", "Leap": "リープ", "Skip": "スキップ", "Acronym": "頭字語", "Elision": "省略", "Finals": "ファイナル", "Av-Gad (Forward Exchange)": "Av-Gad（前方交換）", "Knit Word": "編み込み単語", "At-Ba (Backward Exchange)": "At-Ba（後方交換）", "Pictogram & Meaning": "絵文字と意味", "Miluy (Spelling)": "ミルイ（スペリング）", "Morphs": "モーフ", "Summation": "合計", "# of Paths": "パスの数", "Possible Divisions": "可能な分割", "ThShRQ (Reversed)": "ThShRQ（逆）", "# of Gates": "ゲートの数", "A\"B": "A\"B", "SaG": "サグ", "MaH": "マハ", "BaN": "バン", "# of Words": "単語数", "# of Letters": "文字数", "Ofanim": "オファニム", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh（ファイナル付き）": "AT-BaCh（ファイナル付き）", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "ラギル": "ラギル", "ハクラリ": "ハクラリ", "コレル +文字": "コレル +文字", "コレル +単語": "コレル +単語", "簡略化": "簡略化", "完全簡略化": "完全簡略化", "カタン": "カタン", "序数": "序数", "ハカドミ": "ハカドミ", "ハペラティ": "ハペラティ", "Crowns (tagin)": "クラウン（tagin）", "Ananagrams": "アナナグラム", "Gematria Matches": "ゲマトリア一致", "Total": "合計"}
	},
	'pt': {title: 'GemaCrypt', inputPlaceholder: 'Digite sua palavra aqui', input2Placeholder: 'Palavra opcional para entrelaçar', encryption: 'Criptografia', gematria: 'Gematria', spelling: 'Ortografia', calculate: 'Calcular', transpose: 'Transpor',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (com finais)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +letras', 'Kolel +word(s)': 'Kolel +palavra(s)', 'HaKlali': 'HaKlali', 'Reduced': 'Reduzido', 'Integral Reduced': 'Reduzido integral', 'Katan': 'Katan', 'Ordinal': 'Ordinal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Boi", "House": "Casa", "Water": "Água", "Door": "Porta", "Hand": "Mão", "Eye": "Olho", "Tooth": "Dente", "Head": "Cabeça", "Staff": "Cajado", "Camel": "Camelo", "Fish": "Peixe", "Basket": "Cesta", "Palm": "Palma", "Cross": "Cruz", "Bow": "Arco", "Sickle": "Foice", "Sun": "Sol", "Moon": "Lua", "Star": "Estrela", "Mountain": "Montanha", "Tree": "Árvore", "Field": "Campo", "Foot": "Pé", "Ear": "Orelha", "Heart": "Coração", "Crown": "Coroa"},
		resultHeaders: {"Input Phrase Gematria": "Gematria da frase de entrada", "Encrypted Phrases": "Frases criptografadas", "Encrypted Phrase Gematria": "Gematria da frase criptografada", "Original Input Phrase": "Frase de entrada original", "Leap": "Salto", "Skip": "Pular", "Acronym": "Acrônimo", "Elision": "Elisão", "Finals": "Finais", "Av-Gad (Forward Exchange)": "Av-Gad (Troca para frente)", "Knit Word": "Palavra entrelaçada", "At-Ba (Backward Exchange)": "At-Ba (Troca para trás)", "Pictogram & Meaning": "Pictograma e significado", "Miluy (Spelling)": "Miluy (Ortografia)", "Morphs": "Morfos", "Summation": "Soma", "# of Paths": "# de caminhos", "Possible Divisions": "Divisões possíveis", "ThShRQ (Reversed)": "ThShRQ (Invertido)", "# of Gates": "# de portões", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# de palavras", "# of Letters": "# de letras", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (com finais)": "AT-BaCh (com finais)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +letras": "Kolel +letras", "Kolel +palavra(s)": "Kolel +palavra(s)", "Reduzido": "Reduzido", "Reduzido integral": "Reduzido integral", "Katan": "Katan", "Ordinal": "Ordinal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Coroas (tagin)", "Ananagrams": "Ananagramas", "Gematria Matches": "Correspondências de gematria", "Total": "Total"}
	},
	'it': {title: 'GemaCrypt', inputPlaceholder: 'Digita la tua parola qui', input2Placeholder: 'Parola opzionale da intrecciare', encryption: 'Crittografia', gematria: 'Ghematria', spelling: 'Ortografia', calculate: 'Calcola', transpose: 'Trasponi',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (con finali)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +lettere', 'Kolel +word(s)': 'Kolel +parola/e', 'HaKlali': 'HaKlali', 'Reduced': 'Ridotto', 'Integral Reduced': 'Ridotto integrale', 'Katan': 'Katan', 'Ordinal': 'Ordinale', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Bue", "House": "Casa", "Water": "Acqua", "Door": "Porta", "Hand": "Mano", "Eye": "Occhio", "Tooth": "Dente", "Head": "Testa", "Staff": "Bastone", "Camel": "Cammello", "Fish": "Pesce", "Basket": "Cesto", "Palm": "Palmo", "Cross": "Croce", "Bow": "Arco", "Sickle": "Falce", "Sun": "Sole", "Moon": "Luna", "Star": "Stella", "Mountain": "Montagna", "Tree": "Albero", "Field": "Campo", "Foot": "Piede", "Ear": "Orecchio", "Heart": "Cuore", "Crown": "Corona"},
		resultHeaders: {"Input Phrase Gematria": "Ghematria della frase di input", "Encrypted Phrases": "Frasi criptate", "Encrypted Phrase Gematria": "Ghematria della frase criptata", "Original Input Phrase": "Frase di input originale", "Leap": "Salto", "Skip": "Salta", "Acronym": "Acronimo", "Elision": "Elisione", "Finals": "Finali", "Av-Gad (Forward Exchange)": "Av-Gad (Scambio in avanti)", "Knit Word": "Parola intrecciata", "At-Ba (Backward Exchange)": "At-Ba (Scambio indietro)", "Pictogram & Meaning": "Pittogramma e significato", "Miluy (Spelling)": "Miluy (Ortografia)", "Morphs": "Morfemi", "Summation": "Somma", "# of Paths": "# di percorsi", "Possible Divisions": "Divisioni possibili", "ThShRQ (Reversed)": "ThShRQ (Invertito)", "# of Gates": "# di porte", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# di parole", "# of Letters": "# di lettere", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (con finali)": "AT-BaCh (con finali)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +lettere": "Kolel +lettere", "Kolel +parola/e": "Kolel +parola/e", "Ridotto": "Ridotto", "Ridotto integrale": "Ridotto integrale", "Katan": "Katan", "Ordinale": "Ordinale", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Corone (tagin)", "Ananagrams": "Ananagrammi", "Gematria Matches": "Corrispondenze di ghematria", "Total": "Totale"}
	},
	'nl': {title: 'GemaCrypt', inputPlaceholder: 'Typ hier uw woord', input2Placeholder: 'Optioneel woord om te verweven', encryption: 'Versleuteling', gematria: 'Gematria', spelling: 'Spelling', calculate: 'Berekenen', transpose: 'Transponeren',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (met finales)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +letters', 'Kolel +word(s)': 'Kolel +woord(en)', 'HaKlali': 'HaKlali', 'Reduced': 'Verminderd', 'Integral Reduced': 'Integraal verminderd', 'Katan': 'Katan', 'Ordinal': 'Ordinaal', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Os", "House": "Huis", "Water": "Water", "Door": "Deur", "Hand": "Hand", "Eye": "Oog", "Tooth": "Tand", "Head": "Hoofd", "Staff": "Staf", "Camel": "Kameel", "Fish": "Vis", "Basket": "Mand", "Palm": "Handpalm", "Cross": "Kruis", "Bow": "Boog", "Sickle": "Sikkel", "Sun": "Zon", "Moon": "Maan", "Star": "Ster", "Mountain": "Berg", "Tree": "Boom", "Field": "Veld", "Foot": "Voet", "Ear": "Oor", "Heart": "Hart", "Crown": "Kroon"},
		resultHeaders: {"Input Phrase Gematria": "Gematria van de invoerzin", "Encrypted Phrases": "Versleutelde zinnen", "Encrypted Phrase Gematria": "Gematria van de versleutelde zin", "Original Input Phrase": "Originele invoerzin", "Leap": "Sprong", "Skip": "Overslaan", "Acronym": "Acroniem", "Elision": "Elisie", "Finals": "Finales", "Av-Gad (Forward Exchange)": "Av-Gad (Voorwaartse uitwisseling)", "Knit Word": "Verweven woord", "At-Ba (Backward Exchange)": "At-Ba (Achterwaartse uitwisseling)", "Pictogram & Meaning": "Pictogram & betekenis", "Miluy (Spelling)": "Miluy (Spelling)", "Morphs": "Morfemen", "Summation": "Som", "# of Paths": "# paden", "Possible Divisions": "Mogelijke verdelingen", "ThShRQ (Reversed)": "ThShRQ (Omgekeerd)", "# of Gates": "# poorten", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# woorden", "# of Letters": "# letters", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (met finales)": "AT-BaCh (met finales)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +letters": "Kolel +letters", "Kolel +woord(en)": "Kolel +woord(en)", "Verminderd": "Verminderd", "Integraal verminderd": "Integraal verminderd", "Katan": "Katan", "Ordinaal": "Ordinaal", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Kronen (tagin)", "Ananagrams": "Ananagrammen", "Gematria Matches": "Gematria-overeenkomsten", "Total": "Totaal"}
	},
	'pl': {title: 'GemaCrypt', inputPlaceholder: 'Wpisz tutaj swoje słowo', input2Placeholder: 'Opcjonalne słowo do splatania', encryption: 'Szyfrowanie', gematria: 'Gematria', spelling: 'Pisownia', calculate: 'Oblicz', transpose: 'Transpozycja',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (z końcówkami)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +litery', 'Kolel +word(s)': 'Kolel +słowo(a)', 'HaKlali': 'HaKlali', 'Reduced': 'Zredukowany', 'Integral Reduced': 'Całkowicie zredukowany', 'Katan': 'Katan', 'Ordinal': 'Porządkowy', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Wół", "House": "Dom", "Water": "Woda", "Door": "Drzwi", "Hand": "Ręka", "Eye": "Oko", "Tooth": "Ząb", "Head": "Głowa", "Staff": "Laska", "Camel": "Wielbłąd", "Fish": "Ryba", "Basket": "Kosz", "Palm": "Dłoń", "Cross": "Krzyż", "Bow": "Łuk", "Sickle": "Sierp", "Sun": "Słońce", "Moon": "Księżyc", "Star": "Gwiazda", "Mountain": "Góra", "Tree": "Drzewo", "Field": "Pole", "Foot": "Stopa", "Ear": "Ucho", "Heart": "Serce", "Crown": "Korona"},
		resultHeaders: {"Input Phrase Gematria": "Gematria frazy wejściowej", "Encrypted Phrases": "Zaszyfrowane frazy", "Encrypted Phrase Gematria": "Gematria zaszyfrowanej frazy", "Original Input Phrase": "Oryginalna fraza wejściowa", "Leap": "Skok", "Skip": "Pomiń", "Acronym": "Akronim", "Elision": "Elizja", "Finals": "Końcówki", "Av-Gad (Forward Exchange)": "Av-Gad (Wymiana do przodu)", "Knit Word": "Splecione słowo", "At-Ba (Backward Exchange)": "At-Ba (Wymiana do tyłu)", "Pictogram & Meaning": "Piktogram i znaczenie", "Miluy (Spelling)": "Miluy (Pisownia)", "Morphs": "Morfemy", "Summation": "Suma", "# of Paths": "# ścieżek", "Possible Divisions": "Możliwe podziały", "ThShRQ (Reversed)": "ThShRQ (Odwrócone)", "# of Gates": "# bram", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# słów", "# of Letters": "# liter", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (z końcówkami)": "AT-BaCh (z końcówkami)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +litery": "Kolel +litery", "Kolel +słowo(a)": "Kolel +słowo(a)", "Zredukowany": "Zredukowany", "Całkowicie zredukowany": "Całkowicie zredukowany", "Katan": "Katan", "Porządkowy": "Porządkowy", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Korony (tagin)", "Ananagrams": "Ananagramy", "Gematria Matches": "Dopasowania gematrii", "Total": "Całkowity"}
	},
	'tr': {title: 'GemaCrypt', inputPlaceholder: 'Kelimenizi buraya yazın', input2Placeholder: 'Örgü için isteğe bağlı kelime', encryption: 'Şifreleme', gematria: 'Gematria', spelling: 'Yazım', calculate: 'Hesapla', transpose: 'Transpoze et',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (final harflerle)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +harfler', 'Kolel +word(s)': 'Kolel +kelime(ler)', 'HaKlali': 'HaKlali', 'Reduced': 'Azaltılmış', 'Integral Reduced': 'Tamamen azaltılmış', 'Katan': 'Katan', 'Ordinal': 'Sıralı', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Öküz", "House": "Ev", "Water": "Su", "Door": "Kapı", "Hand": "El", "Eye": "Göz", "Tooth": "Diş", "Head": "Baş", "Staff": "Değnek", "Camel": "Deve", "Fish": "Balık", "Basket": "Sepet", "Palm": "Avuç", "Cross": "Haç", "Bow": "Yay", "Sickle": "Orak", "Sun": "Güneş", "Moon": "Ay", "Star": "Yıldız", "Mountain": "Dağ", "Tree": "Ağaç", "Field": "Tarla", "Foot": "Ayak", "Ear": "Kulak", "Heart": "Kalp", "Crown": "Taç"},
		resultHeaders: {"Input Phrase Gematria": "Girdi ifadesinin gematria'sı", "Encrypted Phrases": "Şifrelenmiş ifadeler", "Encrypted Phrase Gematria": "Şifrelenmiş ifadenin gematria'sı", "Original Input Phrase": "Orijinal girdi ifadesi", "Leap": "Atlama", "Skip": "Atla", "Acronym": "Kısaltma", "Elision": "Eksiltme", "Finals": "Final harfler", "Av-Gad (Forward Exchange)": "Av-Gad (İleri değişim)", "Knit Word": "Örgü kelime", "At-Ba (Backward Exchange)": "At-Ba (Geri değişim)", "Pictogram & Meaning": "Piktogram & anlamı", "Miluy (Spelling)": "Miluy (Yazım)", "Morphs": "Morfemler", "Summation": "Toplam", "# of Paths": "# yol", "Possible Divisions": "Olası bölümler", "ThShRQ (Reversed)": "ThShRQ (Ters)", "# of Gates": "# kapı", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# kelime", "# of Letters": "# harf", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (final harflerle)": "AT-BaCh (final harflerle)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +harfler": "Kolel +harfler", "Kolel +kelime(ler)": "Kolel +kelime(ler)", "Azaltılmış": "Azaltılmış", "Tamamen azaltılmış": "Tamamen azaltılmış", "Katan": "Katan", "Sıralı": "Sıralı", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Taçlar (tagin)", "Ananagrams": "Ananagramlar", "Gematria Matches": "Gematria eşleşmeleri", "Total": "Toplam"}
	},
	'fa': {title: 'گماکریپت', inputPlaceholder: 'کلمه خود را اینجا وارد کنید', input2Placeholder: 'کلمه اختیاری برای بافتن', encryption: 'رمزگذاری', gematria: 'جماتریا', spelling: 'املا', calculate: 'محاسبه', transpose: 'تبدیل',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (با حروف پایانی)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'اوفانیم'},
		gemMenu: {'Ragil': 'راگیل', 'Kolel +letters': 'کولل +حروف', 'Kolel +word(s)': 'کولل +کلمه(ها)', 'HaKlali': 'هاکلالی', 'Reduced': 'کاهش یافته', 'Integral Reduced': 'کاهش یافته کامل', 'Katan': 'کتان', 'Ordinal': 'ترتیبی', 'HaKadmi': 'هاکادمی', 'HaPerati': 'هاپراتی', 'Miluy': 'میلوی'},
		spellMenu: {'A"B': 'آ"ب', 'SaG': 'ساگ', 'MaH': 'ماه', 'BaN': 'بان'},
		pictogramWords: {"Ox": "گاو", "House": "خانه", "Water": "آب", "Door": "در", "Hand": "دست", "Eye": "چشم", "Tooth": "دندان", "Head": "سر", "Staff": "عصا", "Camel": "شتر", "Fish": "ماهی", "Basket": "سبد", "Palm": "کف دست", "Cross": "صلیب", "Bow": "کمان", "Sickle": "داس", "Sun": "خورشید", "Moon": "ماه", "Star": "ستاره", "Mountain": "کوه", "Tree": "درخت", "Field": "مزرعه", "Foot": "پا", "Ear": "گوش", "Heart": "قلب", "Crown": "تاج"},
		resultHeaders: {"Input Phrase Gematria": "جماتریای عبارت ورودی", "Encrypted Phrases": "عبارات رمزگذاری شده", "Encrypted Phrase Gematria": "جماتریای عبارت رمزگذاری شده", "Original Input Phrase": "عبارت ورودی اصلی", "Leap": "پرش", "Skip": "رد کردن", "Acronym": "سرواژه", "Elision": "حذف", "Finals": "حروف پایانی", "Av-Gad (Forward Exchange)": "Av-Gad (تبادل به جلو)", "Knit Word": "کلمه بافته شده", "At-Ba (Backward Exchange)": "At-Ba (تبادل به عقب)", "Pictogram & Meaning": "تصویرنگاشت و معنی", "Miluy (Spelling)": "میلوی (املا)", "Morphs": "ریخت‌ها", "Summation": "جمع", "# of Paths": "# مسیرها", "Possible Divisions": "تقسیمات ممکن", "ThShRQ (Reversed)": "ThShRQ (معکوس)", "# of Gates": "# دروازه‌ها", "A\"B": "آ\"ب", "SaG": "ساگ", "MaH": "ماه", "BaN": "بان", "# of Words": "# کلمات", "# of Letters": "# حروف", "Ofanim": "اوفانیم", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (با حروف پایانی)": "AT-BaCh (با حروف پایانی)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "راگیل": "راگیل", "کولل +حروف": "کولل +حروف", "کولل +کلمه(ها)": "کولل +کلمه(ها)", "هاکلالی": "هاکلالی", "کاهش یافته": "کاهش یافته", "کاهش یافته کامل": "کاهش یافته کامل", "کتان": "کتان", "ترتیبی": "ترتیبی", "هاکادمی": "هاکادمی", "هاپراتی": "هاپراتی", "Crowns (tagin)": "تاج‌ها (tagin)", "Ananagrams": "آناناگرام‌ها", "Gematria Matches": "تطابقات جماتریا", "Total": "مجموع"}
	},
	'zh': {title: '字母密码', inputPlaceholder: '在此输入您的单词', input2Placeholder: '用于编织的可选单词', encryption: '加密', gematria: '字母数字', spelling: '拼写', calculate: '计算', transpose: '转置',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh（含尾字母）', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': '奥法尼姆'},
		gemMenu: {'Ragil': '拉吉尔', 'Kolel +letters': 'Kolel +字母', 'Kolel +word(s)': 'Kolel +单词', 'HaKlali': '哈克拉利', 'Reduced': '简化', 'Integral Reduced': '完全简化', 'Katan': '卡坦', 'Ordinal': '序数', 'HaKadmi': '哈卡德米', 'HaPerati': '哈佩拉蒂', 'Miluy': '米卢伊'},
		spellMenu: {'A"B': 'A"B', 'SaG': '萨格', 'MaH': '马哈', 'BaN': '班'},
		pictogramWords: {"Ox": "牛", "House": "房子", "Water": "水", "Door": "门", "Hand": "手", "Eye": "眼睛", "Tooth": "牙齿", "Head": "头", "Staff": "杖", "Camel": "骆驼", "Fish": "鱼", "Basket": "篮子", "Palm": "手掌", "Cross": "十字", "Bow": "弓", "Sickle": "镰刀", "Sun": "太阳", "Moon": "月亮", "Star": "星星", "Mountain": "山", "Tree": "树", "Field": "田", "Foot": "脚", "Ear": "耳朵", "Heart": "心脏", "Crown": "王冠"},
		resultHeaders: {"Input Phrase Gematria": "输入短语的字母数字", "Encrypted Phrases": "加密短语", "Encrypted Phrase Gematria": "加密短语的字母数字", "Original Input Phrase": "原始输入短语", "Leap": "跳跃", "Skip": "跳过", "Acronym": "首字母缩略词", "Elision": "省略", "Finals": "尾字母", "Av-Gad (Forward Exchange)": "Av-Gad（前向交换）", "Knit Word": "编织词", "At-Ba (Backward Exchange)": "At-Ba（后向交换）", "Pictogram & Meaning": "象形图与含义", "Miluy (Spelling)": "米卢伊（拼写）", "Morphs": "变形", "Summation": "总和", "# of Paths": "路径数", "Possible Divisions": "可能的分割", "ThShRQ (Reversed)": "ThShRQ（反向）", "# of Gates": "门数", "A\"B": "A\"B", "SaG": "萨格", "MaH": "马哈", "BaN": "班", "# of Words": "单词数", "# of Letters": "字母数", "奥法尼姆": "奥法尼姆", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh（含尾字母）": "AT-BaCh（含尾字母）", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "拉吉尔": "拉吉尔", "哈克拉利": "哈克拉利", "Kolel +字母": "Kolel +字母", "Kolel +单词": "Kolel +单词", "简化": "简化", "完全简化": "完全简化", "卡坦": "卡坦", "序数": "序数", "哈卡德米": "哈卡德米", "哈佩拉蒂": "哈佩拉蒂", "Crowns (tagin)": "冠（tagin）", "Ananagrams": "无字母重排", "Gematria Matches": "字母数字匹配", "Total": "全部的"}
	},
	'vi': {title: 'GemaCrypt', inputPlaceholder: 'Nhập từ của bạn tại đây', input2Placeholder: 'Từ tùy chọn để đan', encryption: 'Mã hóa', gematria: 'Gematria', spelling: 'Chính tả', calculate: 'Tính', transpose: 'Chuyển vị',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (với ký tự cuối)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +chữ cái', 'Kolel +word(s)': 'Kolel +từ', 'HaKlali': 'HaKlali', 'Reduced': 'Giảm', 'Integral Reduced': 'Giảm hoàn toàn', 'Katan': 'Katan', 'Ordinal': 'Thứ tự', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Bò", "House": "Nhà", "Water": "Nước", "Door": "Cửa", "Hand": "Tay", "Eye": "Mắt", "Tooth": "Răng", "Head": "Đầu", "Staff": "Gậy", "Camel": "Lạc đà", "Fish": "Cá", "Basket": "Giỏ", "Palm": "Lòng bàn tay", "Cross": "Thánh giá", "Bow": "Cung", "Sickle": "Lưỡi liềm", "Sun": "Mặt trời", "Moon": "Mặt trăng", "Star": "Ngôi sao", "Mountain": "Núi", "Tree": "Cây", "Field": "Cánh đồng", "Foot": "Bàn chân", "Ear": "Tai", "Heart": "Trái tim", "Crown": "Vương miện"},
		resultHeaders: {"Input Phrase Gematria": "Gematria của cụm từ nhập vào", "Encrypted Phrases": "Cụm từ đã mã hóa", "Encrypted Phrase Gematria": "Gematria của cụm từ đã mã hóa", "Original Input Phrase": "Cụm từ nhập vào gốc", "Leap": "Bước nhảy", "Skip": "Bỏ qua", "Acronym": "Từ viết tắt", "Elision": "Lược bỏ", "Finals": "Ký tự cuối", "Av-Gad (Forward Exchange)": "Av-Gad (Hoán đổi tiến)", "Knit Word": "Từ đan", "At-Ba (Backward Exchange)": "At-Ba (Hoán đổi lùi)", "Pictogram & Meaning": "Biểu tượng & ý nghĩa", "Miluy (Spelling)": "Miluy (Chính tả)", "Morphs": "Hình thái", "Summation": "Tổng", "# of Paths": "# đường đi", "Possible Divisions": "Phân chia có thể", "ThShRQ (Reversed)": "ThShRQ (Đảo ngược)", "# of Gates": "# cổng", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# từ", "# of Letters": "# chữ cái", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (với ký tự cuối)": "AT-BaCh (với ký tự cuối)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +chữ cái": "Kolel +chữ cái", "Kolel +từ": "Kolel +từ", "Giảm": "Giảm", "Giảm hoàn toàn": "Giảm hoàn toàn", "Katan": "Katan", "Thứ tự": "Thứ tự", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Vương miện (tagin)", "Ananagrams": "Ananagrams", "Gematria Matches": "Kết quả gematria", "Total": "Tổng cộng"}
	},
	'cs': {title: 'GemaCrypt', inputPlaceholder: 'Zadejte zde své slovo', input2Placeholder: 'Volitelné slovo k pletení', encryption: 'Šifrování', gematria: 'Gematrie', spelling: 'Pravopis', calculate: 'Vypočítat', transpose: 'Transponovat',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (s koncovkami)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +písmena', 'Kolel +word(s)': 'Kolel +slovo(a)', 'HaKlali': 'HaKlali', 'Reduced': 'Redukováno', 'Integral Reduced': 'Plně redukováno', 'Katan': 'Katan', 'Ordinal': 'Ordinační', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Vůl", "House": "Dům", "Water": "Voda", "Door": "Dveře", "Hand": "Ruka", "Eye": "Oko", "Tooth": "Zub", "Head": "Hlava", "Staff": "Hůl", "Camel": "Velbloud", "Fish": "Ryba", "Basket": "Koš", "Palm": "Dlaň", "Cross": "Kříž", "Bow": "Luk", "Sickle": "Srpek", "Sun": "Slunce", "Moon": "Měsíc", "Star": "Hvězda", "Mountain": "Hora", "Tree": "Strom", "Field": "Pole", "Foot": "Noha", "Ear": "Ucho", "Heart": "Srdce", "Crown": "Koruna"},
		resultHeaders: {"Input Phrase Gematria": "Gematrie vstupní fráze", "Encrypted Phrases": "Šifrované fráze", "Encrypted Phrase Gematria": "Gematrie šifrované fráze", "Original Input Phrase": "Původní vstupní fráze", "Leap": "Skok", "Skip": "Přeskočit", "Acronym": "Akronym", "Elision": "Elize", "Finals": "Koncovky", "Av-Gad (Forward Exchange)": "Av-Gad (Výměna vpřed)", "Knit Word": "Pletene slovo", "At-Ba (Backward Exchange)": "At-Ba (Výměna zpět)", "Pictogram & Meaning": "Piktogram & význam", "Miluy (Spelling)": "Miluy (Pravopis)", "Morphs": "Morfémy", "Summation": "Součet", "# of Paths": "# cest", "Possible Divisions": "Možné dělení", "ThShRQ (Reversed)": "ThShRQ (Obráceně)", "# of Gates": "# bran", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# slov", "# of Letters": "# písmen", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (s koncovkami)": "AT-BaCh (s koncovkami)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +písmena": "Kolel +písmena", "Kolel +slovo(a)": "Kolel +slovo(a)", "Redukováno": "Redukováno", "Plně redukováno": "Plně redukováno", "Katan": "Katan", "Ordinační": "Ordinační", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Koruny (tagin)", "Ananagrams": "Ananagramy", "Gematria Matches": "Shody gematrie", "Total": "Celkový"}
	},
	'id': {title: 'GemaCrypt', inputPlaceholder: 'Ketik kata Anda di sini', input2Placeholder: 'Kata opsional untuk dirajut', encryption: 'Enkripsi', gematria: 'Gematria', spelling: 'Ejaan', calculate: 'Hitung', transpose: 'Transposisi',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (dengan huruf akhir)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +huruf', 'Kolel +word(s)': 'Kolel +kata', 'HaKlali': 'HaKlali', 'Reduced': 'Dikurangi', 'Integral Reduced': 'Dikurangi penuh', 'Katan': 'Katan', 'Ordinal': 'Urutan', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Sapi", "House": "Rumah", "Water": "Air", "Door": "Pintu", "Hand": "Tangan", "Eye": "Mata", "Tooth": "Gigi", "Head": "Kepala", "Staff": "Tongkat", "Camel": "Unta", "Fish": "Ikan", "Basket": "Keranjang", "Palm": "Telapak tangan", "Cross": "Salib", "Bow": "Busur", "Sickle": "Sabit", "Sun": "Matahari", "Moon": "Bulan", "Star": "Bintang", "Mountain": "Gunung", "Tree": "Pohon", "Field": "Ladang", "Foot": "Kaki", "Ear": "Telinga", "Heart": "Hati", "Crown": "Mahkota"},
		resultHeaders: {"Input Phrase Gematria": "Gematria frasa masukan", "Encrypted Phrases": "Frasa terenkripsi", "Encrypted Phrase Gematria": "Gematria frasa terenkripsi", "Original Input Phrase": "Frasa masukan asli", "Leap": "Lompatan", "Skip": "Lewati", "Acronym": "Akronim", "Elision": "Penghilangan", "Finals": "Huruf akhir", "Av-Gad (Forward Exchange)": "Av-Gad (Pertukaran maju)", "Knit Word": "Kata rajutan", "At-Ba (Backward Exchange)": "At-Ba (Pertukaran mundur)", "Pictogram & Meaning": "Piktogram & arti", "Miluy (Spelling)": "Miluy (Ejaan)", "Morphs": "Morfem", "Summation": "Penjumlahan", "# of Paths": "# jalur", "Possible Divisions": "Pembagian mungkin", "ThShRQ (Reversed)": "ThShRQ (Terbalik)", "# of Gates": "# gerbang", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# kata", "# of Letters": "# huruf", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (dengan huruf akhir)": "AT-BaCh (dengan huruf akhir)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +huruf": "Kolel +huruf", "Kolel +kata": "Kolel +kata", "Dikurangi": "Dikurangi", "Dikurangi penuh": "Dikurangi penuh", "Katan": "Katan", "Urutan": "Urutan", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Mahkota (tagin)", "Ananagrams": "Ananagram", "Gematria Matches": "Kecocokan gematria", "Total": "Total"}
	},
	'ko': {title: '게마크립트', inputPlaceholder: '여기에 단어를 입력하세요', input2Placeholder: '편직용 선택 단어', encryption: '암호화', gematria: '게마트리아', spelling: '철자', calculate: '계산', transpose: '전치',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (종결 문자 포함)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': '오파님'},
		gemMenu: {'Ragil': '라길', 'Kolel +letters': 'Kolel +글자', 'Kolel +word(s)': 'Kolel +단어', 'HaKlali': '하클랄리', 'Reduced': '축소', 'Integral Reduced': '완전 축소', 'Katan': '카탄', 'Ordinal': '서수', 'HaKadmi': '하카드미', 'HaPerati': '하페라티', 'Miluy': '밀루이'},
		spellMenu: {'A"B': 'A"B', 'SaG': '사그', 'MaH': '마흐', 'BaN': '반'},
		pictogramWords: {"Ox": "소", "House": "집", "Water": "물", "Door": "문", "Hand": "손", "Eye": "눈", "Tooth": "이", "Head": "머리", "Staff": "지팡이", "Camel": "낙타", "Fish": "물고기", "Basket": "바구니", "Palm": "손바닥", "Cross": "십자가", "Bow": "활", "Sickle": "낫", "Sun": "태양", "Moon": "달", "Star": "별", "Mountain": "산", "Tree": "나무", "Field": "들", "Foot": "발", "Ear": "귀", "Heart": "심장", "Crown": "왕관"},
		resultHeaders: {"Input Phrase Gematria": "입력 구문의 게마트리아", "Encrypted Phrases": "암호화된 구문", "Encrypted Phrase Gematria": "암호화된 구문의 게마트리아", "Original Input Phrase": "원본 입력 구문", "Leap": "도약", "Skip": "건너뛰기", "Acronym": "두문자어", "Elision": "생략", "Finals": "종결 문자", "Av-Gad (Forward Exchange)": "Av-Gad (전방 교환)", "Knit Word": "편직 단어", "At-Ba (Backward Exchange)": "At-Ba (후방 교환)", "Pictogram & Meaning": "그림문자 및 의미", "Miluy (Spelling)": "밀루이 (철자)", "Morphs": "형태소", "Summation": "합계", "# of Paths": "# 경로", "Possible Divisions": "가능한 분할", "ThShRQ (Reversed)": "ThShRQ (역순)", "# of Gates": "# 게이트", "A\"B": "A\"B", "SaG": "사그", "MaH": "마흐", "BaN": "반", "# of Words": "# 단어", "# of Letters": "# 글자", "오파님": "오파님", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (종결 문자 포함)": "AT-BaCh (종결 문자 포함)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "라길": "라길", "하클랄리": "하클랄리", "Kolel +글자": "Kolel +글자", "Kolel +단어": "Kolel +단어", "축소": "축소", "완전 축소": "완전 축소", "카탄": "카탄", "서수": "서수", "하카드미": "하카드미", "하페라티": "하페라티", "Crowns (tagin)": "왕관 (tagin)", "Ananagrams": "아나나그램", "Gematria Matches": "게마트리아 일치", "Total": "총"}
	},
	'uk': {title: 'ГемаКріпт', inputPlaceholder: 'Введіть своє слово тут', input2Placeholder: 'Необов’язкове слово для плетіння', encryption: 'Шифрування', gematria: 'Гематрія', spelling: 'Правопис', calculate: 'Обчислити', transpose: 'Транспонувати',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'Ах-БІ', 'AChaS-BeTA': 'Ахас-БеТА', 'AT-BaCh': 'АТ-Бах', 'AT-BaCh (with Finals)': 'АТ-Бах (з фіналами)', 'AiY-BaK': 'АйЙ-Бак', 'ATz-BaPh': 'АТц-Баф', 'AL-BeTh': 'АЛ-Бет', 'Ofanim': 'Офанім'},
		gemMenu: {'Ragil': 'Рагіль', 'Kolel +letters': 'Колель +літери', 'Kolel +word(s)': 'Колель +слово(а)', 'HaKlali': 'ХаКлалі', 'Reduced': 'Зменшено', 'Integral Reduced': 'Повністю зменшено', 'Katan': 'Катан', 'Ordinal': 'Порядковий', 'HaKadmi': 'ХаКадмі', 'HaPerati': 'ХаПераті', 'Miluy': 'Мілуй'},
		spellMenu: {'A"B': 'А"Б', 'SaG': 'СаГ', 'MaH': 'МаХ', 'BaN': 'БаН'},
		pictogramWords: {"Ox": "Віл", "House": "Дім", "Water": "Вода", "Door": "Двері", "Hand": "Рука", "Eye": "Око", "Tooth": "Зуб", "Head": "Голова", "Staff": "Посох", "Camel": "Верблюд", "Fish": "Риба", "Basket": "Кошик", "Palm": "Долоня", "Cross": "Хрест", "Bow": "Лук", "Sickle": "Серп", "Sun": "Сонце", "Moon": "Місяць", "Star": "Зірка", "Mountain": "Гора", "Tree": "Дерево", "Field": "Поле", "Foot": "Нога", "Ear": "Вухо", "Heart": "Серце", "Crown": "Корона"},
		resultHeaders: {"Input Phrase Gematria": "Гематрія вхідної фрази", "Encrypted Phrases": "Зашифровані фрази", "Encrypted Phrase Gematria": "Гематрія зашифрованої фрази", "Original Input Phrase": "Оригінальна вхідна фраза", "Leap": "Стрибок", "Skip": "Пропустити", "Acronym": "Акронім", "Elision": "Елізія", "Finals": "Фінали", "Av-Gad (Forward Exchange)": "Av-Gad (Прямий обмін)", "Knit Word": "Зв’язане слово", "At-Ba (Backward Exchange)": "At-Ba (Зворотний обмін)", "Pictogram & Meaning": "Піктограма та значення", "Miluy (Spelling)": "Miluy (Правопис)", "Morphs": "Морфи", "Summation": "Сума", "# of Paths": "# шляхів", "Possible Divisions": "Можливі поділи", "ThShRQ (Reversed)": "ThShRQ (Зворотний)", "# of Gates": "# воріт", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# слів", "# of Letters": "# літер", "Офанім": "Офанім", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "Ах-БІ", "AChaS-BeTA": "Ахас-БеТА", "AiY-BaK": "АйЙ-Бак", "AT-Бах": "АТ-Бах", "АТ-Бах (з фіналами)": "АТ-Бах (з фіналами)", "АТц-Баф": "АТц-Баф", "АЛ-Бет": "АЛ-Бет", "Рагіль": "Рагіль", "ХаКлалі": "ХаКлалі", "Колель +літери": "Колель +літери", "Колель +слово(а)": "Колель +слово(а)", "Зменшено": "Зменшено", "Повністю зменшено": "Повністю зменшено", "Катан": "Катан", "Порядковий": "Порядковий", "ХаКадмі": "ХаКадмі", "ХаПераті": "ХаПераті", "Crowns (tagin)": "Корони (tagin)", "Ananagrams": "Ананаграми", "Gematria Matches": "Відповідності гематрії", "Total": "Всього"}
	},
	'hu': {title: 'GemaCrypt', inputPlaceholder: 'Írja be ide a szavát', input2Placeholder: 'Opcionális szó a fonáshoz', encryption: 'Titkosítás', gematria: 'Gemátria', spelling: 'Helyesírás', calculate: 'Számítás', transpose: 'Transzponálás',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (végső betűkkel)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'Ofanim'},
		gemMenu: {'Ragil': 'Ragil', 'Kolel +letters': 'Kolel +betűk', 'Kolel +word(s)': 'Kolel +szó(k)', 'HaKlali': 'HaKlali', 'Reduced': 'Csökkentett', 'Integral Reduced': 'Teljesen csökkentett', 'Katan': 'Katan', 'Ordinal': 'Sorszám', 'HaKadmi': 'HaKadmi', 'HaPerati': 'HaPerati', 'Miluy': 'Miluy'},
		spellMenu: {'A"B': 'A"B', 'SaG': 'SaG', 'MaH': 'MaH', 'BaN': 'BaN'},
		pictogramWords: {"Ox": "Ökör", "House": "Ház", "Water": "Víz", "Door": "Ajtó", "Hand": "Kéz", "Eye": "Szem", "Tooth": "Fog", "Head": "Fej", "Staff": "Bot", "Camel": "Teve", "Fish": "Hal", "Basket": "Kosár", "Palm": "Tenyer", "Cross": "Kereszt", "Bow": "Íj", "Sickle": "Sarló", "Sun": "Nap", "Moon": "Hold", "Star": "Csillag", "Mountain": "Hegy", "Tree": "Fa", "Field": "Mező", "Foot": "Láb", "Ear": "Fül", "Heart": "Szív", "Crown": "Korona"},
		resultHeaders: {"Input Phrase Gematria": "A bevitt kifejezés gemátriája", "Encrypted Phrases": "Titkosított kifejezések", "Encrypted Phrase Gematria": "A titkosított kifejezés gemátriája", "Original Input Phrase": "Eredeti bevitt kifejezés", "Leap": "Ugrás", "Skip": "Kihagyás", "Acronym": "Betűszó", "Elision": "Elhagyás", "Finals": "Végződések", "Av-Gad (Forward Exchange)": "Av-Gad (Előre csere)", "Knit Word": "Kötött szó", "At-Ba (Backward Exchange)": "At-Ba (Visszacsere)", "Pictogram & Meaning": "Piktogram & jelentés", "Miluy (Spelling)": "Miluy (Helyesírás)", "Morphs": "Morémák", "Summation": "Összegzés", "# of Paths": "# út", "Possible Divisions": "Lehetséges felosztások", "ThShRQ (Reversed)": "ThShRQ (Fordított)", "# of Gates": "# kapu", "A\"B": "A\"B", "SaG": "SaG", "MaH": "MaH", "BaN": "BaN", "# of Words": "# szó", "# of Letters": "# betű", "Ofanim": "Ofanim", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (végső betűkkel)": "AT-BaCh (végső betűkkel)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "Ragil": "Ragil", "HaKlali": "HaKlali", "Kolel +betűk": "Kolel +betűk", "Kolel +szó(k)": "Kolel +szó(k)", "Csökkentett": "Csökkentett", "Teljesen csökkentett": "Teljesen csökkentett", "Katan": "Katan", "Sorszám": "Sorszám", "HaKadmi": "HaKadmi", "HaPerati": "HaPerati", "Crowns (tagin)": "Koronák (tagin)", "Ananagrams": "Anagrammák", "Gematria Matches": "Gemátria egyezések", "Total": "Teljes"}
	},
	'ar': {title: 'جيمكريبت', inputPlaceholder: 'اكتب كلمتك هنا', input2Placeholder: 'كلمة اختيارية للنسج', encryption: 'تشفير', gematria: 'الجيماتريا', spelling: 'التهجئة', calculate: 'حساب', transpose: 'تحويل',
		cryptMenu: {'AYiK-BeCheR': 'AYiK-BeCheR', 'AL-BaM': 'AL-BaM', 'AT-BaSh': 'AT-BaSh', 'ACh-BI': 'ACh-BI', 'AChaS-BeTA': 'AChaS-BeTA', 'AT-BaCh': 'AT-BaCh', 'AT-BaCh (with Finals)': 'AT-BaCh (مع النهايات)', 'AiY-BaK': 'AiY-BaK', 'ATz-BaPh': 'ATz-BaPh', 'AL-BeTh': 'AL-BeTh', 'Ofanim': 'أوفانيم'},
		gemMenu: {'Ragil': 'راجيل', 'Kolel +letters': 'كوليل +حروف', 'Kolel +word(s)': 'كوليل +كلمة/كلمات', 'HaKlali': 'هاكلالي', 'Reduced': 'مخفض', 'Integral Reduced': 'مخفض كليًا', 'Katan': 'كتان', 'Ordinal': 'ترتيبي', 'HaKadmi': 'هاكادمي', 'HaPerati': 'هابراتي', 'Miluy': 'ميلوي'},
		spellMenu: {'A"B': 'أ"ب', 'SaG': 'ساج', 'MaH': 'ماه', 'BaN': 'بان'},
		pictogramWords: {"Ox": "ثور", "House": "منزل", "Water": "ماء", "Door": "باب", "Hand": "يد", "Eye": "عين", "Tooth": "سن", "Head": "رأس", "Staff": "عصا", "Camel": "جمل", "Fish": "سمكة", "Basket": "سلة", "Palm": "راحة اليد", "Cross": "صليب", "Bow": "قوس", "Sickle": "منجل", "Sun": "شمس", "Moon": "قمر", "Star": "نجمة", "Mountain": "جبل", "Tree": "شجرة", "Field": "حقل", "Foot": "قدم", "Ear": "أذن", "Heart": "قلب", "Crown": "تاج"},
		resultHeaders: {"Input Phrase Gematria": "جيماتريا العبارة المدخلة", "Encrypted Phrases": "العبارات المشفرة", "Encrypted Phrase Gematria": "جيماتريا العبارة المشفرة", "Original Input Phrase": "العبارة المدخلة الأصلية", "Leap": "قفزة", "Skip": "تخطي", "Acronym": "اختصار", "Elision": "حذف", "Finals": "النهايات", "Av-Gad (Forward Exchange)": "Av-Gad (تبديل للأمام)", "Knit Word": "كلمة منسوجة", "At-Ba (Backward Exchange)": "At-Ba (تبديل للخلف)", "Pictogram & Meaning": "رمز تصويري & معنى", "Miluy (Spelling)": "ميلوي (تهجئة)", "Morphs": "أشكال", "Summation": "مجموع", "# of Paths": "# المسارات", "Possible Divisions": "تقسيمات ممكنة", "ThShRQ (Reversed)": "ThShRQ (معكوس)", "# of Gates": "# البوابات", "A\"B": "أ\"ب", "SaG": "ساج", "MaH": "ماه", "BaN": "بان", "# of Words": "# الكلمات", "# of Letters": "# الحروف", "أوفانيم": "أوفانيم", "AYiK-BeCheR": "AYiK-BeCheR", "AL-BaM": "AL-BaM", "AT-BaSh": "AT-BaSh", "ACh-BI": "ACh-BI", "AChaS-BeTA": "AChaS-BeTA", "AiY-BaK": "AiY-BaK", "AT-BaCh": "AT-BaCh", "AT-BaCh (مع النهايات)": "AT-BaCh (مع النهايات)", "ATz-BaPh": "ATz-BaPh", "AL-BeTh": "AL-BeTh", "راجيل": "راجيل", "هاكلالي": "هاكلالي", "كوليل +حروف": "كوليل +حروف", "كوليل +كلمة/كلمات": "كوليل +كلمة/كلمات", "مخفض": "مخفض", "مخفض كليًا": "مخفض كليًا", "كتان": "كتان", "ترتيبي": "ترتيبي", "هاكادمي": "هاكادمي", "هاببراتي": "هاببراتي", "Crowns (tagin)": "تيجان (tagin)", "Ananagrams": "أناناغرامات", "Gematria Matches": "تطابقات الجيماتريا", "Total": "المجموع"}
	},
};
...
function translateUI() {
	...
	let h1 = document.querySelector('.hidden-title h1');
	if (h1) h1.textContent = map.title;
	// Input placeholders
	let input1 = document.getElementById('inputText');
	if (input1) input1.placeholder = map.inputPlaceholder;
	let input2 = document.getElementById('inputText2');
	if (input2) input2.placeholder = map.input2Placeholder;
	// Button/dropdown headers
	let encHeader = document.querySelector('center:contains("Encryption")');
	if (encHeader) encHeader.textContent = map.encryption;
	let gemHeader = document.querySelector('center:contains("Gematria")');
	if (gemHeader) gemHeader.textContent = map.gematria;
	let spellHeader = document.querySelector('center:contains("Spelling")');
	if (spellHeader) spellHeader.textContent = map.spelling;
	let calcHeader = document.querySelector('center:contains("Calculate")');
	if (calcHeader) calcHeader.textContent = map.calculate;
	let transposeBtn = document.getElementById('transpose');
	if (transposeBtn) transposeBtn.textContent = map.transpose;
	// Dropdowns
	let cryptOpts = document.querySelectorAll('#cryptmenu option');
	cryptOpts.forEach(opt => {
		if (map.cryptMenu[opt.textContent]) opt.textContent = map.cryptMenu[opt.textContent];
	});
	let gemOpts = document.querySelectorAll('#gemmenu option');
	gemOpts.forEach(opt => {
		if (map.gemMenu[opt.textContent]) opt.textContent = map.gemMenu[opt.textContent];
	});
	let spellOpts = document.querySelectorAll('#spellmenu option');
	spellOpts.forEach(opt => {
		if (map.spellMenu[opt.textContent]) opt.textContent = map.spellMenu[opt.textContent];
	});
}
document.addEventListener('DOMContentLoaded', translateUI);
</script>
<title>GemaCrypt - Hebrew Gematria Calculator & Bible Code Analysis Tool</title>
...
<!-- Leap -->
<td width="33%" valign="top"><p align="center" valign="top"><b><u><a href="/gemacrypt/help.html#Leap" target="_blank" border="0" style="text-decoration: none;" onclick="SendLeap()"><span title="Also called a Jump, where the first letter of the original word is removed of leaped over, to see if it reveals a root word.">Leap</span><!-- (Jump)-->:</a></u></b></p>
<div align="center" data-role="fieldcontain" class="mobiletextinput4" id="leap"></div></td>
<!-- Skip -->
<td width="33%" valign="top"><p align="right" valign="top"><b><u><a href="/gemacrypt/help.html#Skip" target="_blank" border="0" style="text-decoration: none;" onclick="SendSkip()"><span title="Also called a Dilug, where the second letter of the original word is removed or skipped over, to see if it reveals a root word.">Skip:</span></a></u></b></p>
<div align="right" data-role="fieldcontain" class="mobiletextinput4" id="skip"></div></td></tr>

<!-- Acronym -->
<tr><td width="33%" valign="top"><p align="left" valign="top"><b><u><a href="/gemacrypt/help.html#Acronym" target="_blank" border="0" style="text-decoration: none;" onclick="SendAcronym()"><span title="Takes the first letter of each word and combines them to see if they reveal a hidden word.">Acronym:</span></a></u></b></p>
<div align="left" data-role="fieldcontain" class="mobiletextinput4" id="acronym"></div></td>
<!-- Elision -->
<td width="33%" valign="top"><p align="center" valign="top"><b><u><span title="Removing the first and last letter."><a href="/gemacrypt/help.html#Elision" target="_blank" style="text-decoration: none;">Elision:</a></span></u></b></p>
<div align="center" data-role="fieldcontain" class="mobiletextinput4" id="elision"></div></td>
<!-- Acronym with Finals -->
<td width="33%" valign="top"><p align="right" valign="top"><b><u><span title="A reverse acronym, where the last letter of each of the original words is combined to see if they reveal a hidden word."><a href="/gemacrypt/help.html#Acronym" target="_blank" style="text-decoration: none;">Finals:</a></span><!--Sofim--></u></b></p>
...
<!-- Pictogram & Meaning -->
<tr><td width="33%" valign="top"><p align="left" valign="top"><b><u><span title="The pictograms for each letter of the original word and their meanings."><a href="/gemacrypt/help.html#Four_Major_Writing_Styles" target="_blank" style="text-decoration: none;">Pictogram & Meaning:</a></span></u></b> <a href="#" style="text-decoration: none;" onclick="togglePictograms()"><img src="img/expand.png" id="PictogramsExpandCollapseImg" alt="Expand/Collapse" heigth="16" width="20" border="0" style="filter: drop-shadow(0 0 5px #FFFFFF);"><style>a:hover img[src="img/kboard.png"] {filter: drop-shadow(0 0 25px #FFFFFF); box-shadow: 0 0 10px #FFFFFF; }</style></a></p>
<div id="Pictograms"><div align="left" data-role="fieldcontain" class="mobiletextinput4" id="pictogram"></div></div></td>
<!-- Miluy (Spelling) -->
<td width="33%" valign="top"><p align="center" valign="top"><b><u><span title="The full spelling of each letter written out beginning with the first letter at the top and ending with the last letter at the bottom."><a href="/gemacrypt/help.html#ABaG_BeGeD" target="_blank" style="text-decoration: none;">Miluy (Spelling):</a></span></u></b> <a href="#" style="text-decoration: none;" onclick="toggleMiluy()"><img src="img/expand.png" id="MiluyExpandCollapseImg" alt="Expand/Collapse" heigth="16" width="20" border="0" style="filter: drop-shadow(0 0 5px #FFFFFF);"><style>a:hover img[src="img/kboard.png"] {filter: drop-shadow(0 0 25px #FFFFFF); box-shadow: 0 0 10px #FFFFFF; }</style></p>
<div id="Miluy"><div align="center" data-role="fieldcontain" class="mobiletextinput4" id="spelling"></div></div></td>
<!-- Morphs -->
<td width="33%" valign="top"><p align="right" valign="top"><b><u><a href="#" style="text-decoration: none;" onclick="toggleMorphs()"><img src="img/expand.png" id="MorphsExpandCollapseImg" alt="Expand/Collapse" heigth="16" width="20" border="0" style="filter: drop-shadow(0 0 5px #FFFFFF);"><style>a:hover img[src="img/kboard.png"] {filter: drop-shadow(0 0 25px #FFFFFF); box-shadow: 0 0 10px #FFFFFF; }</style></a>   <span title="The assumption that a letter is made up of 2 or more similar letters based on their appearance, where these new/additional letter could be substituted for that letter."><a href="" target="_blank" style="text-decoration: none;">Morphs:</a></span></u></b></p>
<div id="Morphs"><div align="right" data-role="fieldcontain" class="mobiletextinput4" id="morph"></div></ol></div></td></tr>

<!-- Summation -->
<tr><td width="33%" valign="top"><p align="left" valign="top"><b><u><span title="The letter combination that normally represents the numerical value of the original word."><a href="" target="_blank" style="text-decoration: none;">Summation:</a></span></u></b></p>
<div align="left" data-role="fieldcontain" class="mobiletextinput4" id="summation"></div></td>
<!-- Paths -->
<td width="33%" valign="top"><p align="center" valign="top"><b><u><span title="The number of paths on the Tree of Life, found by the number of unique letters in the original word."><a href="#" onclick="openPathModal();" style="text-decoration: none;"># of Paths:</a></span></u></b></p>
<div align="center" data-role="fieldcontain" class="mobiletextinput4" id="paths"></div></td>
<!-- Divisions -->
<td width="33%" valign="top"><p align="right" valign="top"><b><u><a href="#" style="text-decoration: none;" onclick="togglePossibleDivisions()"><img src="img/expand.png" id="PossibleDivisionsExpandCollapseImg" alt="Expand/Collapse" heigth="16" width="20" border="0" style="filter: drop-shadow(0 0 5px #FFFFFF);"><style>a:hover img[src="img/kboard.png"] {filter: drop-shadow(0 0 25px #FFFFFF); box-shadow: 0 0 10px #FFFFFF; }</style></a>   <span title="The different letter combinations with make words of the same numerical value."><a href="" target="_blank" style="text-decoration: none;">Possible Divisions:</a></span></u></b></p>
<div id="PossibleDivisions"><div align="right" data-role="fieldcontain" class="mobiletextinput4" id="div"></div></div></td></tr>

<!-- Reversed -->
<tr><td width="33%" valign="top"><p align="left" valign="top"><b><u><a href="" border="0" style="text-decoration: none;" onclick="SendReverse()"><span title="This will generate a random word based on the number of letters in the original word."><a href="/gemacrypt/help.html#ThShRQ" target="_blank" style="text-decoration: none;">ThShRQ (Reversed):</a></span></a></u></b></p>
...
<!-- Words -->
<tr><td width="33%" valign="top"><p align="left" valign="top"><b><u><span title=""><a href="Total number of words originally entered." target="_blank" style="text-decoration: none;"># of Words:</a></span></u></b></p>
...
// Create Gate Modal dialog window
function createGateModal() {
  var modal = `
    <div id="myGateModal" class="modal">
...
// Modal dialog for Gates
function openGateModal() {
  createGateModal(); // Call createGateModal() first to create the modal HTML
  var message =  `<center>Gates are the number of unique connections between one letter of the alphabet and another letter.<br><br><img src="img/gates.jpg"></center>`;
  document.getElementById("modal-message").innerHTML = message;
  document.getElementById("myGateModal").style.display = "block";
}
function closeModal() {
  document.getElementById("myGateModal").style.display = "none";
}

// Create Path Modal dialog window
function createPathModal() {
  var modal = `
    <div id="myPathModal" class="modal">
      <div class="modal-content">
        <span class="close" onclick="closePathModal()">&times;</span>
        <p id="path-modal-message"></p>
      </div>
    </div>
  `;
  document.body.insertAdjacentHTML('beforeend', modal);
}
// Modal dialog for Paths
function openPathModal() {
  createPathModal(); // Call createPathModal() first to create the modal HTML
  var message =  `<center>Paths are the number of unique connections between the Sephirot (digits 0-9 or 1-10) of the Tree of Life.<br><br><img src="img/paths.jpg"></center>`;
  document.getElementById("path-modal-message").innerHTML = message;
  document.getElementById("myPathModal").style.display = "block";
}
function closePathModal() {
  document.getElementById("myPathModal").style.display = "none";
}
window.onclick = function(event) {
  if (event.target == document.getElementById("myGateModal")) {
    document.getElementById("myGateModal").style.display = "none";
  }
  if (event.target == document.getElementById("myPathModal")) {
    document.getElementById("myPathModal").style.display = "none";
  }
}
...
var gematria = document.getElementById('gemmenu').value;
  if (gematria == 'Ragil' || gematria == 'Kolel' || gematria == 'Kolel +1' || gematria == 'HaKlali'/* || gematria == 'Katan'*/){
...
var paths=gates=words=letters=0;
...
var original = document.getElementById('inputText').value;
words = document.getElementById('inputText').value.trim().split(/\s+/).length;
document.getElementById("words").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${words}); Transpose(); return false;" target='_blank'><b>${words}</b></a>`;
letters = document.getElementById('inputText').value.replace(/[^\u0590-\u05FF\u0370-\u03FFa-zA-Z]/g, '').length;
document.getElementById("letters").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${letters}); Transpose(); return false;" target='_blank'><b>${letters}</b></a>`;
...
document.getElementById("backexch").innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(backexch)+"' target='_blank' style='color: white; font-weight: 400;'><b>" + backexch + "</b></a><br />";
...
document.getElementById("AB").innerHTML = `<b><a href='#' onclick="replaceInputField('inputText', ${wordAB}); Transpose(); return false;" target='_blank'>${wordAB}</a>` + `<br /><font color='#FFFFFF'>Total = <a href='#' onclick="replaceInputField('inputText', ${gematriaAB}); Transpose(); return false;" target='_blank'>${gematriaAB}</a></font></b>`;
// SaG Method
for (var i=0; i < alphas.length; i++){
	switch(array[i]){
...
document.getElementById("SaG").innerHTML = `<b><a href='#' onclick="replaceInputField('inputText', ${wordSaG}); Transpose(); return false;" target='_blank'>${wordSaG}</a>` + `<br /><font color='#FFFFFF'>Total = <a href='#' onclick="replaceInputField('inputText', ${gematriaSaG}); Transpose(); return false;" target='_blank'>${gematriaSaG}</a></font></b>`;
// MaH Method
for (var i=0; i < alphas.length; i++){
	switch(array[i]){
...
document.getElementById("MaH").innerHTML = `<b><a href='#' onclick="replaceInputField('inputText', ${wordMaH}); Transpose(); return false;" target='_blank'>${wordMaH}</a>` + `<br /><font color='#FFFFFF'>Total = <a href='#' onclick="replaceInputField('inputText', ${gematriaMaH}); Transpose(); return false;" target='_blank'>${gematriaMaH}</a></font></b>`;
// BaN Method
for (var i=0; i < alphas.length; i++){
	switch(array[i]){
...
document.getElementById("BaN").innerHTML = `<b><a href='#' onclick="replaceInputField('inputText', ${wordBaN}); Transpose(); return false;" target='_blank'>${wordBaN}</a>` + `<br /><font color='#FFFFFF'>Total = <a href='#' onclick="replaceInputField('inputText', ${gematriaBaN}); Transpose(); return false;" target='_blank'>${gematriaBaN}</a></font></b>`;
...
if( cryptography == "AL-BaM" ){
	...
	//else if (gematria == "Katan"){	while (gematria1.endsWith("0")) {gematria1 = gematria1.slice(0, -1);}	}
...
document.getElementById('crypt2').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(cryptography2)+"' target='_blank'><b>" + cryptography2 + "</b></a><br />";
...
document.getElementById("originalWord").innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(inputText)+"' target='_blank'><b>" + inputText + "</b></a><br />";
...
document.getElementById('acronym').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(acronym)+"' target='_blank'><b>" + acronym + "</b></a><br />";
...
document.getElementById('sofim').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(sofim)+"' target='_blank'><b>" + sofim + "</b></a><br />";
...
document.getElementById('elision').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(elision)+"' target='_blank'><b>" + elision + "</b></a><br />";
...
document.getElementById('reverseText').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(reverse)+"' target='_blank'><b>" + reverse + "</b></a><br />";
...
document.getElementById('leap').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(leap)+"' target='_blank'><b>" + leap + "</b></a><br />";
...
document.getElementById('skip').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(skip)+"' target='_blank'><b>" + skip + "</b></a><br />";
...
KolelValue += letterCount;
Kolel1Value += wordCount;
//KatanValue = RagilValue.replace(/0+$/, ''); // Truncate any trailing zeros

document.getElementById("Ragil").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${RagilValue}); Transpose(); return false;" target='_blank'><b>${RagilValue}</b></a>`;
document.getElementById("Kolel").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${KolelValue}); Transpose(); return false;" target='_blank'><b>${KolelValue}</b></a>`;
document.getElementById("Kolel+1").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${Kolel1Value}); Transpose(); return false;" target='_blank'><b>${Kolel1Value}</b></a>`;
document.getElementById("HaKlali").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${HaKlaliValue}); Transpose(); return false;" target='_blank'><b>${HaKlaliValue}</b></a>`;
document.getElementById("Reduced").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${ReducedlValue}); Transpose(); return false;" target='_blank'><b>${ReducedlValue}</b></a>`;
document.getElementById("Integral-Reduced").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${IntegralReducedlValue}); Transpose(); return false;" target='_blank'><b>${IntegralReducedlValue}</b></a>`;
document.getElementById("Katan").innerHTML = `<a href='#' onclick="replaceInputField('inputText', ${KatanValue}); Transpose(); return false;" target='_blank'><b>${KatanValue}</b></a>`;
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AL-BaM').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ALBaM)+"' target='_blank'><b>" + ALBaM + "</b></a><br />";
	...
	document.getElementById('AT-BaSh').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ATBaSh)+"' target='_blank'><b>" + ATBaSh + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('ACh-BI').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(AChBI)+"' target='_blank'><b>" + AChBI + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AYiK-BeCheR').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(AYiKBeCheR)+"' target='_blank'><b>" + AYiKBeCheR + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AChaS-BeTA').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(AChaSBeTA)+"' target='_blank'><b>" + AChaSBeTA + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AT-BaCh').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ATBaCh)+"' target='_blank'><b>" + ATBaCh + "</b></a><br />";
	...
	document.getElementById('AT-BaCh999').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ATBaCh999)+"' target='_blank'><b>" + ATBaCh999 + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AiY-BaK').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(AiYBaK)+"' target='_blank'><b>" + AiYBaK + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('ATz-BaPh').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ATzBaPh)+"' target='_blank'><b>" + ATzBaPh + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('AL-BeTh').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(ALBeTh)+"' target='_blank'><b>" + ALBeTh + "</b></a><br />";
...
for (var i=0; i < alphas.length; i++){
	...
	document.getElementById('Ofanim').innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(Ofanim)+"' target='_blank'><b>" + Ofanim + "</b></a><br />";
...
document.getElementById("randword").innerHTML = "<a href='http://translate.google.com/#auto/en/"+encodeURIComponent(rand)+"' target='_blank' style='color: white; font-weight: 400;'>" + rand + "</a><br />";
</script>
